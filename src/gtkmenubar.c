			   ...
			   GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_PACK_DIRECTION:
      __gtk_menu_bar_set_pack_direction (menubar, g_value_get_enum (value));
      break;
    case PROP_CHILD_PACK_DIRECTION:
      __gtk_menu_bar_set_child_pack_direction (menubar, g_value_get_enum (value));
      break;
    default:
			   ...
			   GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_PACK_DIRECTION:
      g_value_set_enum (value, __gtk_menu_bar_get_pack_direction (menubar));
      break;
    case PROP_CHILD_PACK_DIRECTION:
      g_value_set_enum (value, __gtk_menu_bar_get_child_pack_direction (menubar));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
			   ...
			   GtkRequisition *requisition)
{
  ...
  if (__gtk_widget_get_visible (widget))
      ...
      while (children)
	{
	  ...
	  if (__gtk_widget_get_visible (child))
	    {
	      ...
	      gtk_menu_item_get_props (GTK_MENU_ITEM (child))->show_submenu_indicator = FALSE;
	      __gtk_widget_size_request (child, &child_requisition);
              __gtk_menu_item_toggle_size_request (GTK_MENU_ITEM (child),
                                                 &toggle_size);
      ...
      requisition->width += (gtk_container_get_props (GTK_CONTAINER (menu_bar))->border_width +
                             ipadding + 
			     BORDER_SPACING) * 2;
      requisition->height += (gtk_container_get_props (GTK_CONTAINER (menu_bar))->border_width +
                              ipadding +
			      BORDER_SPACING) * 2;
			    ...
			    GtkAllocation *allocation)
{
  ...
  if (gtk_menu_shell_get_props (menu_shell)->children)
    {
      child_allocation.x = (gtk_container_get_props (GTK_CONTAINER (menu_bar))->border_width +
			    ipadding + 
			    BORDER_SPACING);
      child_allocation.y = (gtk_container_get_props (GTK_CONTAINER (menu_bar))->border_width +
			    BORDER_SPACING);
	  ...
	  while (children)
	    {
	      ...
	      __gtk_menu_item_toggle_size_request (GTK_MENU_ITEM (child),
						 &toggle_size);
	      __gtk_widget_get_child_requisition (child, &child_requisition);
		...
		child_requisition.height += toggle_size;
		  ...
		  && (gtk_menu_item_get_props (GTK_MENU_ITEM(child))->right_justify)) 
		{
  ...
  if (__gtk_widget_is_drawable (widget))
    {
      ...
      border = gtk_container_get_props (GTK_CONTAINER (widget))->border_width;
  ...
  if (accel && *accel)
    {
      ...
      if (event->keyval == keyval &&
	   ...
	   (mods & __gtk_accelerator_get_default_mod_mask ())))
        {
	  GList *tmp_menubars = get_viewable_menu_bars (GTK_WINDOW (widget));
	  GList *menubars;

	  menubars = ___gtk_container_focus_sort (GTK_CONTAINER (widget), tmp_menubars,
	  ...
	  if (menubars)
	    {
	      ...
	      __gtk_menu_shell_select_first (menu_shell, FALSE);
 ...
 **/
void
___gtk_menu_bar_cycle_focus (GtkMenuBar       *menubar,
			   GtkDirectionType  dir)
{
  GtkWidget *toplevel = __gtk_widget_get_toplevel (GTK_WIDGET (menubar));
  ...
  if (__gtk_widget_is_toplevel (toplevel))
    {
      ...
      menubars = ___gtk_container_focus_sort (GTK_CONTAINER (toplevel), tmp_menubars,
  ...
  __gtk_menu_shell_cancel (GTK_MENU_SHELL (menubar));
...
get_shadow_type (GtkMenuBar *menubar)
{
  ...
  __gtk_widget_style_get (GTK_WIDGET (menubar),
			   ...
			   GtkMenuDirectionType  direction)
{
  ...
  text_dir = __gtk_widget_get_direction (GTK_WIDGET (menubar));
  pack_dir = __gtk_menu_bar_get_pack_direction (menubar);
...
/**
 * __gtk_menu_bar_get_pack_direction:
 * @menubar: a #GtkMenuBar
 * 
 * Retrieves the current pack direction of the menubar. 
 * See __gtk_menu_bar_set_pack_direction().
 *
 ...
 */
GtkPackDirection
__gtk_menu_bar_get_pack_direction (GtkMenuBar *menubar)
{
  GtkMenuBarPrivate *priv;
...
/**
 * __gtk_menu_bar_set_pack_direction:
 * @menubar: a #GtkMenuBar
 ...
 */
void
__gtk_menu_bar_set_pack_direction (GtkMenuBar       *menubar,
                                 GtkPackDirection  pack_dir)
{
  GtkMenuBarPrivate *priv;
  GList *l;
  ...
  if (priv->pack_direction != pack_dir)
    {
      ...
      __gtk_widget_queue_resize (GTK_WIDGET (menubar));

      for (l = gtk_menu_shell_get_props (GTK_MENU_SHELL (menubar))->children; l; l = l->next)
	__gtk_widget_queue_resize (GTK_WIDGET (l->data));
...
/**
 * __gtk_menu_bar_get_child_pack_direction:
 * @menubar: a #GtkMenuBar
 * 
 * Retrieves the current child pack direction of the menubar.
 * See __gtk_menu_bar_set_child_pack_direction().
 *
 ...
 */
GtkPackDirection
__gtk_menu_bar_get_child_pack_direction (GtkMenuBar *menubar)
{
  GtkMenuBarPrivate *priv;
...
/**
 * __gtk_menu_bar_set_child_pack_direction:
 * @menubar: a #GtkMenuBar
 ...
 */
void
__gtk_menu_bar_set_child_pack_direction (GtkMenuBar       *menubar,
