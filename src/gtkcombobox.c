 ...
 * can be accessed by calling __gtk_bin_get_child() on the combo box.
 *
...
static void     __gtk_combo_box_set_active_internal  (GtkComboBox      *combo_box,
						    GtkTreePath      *path);
...
gtk_combo_box_class_init (GtkComboBoxClass *klass)
{
   ...
   * call to __gtk_combo_box_set_active_iter().
  ...
  __gtk_binding_entry_add_signal (binding_set, GDK_Down, GDK_MOD1_MASK,
				"popup", 0);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Down, GDK_MOD1_MASK,
				"popup", 0);

  __gtk_binding_entry_add_signal (binding_set, GDK_Up, GDK_MOD1_MASK,
				"popdown", 0);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Up, GDK_MOD1_MASK,
				"popdown", 0);
  ...
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Up, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_STEP_UP);
  __gtk_binding_entry_add_signal (binding_set, GDK_Page_Up, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_PAGE_UP);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Page_Up, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_PAGE_UP);
  __gtk_binding_entry_add_signal (binding_set, GDK_Home, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_START);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Home, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_START);

  __gtk_binding_entry_add_signal (binding_set, GDK_Down, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_STEP_DOWN);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Down, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_STEP_DOWN);
  __gtk_binding_entry_add_signal (binding_set, GDK_Page_Down, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_PAGE_DOWN);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_Page_Down, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_PAGE_DOWN);
  __gtk_binding_entry_add_signal (binding_set, GDK_End, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_END);
  __gtk_binding_entry_add_signal (binding_set, GDK_KP_End, 0,
				"move-active", 1,
				GTK_TYPE_SCROLL_TYPE, GTK_SCROLL_END);
   ...
   * <literal>__gtk_tree_path_get_indices (path)[0]</literal>,
...
gtk_combo_box_init (GtkComboBox *combo_box)
{
  ...
  gtk_combo_box_get_props (combo_box)->priv = priv;
                            ...
                            GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_MODEL:
      __gtk_combo_box_set_model (combo_box, g_value_get_object (value));
      break;

    case PROP_WRAP_WIDTH:
      __gtk_combo_box_set_wrap_width (combo_box, g_value_get_int (value));
      break;

    case PROP_ROW_SPAN_COLUMN:
      __gtk_combo_box_set_row_span_column (combo_box, g_value_get_int (value));
      break;

    case PROP_COLUMN_SPAN_COLUMN:
      __gtk_combo_box_set_column_span_column (combo_box, g_value_get_int (value));
      break;

    case PROP_ACTIVE:
      __gtk_combo_box_set_active (combo_box, g_value_get_int (value));
      break;

    case PROP_ADD_TEAROFFS:
      __gtk_combo_box_set_add_tearoffs (combo_box, g_value_get_boolean (value));
      break;

    case PROP_HAS_FRAME:
      gtk_combo_box_get_props (combo_box)->priv->has_frame = g_value_get_boolean (value);

      if (gtk_combo_box_get_props (combo_box)->priv->has_entry)
        {
          GtkWidget *child;

          child = __gtk_bin_get_child (GTK_BIN (combo_box));

          __gtk_entry_set_has_frame (GTK_ENTRY (child),
                                   gtk_combo_box_get_props (combo_box)->priv->has_frame);
        }

      break;

    case PROP_FOCUS_ON_CLICK:
      __gtk_combo_box_set_focus_on_click (combo_box,
                                        g_value_get_boolean (value));
      break;

    case PROP_TEAROFF_TITLE:
      __gtk_combo_box_set_title (combo_box, g_value_get_string (value));
      break;
    ...
    case PROP_BUTTON_SENSITIVITY:
      __gtk_combo_box_set_button_sensitivity (combo_box,
                                            g_value_get_enum (value));
      break;

    case PROP_EDITING_CANCELED:
      gtk_combo_box_get_props (combo_box)->priv->editing_canceled = g_value_get_boolean (value);
      break;

    case PROP_HAS_ENTRY:
      gtk_combo_box_get_props (combo_box)->priv->has_entry = g_value_get_boolean (value);
      break;

    case PROP_ENTRY_TEXT_COLUMN:
      __gtk_combo_box_set_entry_text_column (combo_box, g_value_get_int (value));
      break;
                            ...
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
      case PROP_MODEL:
        g_value_set_object (value, gtk_combo_box_get_props (combo_box)->priv->model);
        break;

      case PROP_WRAP_WIDTH:
        g_value_set_int (value, gtk_combo_box_get_props (combo_box)->priv->wrap_width);
        break;

      case PROP_ROW_SPAN_COLUMN:
        g_value_set_int (value, gtk_combo_box_get_props (combo_box)->priv->row_column);
        break;

      case PROP_COLUMN_SPAN_COLUMN:
        g_value_set_int (value, gtk_combo_box_get_props (combo_box)->priv->col_column);
        break;

      case PROP_ACTIVE:
        g_value_set_int (value, __gtk_combo_box_get_active (combo_box));
        break;

      case PROP_ADD_TEAROFFS:
        g_value_set_boolean (value, __gtk_combo_box_get_add_tearoffs (combo_box));
        break;

      case PROP_HAS_FRAME:
        g_value_set_boolean (value, gtk_combo_box_get_props (combo_box)->priv->has_frame);
        break;

      case PROP_FOCUS_ON_CLICK:
        g_value_set_boolean (value, gtk_combo_box_get_props (combo_box)->priv->focus_on_click);
        break;

      case PROP_TEAROFF_TITLE:
        g_value_set_string (value, __gtk_combo_box_get_title (combo_box));
        break;

      case PROP_POPUP_SHOWN:
        g_value_set_boolean (value, gtk_combo_box_get_props (combo_box)->priv->popup_shown);
        break;

      case PROP_BUTTON_SENSITIVITY:
        g_value_set_enum (value, gtk_combo_box_get_props (combo_box)->priv->button_sensitivity);
        break;
			     ...
			     GtkStateType  previous)
{
  ...
  GtkComboBoxPrivate *priv = gtk_combo_box_get_props (combo_box)->priv;
  ...
  if (__gtk_widget_get_realized (widget))
      ...
      if (!priv->tree_view && priv->cell_view)
	{
	  if ((__gtk_widget_get_state (widget) == GTK_STATE_INSENSITIVE) !=
	      (__gtk_widget_get_state (priv->cell_view) == GTK_STATE_INSENSITIVE))
	    __gtk_widget_set_sensitive (priv->cell_view, __gtk_widget_get_sensitive (widget));
	  
	  __gtk_widget_set_state (priv->cell_view, 
...
gtk_combo_box_check_appearance (GtkComboBox *combo_box)
{
  ...
  if (priv->wrap_width)
    ...
    __gtk_widget_style_get (GTK_WIDGET (combo_box),
                              ...
                              gpointer   data)
{
  ...
  if (__gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (widget)))
    {
      if (!gtk_combo_box_get_props (combo_box)->priv->popup_in_progress)
        __gtk_combo_box_popup (combo_box);
    }
  else
    __gtk_combo_box_popdown (combo_box);
                   ...
                   GtkWidget    *widget)
{
  ...
  if (priv->cell_view &&
      __gtk_widget_get_parent (priv->cell_view))
    {
      __gtk_widget_unparent (priv->cell_view);
      gtk_bin_get_props (GTK_BIN (container))->child = NULL;
      __gtk_widget_queue_resize (GTK_WIDGET (container));
    }
  
  __gtk_widget_set_parent (widget, GTK_WIDGET (container));
  gtk_bin_get_props (GTK_BIN (container))->child = widget;
  ...
  if (priv->cell_view &&
      widget != priv->cell_view)
    {
	  ...
	  priv->separator = NULL;
        ...
        {
          __gtk_widget_unparent (priv->cell_view_frame);
  ...
  if (priv->has_entry)
    {
       ...
       */
      gtk_entry_get_props (GTK_ENTRY (widget))->is_cell_renderer = TRUE;

      g_signal_connect (widget, "changed",
			G_CALLBACK (gtk_combo_box_entry_contents_changed),
			combo_box);

      __gtk_entry_set_has_frame (GTK_ENTRY (widget), priv->has_frame);
    }
}
		      ...
		      GtkWidget    *widget)
{
  ...
  if (priv->has_entry)
    {
      ...
      child_widget = __gtk_bin_get_child (GTK_BIN (container));
      if (widget && widget == child_widget)
	{
	  g_signal_handlers_disconnect_by_func (widget,
						gtk_combo_box_entry_contents_changed,
						container);
	  gtk_entry_get_props (GTK_ENTRY (widget))->is_cell_renderer = FALSE;
	}
    }
  ...
  if (appears_as_list)
    ...
    {
      gtk_combo_box_menu_destroy (combo_box);
      __gtk_menu_detach (GTK_MENU (priv->popup_widget));
  ...
  if (!priv->cell_view)
    {
      priv->cell_view = __gtk_cell_view_new ();
      __gtk_widget_set_parent (priv->cell_view, GTK_WIDGET (container));
      gtk_bin_get_props (GTK_BIN (container))->child = priv->cell_view;
      
      __gtk_widget_show (priv->cell_view);
      __gtk_cell_view_set_model (GTK_CELL_VIEW (priv->cell_view),
			       priv->model);
  ...
  if (__gtk_tree_row_reference_valid (priv->active_row))
    {
      path = __gtk_tree_row_reference_get_path (priv->active_row);
      __gtk_combo_box_set_active_internal (combo_box, path);
      __gtk_tree_path_free (path);
    }
  else
    __gtk_combo_box_set_active_internal (combo_box, NULL);
}
                             ...
                             GtkCellRenderer *cell)
{
  ...
  for (i = gtk_combo_box_get_props (combo_box)->priv->cells; i; i = i->next)
    {
                         ...
                         gpointer   user_data)
{
  ...
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->button),
                                TRUE);
                         ...
                         gpointer   user_data)
{
  ...
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (gtk_combo_box_get_props (combo_box)->priv->button),
                                FALSE);
}
			...
			GtkMenu	  *menu)
{
  ...
  g_signal_handlers_disconnect_by_func (gtk_menu_get_props (menu)->toplevel,
                                ...
                                GtkWidget   *popup)
{
  ...
  if (GTK_IS_MENU (priv->popup_widget))
    ...
    {
      __gtk_container_remove (GTK_CONTAINER (priv->scrolled_window),
                            priv->popup_widget);
  ...
  if (GTK_IS_MENU (popup))
    {
      if (priv->popup_window)
        {
          __gtk_widget_destroy (priv->popup_window);
       ...
       */
      g_signal_connect (gtk_menu_get_props (GTK_MENU (popup))->toplevel, "show",
                        G_CALLBACK (gtk_combo_box_menu_show), combo_box);
      g_signal_connect (gtk_menu_get_props (GTK_MENU (popup))->toplevel, "hide",
                        G_CALLBACK (gtk_combo_box_menu_hide), combo_box);

      __gtk_menu_attach_to_widget (GTK_MENU (popup),
  ...
  else
    {
      if (!priv->popup_window)
        {
          priv->popup_window = __gtk_window_new (GTK_WINDOW_POPUP);
          __gtk_widget_set_name (priv->popup_window, "gtk-combobox-popup-window");

	  __gtk_window_set_type_hint (GTK_WINDOW (priv->popup_window),
	  ...
	  __gtk_window_set_resizable (GTK_WINDOW (priv->popup_window), FALSE);

	  priv->scrolled_window = __gtk_scrolled_window_new (NULL, NULL);
	  
	  __gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (priv->scrolled_window),
					  GTK_POLICY_NEVER,
					  GTK_POLICY_NEVER);
	  __gtk_scrolled_window_set_shadow_type (GTK_SCROLLED_WINDOW (priv->scrolled_window),
					       GTK_SHADOW_IN);

          __gtk_widget_show (priv->scrolled_window);
	  
	  __gtk_container_add (GTK_CONTAINER (priv->popup_window),
			     priv->scrolled_window);
        }

      __gtk_container_add (GTK_CONTAINER (priv->scrolled_window),
                         popup);

      __gtk_widget_show (popup);
      g_object_ref (popup);
      priv->popup_widget = popup;
    }
}
				   ...
				   gpointer  user_data)
{
  ...
  if (!__gtk_widget_get_has_window (child))
    {
      sx += gtk_widget_get_props (child)->allocation.x;
      sy += gtk_widget_get_props (child)->allocation.y;
    }

  __gdk_window_get_root_coords (gtk_widget_get_props (child)->window, sx, sy, &sx, &sy);

  if (GTK_SHADOW_NONE != gtk_combo_box_get_props (combo_box)->priv->shadow_type)
    sx -= gtk_widget_get_props (GTK_WIDGET (combo_box))->style->xthickness;

  __gtk_widget_size_request (GTK_WIDGET (menu), &req);

  if (__gtk_widget_get_direction (GTK_WIDGET (combo_box)) == GTK_TEXT_DIR_LTR)
    *x = sx;
  else
    *x = sx + gtk_widget_get_props (child)->allocation.width - req.width;
  *y = sy;

  screen = __gtk_widget_get_screen (GTK_WIDGET (combo_box));
  monitor_num = __gdk_screen_get_monitor_at_window (screen, 
						  gtk_widget_get_props (GTK_WIDGET (combo_box))->window);
  ...
  if (monitor.y + monitor.height - *y - gtk_widget_get_props (child)->allocation.height >= req.height)
    *y += gtk_widget_get_props (child)->allocation.height;
  else if (*y - monitor.y >= req.height)
    *y -= req.height;
  else if (monitor.y + monitor.height - *y - gtk_widget_get_props (child)->allocation.height > *y - monitor.y) 
    *y += gtk_widget_get_props (child)->allocation.height;
  else
    *y -= req.height;
				  ...
				  gpointer  user_data)
{
  ...
  __gtk_widget_get_child_requisition (GTK_WIDGET (menu), &requisition);
  menu_width = requisition.width;

  active = __gtk_menu_get_active (GTK_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget));

  menu_xpos = gtk_widget_get_props (widget)->allocation.x;
  menu_ypos = gtk_widget_get_props (widget)->allocation.y + gtk_widget_get_props (widget)->allocation.height / 2 - 2;

  if (active != NULL)
    {
      __gtk_widget_get_child_requisition (active, &requisition);
  ...
  while (children)
	...
	{
	  __gtk_widget_get_child_requisition (child, &requisition);
  ...
  if (__gtk_widget_get_direction (widget) == GTK_TEXT_DIR_RTL)
    menu_xpos = menu_xpos + gtk_widget_get_props (widget)->allocation.width - menu_width;

  __gdk_window_get_root_coords (gtk_widget_get_props (widget)->window, menu_xpos, menu_ypos,
			      &menu_xpos, &menu_ypos);

  /* Clamp the position on screen */
  screen_width = __gdk_screen_get_width (__gtk_widget_get_screen (widget));
			     ...
			     gpointer  user_data)
{
  ...
  if (priv->wrap_width > 0 || priv->cell_view == NULL)	
  ...
  else
    {
      ...
      menu_item = __gtk_menu_get_active (GTK_MENU (priv->popup_widget));
      if (menu_item)
	__gtk_menu_shell_select_item (GTK_MENU_SHELL (priv->popup_widget), 
				    menu_item);
			     ...
			     gint        *height)
{
  ...
  *x = *y = 0;
  ...
  if (!__gtk_widget_get_has_window (sample))
    {
      *x += gtk_widget_get_props (sample)->allocation.x;
      *y += gtk_widget_get_props (sample)->allocation.y;
    }
  
  __gdk_window_get_root_coords (gtk_widget_get_props (sample)->window, *x, *y, x, y);

  *width = gtk_widget_get_props (sample)->allocation.width;

  hpolicy = vpolicy = GTK_POLICY_NEVER;
  __gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (priv->scrolled_window),
				  hpolicy, vpolicy);
  __gtk_widget_size_request (priv->scrolled_window, &popup_req);
  ...
  *height = popup_req.height;
  ...
  if (*y + gtk_widget_get_props (sample)->allocation.height + *height <= monitor.y + monitor.height)
    *y += gtk_widget_get_props (sample)->allocation.height;
  else if (*y - *height >= monitor.y)
    *y -= *height;
  else if (monitor.y + monitor.height - (*y + gtk_widget_get_props (sample)->allocation.height) > *y - monitor.y)
    {
      *y += gtk_widget_get_props (sample)->allocation.height;
...
cell_view_is_sensitive (GtkCellView *cell_view)
{
  ...
  cells = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (cell_view));
			      ...
			      GtkTreeIter *iter)
{
  ...
  __gtk_tree_view_column_cell_set_cell_data (priv->column,
					   priv->model,
					   iter, FALSE, FALSE);

  cells = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (priv->column));
			 ...
			 GtkWidget   *menu)
{
  ...
  children = __gtk_container_get_children (GTK_CONTAINER (menu));

  for (child = children; child; child = child->next)
    {
      item = GTK_WIDGET (child->data);
      cell_view = gtk_bin_get_props (GTK_BIN (item))->child;

      if (!GTK_IS_CELL_VIEW (cell_view))
	continue;
      
      submenu = __gtk_menu_item_get_submenu (GTK_MENU_ITEM (item));
      if (submenu != NULL)
	{
	  __gtk_widget_set_sensitive (item, TRUE);
      ...
      else
	{
	  ...
	  if (menu != priv->popup_widget && child == children)
	    ...
	    __gtk_widget_set_sensitive (item, sensitive);
	}
    }
			  ...
			  guint32      activate_time)
{
  ...
  if (__gtk_tree_row_reference_valid (priv->active_row))
    {
      path = __gtk_tree_row_reference_get_path (priv->active_row);
      active_item = __gtk_tree_path_get_indices (path)[0];
      __gtk_tree_path_free (path);
  ...
  /* FIXME handle nested menus better */
  __gtk_menu_set_active (GTK_MENU (priv->popup_widget), active_item);
  
  if (priv->wrap_width == 0)
    {
      width = gtk_widget_get_props (GTK_WIDGET (combo_box))->allocation.width;
      __gtk_widget_set_size_request (priv->popup_widget, -1, -1);
      __gtk_widget_size_request (priv->popup_widget, &requisition);
      
      __gtk_widget_set_size_request (priv->popup_widget,
				   MAX (width, requisition.width), -1);
    }
  
  __gtk_menu_popup (GTK_MENU (priv->popup_widget),
		  NULL, NULL,
...
{
  if ((__gdk_pointer_grab (window, TRUE,
			 GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK |
			 GDK_POINTER_MOTION_MASK,
			 NULL, NULL, activate_time) == 0))
    {
      if (!grab_keyboard ||
	  __gdk_keyboard_grab (window, TRUE,
			     activate_time) == 0)
	return TRUE;
      else
	{
	  __gdk_display_pointer_ungrab (__gdk_window_get_display (window),
				      activate_time);
	  return FALSE;
	}
    }
 ...
 */
void
__gtk_combo_box_popup (GtkComboBox *combo_box)
{
...
gtk_combo_box_real_popup (GtkComboBox *combo_box)
{
  ...
  if (!__gtk_widget_get_realized (GTK_WIDGET (combo_box)))
    return;

  if (__gtk_widget_get_mapped (priv->popup_widget))
    return;
  ...
  toplevel = __gtk_widget_get_toplevel (GTK_WIDGET (combo_box));
  if (GTK_IS_WINDOW (toplevel))
    {
      __gtk_window_group_add_window (__gtk_window_get_group (GTK_WINDOW (toplevel)),
                                   GTK_WINDOW (priv->popup_window));
      __gtk_window_set_transient_for (GTK_WINDOW (priv->popup_window),
                                    GTK_WINDOW (toplevel));
    }

  __gtk_widget_show_all (priv->scrolled_window);
  gtk_combo_box_list_position (combo_box, &x, &y, &width, &height);
  
  __gtk_widget_set_size_request (priv->popup_window, width, height);  
  __gtk_window_move (GTK_WINDOW (priv->popup_window), x, y);

  if (__gtk_tree_row_reference_valid (priv->active_row))
    {
      path = __gtk_tree_row_reference_get_path (priv->active_row);
      ppath = __gtk_tree_path_copy (path);
      if (__gtk_tree_path_up (ppath))
	__gtk_tree_view_expand_to_path (GTK_TREE_VIEW (priv->tree_view),
				      ppath);
      __gtk_tree_path_free (ppath);
    }
  __gtk_tree_view_set_hover_expand (GTK_TREE_VIEW (priv->tree_view), 
				  TRUE);
  
  /* popup */
  __gtk_window_set_screen (GTK_WINDOW (priv->popup_window),
                         __gtk_widget_get_screen (GTK_WIDGET (combo_box)));
  __gtk_widget_show (priv->popup_window);

  if (path)
    {
      __gtk_tree_view_set_cursor (GTK_TREE_VIEW (priv->tree_view),
				path, NULL, FALSE);
      __gtk_tree_path_free (path);
    }

  __gtk_widget_grab_focus (priv->popup_window);
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->button),
                                TRUE);
  ...
  __gtk_grab_add (priv->popup_window);
}

static gboolean
gtk_combo_box_real_popdown (GtkComboBox *combo_box)
{
  if (gtk_combo_box_get_props (combo_box)->priv->popup_shown)
    {
      __gtk_combo_box_popdown (combo_box);
      return TRUE;
    }
 ...
 */
void
__gtk_combo_box_popdown (GtkComboBox *combo_box)
{
  GtkComboBoxPrivate *priv = gtk_combo_box_get_props (combo_box)->priv;
  GdkDisplay *display;
  ...
  if (GTK_IS_MENU (priv->popup_widget))
    {
      __gtk_menu_popdown (GTK_MENU (priv->popup_widget));
      return;
    }
  ...
  __gtk_grab_remove (priv->popup_window);

  display = __gtk_widget_get_display (GTK_WIDGET (combo_box));
  __gdk_display_pointer_ungrab (display, GDK_CURRENT_TIME);
  __gdk_display_keyboard_ungrab (display, GDK_CURRENT_TIME);

  __gtk_widget_hide_all (priv->popup_window);
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->button),
                                FALSE);
}
                                    ...
                                    GtkTreePath *path)
{
  ...
  if (priv->cell_view)
    __gtk_widget_style_get (priv->cell_view,
  ...
  if (priv->cell_view)
    __gtk_cell_view_get_size_of_row (GTK_CELL_VIEW (priv->cell_view),
                                   path, &req);
  else
    req.width = 0;
...
gtk_combo_box_remeasure (GtkComboBox *combo_box)
{
  ...
  if (!priv->model ||
      !__gtk_tree_model_get_iter_first (priv->model, &iter))
    return;
                            ...
                            GtkRequisition *requisition)
{
  ...
  /* common */
  __gtk_widget_size_request (gtk_bin_get_props (GTK_BIN (widget))->child, &bin_req);
  ...
  __gtk_widget_set_size_request (priv->arrow, arrow_size, arrow_size);
  ...
  if (!priv->tree_view)
    {
	  ...
	  border_width = gtk_container_get_props (GTK_CONTAINER (combo_box))->border_width;
          ...
          __gtk_widget_size_request (priv->separator, &sep_req);
          __gtk_widget_size_request (priv->arrow, &arrow_req);
      ...
      else
        {
          ...
          __gtk_widget_size_request (priv->button, &but_req);
  ...
  else
    {
      ...
      *requisition = bin_req;
      ...
      if (priv->cell_view_frame)
        {
	  __gtk_widget_size_request (priv->cell_view_frame, &frame_req);
	  if (priv->has_frame)
	    {
	      requisition->width += 2 *
...
#define GTK_COMBO_BOX_SIZE_ALLOCATE_BUTTON 					\
  __gtk_widget_size_request (gtk_combo_box_get_props (combo_box)->priv->button, &req); 			\
  										\
  if (is_rtl) 									\
  ...
  child.height = MAX (1, child.height);						\
  										\
  __gtk_widget_size_allocate (gtk_combo_box_get_props (combo_box)->priv->button, &child);
                             ...
                             GtkAllocation *allocation)
{
  ...
  if (GTK_SHADOW_NONE != priv->shadow_type)
    {
      shadow_width = gtk_widget_get_props (widget)->style->xthickness;
      shadow_height = gtk_widget_get_props (widget)->style->ythickness;
    }
  else
    {
      shadow_width = 0;
  ...
  if (!priv->tree_view)
    {
	  ...
	  if (!priv->is_cell_renderer)
	    {
          ...
          /* handle the children */
          __gtk_widget_size_request (priv->arrow, &req);
          child.width = req.width;
          if (!is_rtl)
            child.x += width - req.width;
	  child.width = MAX (1, child.width);
	  child.height = MAX (1, child.height);
          __gtk_widget_size_allocate (priv->arrow, &child);
          if (is_rtl)
            child.x += req.width;
          __gtk_widget_size_request (priv->separator, &req);
          child.width = req.width;
          if (!is_rtl)
            child.x -= req.width;
	  child.width = MAX (1, child.width);
	  child.height = MAX (1, child.height);
          __gtk_widget_size_allocate (priv->separator, &child);
		...
		+ border_width + xthickness + focus_width + focus_pad;
          ...
          if (__gtk_widget_get_visible (priv->popup_widget))
            {
              gint width;
              GtkRequisition requisition;

              /* Warning here, without the check in the position func */
              __gtk_menu_reposition (GTK_MENU (priv->popup_widget));
              if (priv->wrap_width == 0)
                {
                  width = gtk_widget_get_props (GTK_WIDGET (combo_box))->allocation.width;
                  __gtk_widget_set_size_request (priv->popup_widget, -1, -1);
	  ...
	  child.width = MAX (1, child.width);
	  child.height = MAX (1, child.height);
          __gtk_widget_size_allocate (gtk_bin_get_props (GTK_BIN (widget))->child, &child);
        }
      else
        {
  ...
  else
    {
      ...
      int delta_x = shadow_width + gtk_container_get_props (GTK_CONTAINER (widget))->border_width;
      int delta_y = shadow_height + gtk_container_get_props (GTK_CONTAINER (widget))->border_width;
      ...
      if (priv->cell_view_frame)
        {
          ...
          __gtk_widget_size_allocate (priv->cell_view_frame, &child);
      ...
      if (__gtk_widget_get_visible (priv->popup_window))
        {
          gint x, y, width, height;
          gtk_combo_box_list_position (combo_box, &x, &y, &width, &height);
          __gtk_window_move (GTK_WINDOW (priv->popup_window), x, y);
...
gtk_combo_box_unset_model (GtkComboBox *combo_box)
{
  ...
  if (!priv->tree_view)
    {
      if (priv->popup_widget)
        __gtk_container_foreach (GTK_CONTAINER (priv->popup_widget),
                               (GtkCallback)__gtk_widget_destroy, NULL);
    }
  ...
  if (priv->active_row)
    {
      __gtk_tree_row_reference_free (priv->active_row);
      priv->active_row = NULL;
    }

  if (priv->cell_view)
    __gtk_cell_view_set_model (GTK_CELL_VIEW (priv->cell_view), NULL);
}
                      ...
                      gpointer      callback_data)
{
  ...
  if (gtk_bin_get_props (GTK_BIN (container))->child)
    (* callback) (gtk_bin_get_props (GTK_BIN (container))->child, callback_data);
}
                            ...
                            GdkEventExpose *event)
{
  ...
  if (__gtk_widget_is_drawable (widget) &&
      GTK_SHADOW_NONE != priv->shadow_type)
    {
      __gtk_paint_shadow (gtk_widget_get_props (widget)->style, gtk_widget_get_props (widget)->window,
                        ...
                        gtk_widget_get_props (widget)->allocation.x, gtk_widget_get_props (widget)->allocation.y,
  ...
  __gtk_container_propagate_expose (GTK_CONTAINER (widget),
                                  gtk_bin_get_props (GTK_BIN (widget))->child, event);
		...
		gpointer      data)
{
  ...
  if (__gtk_tree_path_compare (path, search_data->path) == 0)
	   ...
	   gboolean      visible)
{
  ...
  search_data.path = __gtk_tree_model_get_path (model, iter);
  search_data.visible = visible;
  search_data.found = FALSE;
  search_data.set = FALSE;

  __gtk_tree_model_foreach (model, tree_next_func, &search_data);
  
  *next = search_data.iter;

  __gtk_tree_path_free (search_data.path);
	   ...
	   gboolean      visible)
{
  ...
  __gtk_tree_model_foreach (model, tree_prev_func, &search_data);
	   ...
	   gboolean      visible)
{
  ...
  __gtk_tree_model_foreach (model, tree_last_func, &search_data);
	    ...
	    gboolean      visible)
{
  ...
  __gtk_tree_model_foreach (model, tree_first_func, &search_data);
                            ...
                            GdkEventScroll     *event)
{
  ...
  if (found)
    __gtk_combo_box_set_active_iter (combo_box, &new_iter);
  ...
  for (k = priv->cells; k; k = k->next)
    {
      ...
      if (info->pack == GTK_PACK_START)
        __gtk_cell_layout_pack_start (cell_layout,
                                    info->cell, info->expand);
      else if (info->pack == GTK_PACK_END)
        __gtk_cell_layout_pack_end (cell_layout,
                                  info->cell, info->expand);

      __gtk_cell_layout_set_cell_data_func (cell_layout,
                                          info->cell,
                                          combo_cell_data_func, info, NULL);

      for (j = info->attributes; j; j = j->next->next)
        {
          __gtk_cell_layout_add_attribute (cell_layout,
                                         info->cell,
                                         j->data,
                          ...
                          gboolean     add_children)
{
  ...
  if (priv->cell_view)
    {
      ...
      __gtk_button_set_focus_on_click (GTK_BUTTON (priv->button),
				     priv->focus_on_click);
      ...
      priv->separator = __gtk_vseparator_new ();
      __gtk_container_add (GTK_CONTAINER (priv->box), priv->separator);

      priv->arrow = __gtk_arrow_new (GTK_ARROW_DOWN, GTK_SHADOW_NONE);
      __gtk_container_add (GTK_CONTAINER (priv->box), priv->arrow);

      __gtk_widget_show_all (priv->button);
    }
  else
    {
      priv->button = __gtk_toggle_button_new ();
  ...
  menu = __gtk_menu_new ();
  __gtk_widget_set_name (menu, "gtk-combobox-popup-menu");
  __gtk_menu_set_reserve_toggle_size (GTK_MENU (menu), FALSE);
  ...
  priv->column = __gtk_tree_view_column_new ();
...
gtk_combo_box_menu_fill (GtkComboBox *combo_box)
{
  ...
  if (priv->add_tearoffs)
    {
      GtkWidget *tearoff = __gtk_tearoff_menu_item_new ();

      __gtk_widget_show (tearoff);
      
      if (priv->wrap_width)
	__gtk_menu_attach (GTK_MENU (menu), tearoff, 0, priv->wrap_width, 0, 1);
      else
	__gtk_menu_shell_append (GTK_MENU_SHELL (menu), tearoff);
    }
			     ...
			     GtkTreeIter  *iter)
{
  ...
  cell_view = __gtk_cell_view_new ();
  item = __gtk_menu_item_new ();
  __gtk_container_add (GTK_CONTAINER (item), cell_view);

  __gtk_cell_view_set_model (GTK_CELL_VIEW (cell_view), model);	  
  path = __gtk_tree_model_get_path (model, iter);
  __gtk_cell_view_set_displayed_row (GTK_CELL_VIEW (cell_view), path);
  __gtk_tree_path_free (path);

  gtk_combo_box_sync_cells (combo_box, GTK_CELL_LAYOUT (cell_view));
  __gtk_widget_size_request (cell_view, &req);
  __gtk_widget_show (cell_view);
			       ...
			       GtkTreeIter *parent)
{
  ...
  n_children = __gtk_tree_model_iter_n_children (model, parent);
  
  last = NULL;
  for (i = 0; i < n_children; i++)
    {
      __gtk_tree_model_iter_nth_child (model, &iter, parent, i);
	...
	is_separator = FALSE;
      ...
      if (is_separator)
	{
	  item = __gtk_separator_menu_item_new ();
	  path = __gtk_tree_model_get_path (model, &iter);
	  g_object_set_data_full (G_OBJECT (item),
				  I_("gtk-combo-box-item-path"),
				  __gtk_tree_row_reference_new (model, path),
      ...
      else
	{
	  ...
	  if (__gtk_tree_model_iter_has_child (model, &iter))
	    {
	      submenu = __gtk_menu_new ();
              __gtk_menu_set_reserve_toggle_size (GTK_MENU (submenu), FALSE);
	      __gtk_widget_show (submenu);
	      __gtk_menu_item_set_submenu (GTK_MENU_ITEM (item), submenu);
	      ...
	      separator = __gtk_separator_menu_item_new ();
	      __gtk_widget_show (subitem);
	      __gtk_widget_show (separator);
	      g_signal_connect (subitem, "activate",
				G_CALLBACK (gtk_combo_box_menu_item_activate),
				combo_box);
	      __gtk_menu_shell_append (GTK_MENU_SHELL (submenu), subitem);
	      __gtk_menu_shell_append (GTK_MENU_SHELL (submenu), separator);
...
gtk_combo_box_menu_destroy (GtkComboBox *combo_box)
{
  ...
  __gtk_widget_unparent (priv->button);
               ...
               guint      bottom_attach)
{
  ...
  for (i = gtk_menu_shell_get_props (GTK_MENU_SHELL (menu))->children; i; i = i->next)
    {
      guint l, r, b, t;

      __gtk_container_child_get (GTK_CONTAINER (menu), 
			       i->data,
                               "left-attach", &l,
                               "right-attach", &r,
                               "bottom-attach", &b,
			     ...
			     GtkWidget   *last)
{
  ...
  if (priv->col_column == -1 &&
    ...
    {
      if (priv->col_column != -1)
	__gtk_tree_model_get (priv->model, iter,
  ...
  /* set attach props */
  __gtk_menu_attach (GTK_MENU (menu), item,
                   current_col, current_col + cols,
                   current_row, current_row + rows);
}
...
gtk_combo_box_relayout (GtkComboBox *combo_box)
{
  ...
  menu = gtk_combo_box_get_props (combo_box)->priv->popup_widget;
  
  /* do nothing unless we are in menu style and realized */
  if (gtk_combo_box_get_props (combo_box)->priv->tree_view || !GTK_IS_MENU_SHELL (menu))
    return;
  
  list = __gtk_container_get_children (GTK_CONTAINER (menu));
  
  for (j = g_list_last (list); j; j = j->prev)
    __gtk_container_remove (GTK_CONTAINER (menu), j->data);
                                 ...
                                 gpointer        user_data)
{
  ...
  if (GTK_IS_MENU (priv->popup_widget) &&
      event->type == GDK_BUTTON_PRESS && event->button == 1)
    {
	  ...
	  !__gtk_widget_has_focus (priv->button))
	__gtk_widget_grab_focus (priv->button);
                                  ...
                                  gpointer   user_data)
{
  ...
  path = __gtk_cell_view_get_displayed_row (GTK_CELL_VIEW (cell_view));

  if (__gtk_tree_model_get_iter (gtk_combo_box_get_props (combo_box)->priv->model, &iter, path))
  {
    if (__gtk_menu_item_get_submenu (GTK_MENU_ITEM (item)) == NULL)
      __gtk_combo_box_set_active_iter (combo_box, &iter);
  }
...
gtk_combo_box_update_sensitivity (GtkComboBox *combo_box)
{
  ...
  if (!gtk_combo_box_get_props (combo_box)->priv->button)
    return;

  switch (gtk_combo_box_get_props (combo_box)->priv->button_sensitivity)
    {
      ...
      case GTK_SENSITIVITY_AUTO:
        sensitive = gtk_combo_box_get_props (combo_box)->priv->model &&
                    __gtk_tree_model_get_iter_first (gtk_combo_box_get_props (combo_box)->priv->model, &iter);
        break;
      default:
  ...
  __gtk_widget_set_sensitive (gtk_combo_box_get_props (combo_box)->priv->button, sensitive);

  /* In list-mode, we also need to update sensitivity of the event box */
  if (GTK_IS_TREE_VIEW (gtk_combo_box_get_props (combo_box)->priv->tree_view)
      && gtk_combo_box_get_props (combo_box)->priv->cell_view)
    __gtk_widget_set_sensitive (gtk_combo_box_get_props (combo_box)->priv->box, sensitive);
}
				  ...
				  gpointer          user_data)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->tree_view)
				 ...
				 gpointer          user_data)
{
  ...
  if (!__gtk_tree_row_reference_valid (priv->active_row))
    {
      if (priv->cell_view)
	__gtk_cell_view_set_displayed_row (GTK_CELL_VIEW (priv->cell_view), NULL);
				    ...
				    gpointer         user_data)
{
  ...
  __gtk_tree_row_reference_reordered (G_OBJECT (user_data), path, iter, new_order);
				 ...
				 gpointer          user_data)
{
  ...
  if (__gtk_tree_row_reference_valid (priv->active_row))
    {
      active_path = __gtk_tree_row_reference_get_path (priv->active_row);
      if (__gtk_tree_path_compare (path, active_path) == 0 &&
	  priv->cell_view)
	__gtk_widget_queue_resize (GTK_WIDGET (priv->cell_view));
      __gtk_tree_path_free (active_path);
    }
...
list_popup_resize_idle (gpointer user_data)
{
  ...
  if (priv->tree_view && __gtk_widget_get_mapped (priv->popup_window))
    {
      gtk_combo_box_list_position (combo_box, &x, &y, &width, &height);
...
gtk_combo_box_list_popup_resize (GtkComboBox *combo_box)
{
  ...
  if (!priv->resize_idle_id)
    priv->resize_idle_id = 
      __gdk_threads_add_idle (list_popup_resize_idle, combo_box);
}
                                 ...
                                 gpointer      user_data)
{
  ...
  pos = __gtk_tree_path_get_indices (path)[depth - 1];
  if (depth > 1)
    {
      ppath = __gtk_tree_path_copy (path);
      __gtk_tree_path_up (ppath);
      parent = find_menu_by_path (priv->popup_widget, ppath, FALSE);
      __gtk_tree_path_free (ppath);

      menu = __gtk_menu_item_get_submenu (GTK_MENU_ITEM (parent));
      if (!menu)
	{
	  menu = __gtk_menu_new ();
          __gtk_menu_set_reserve_toggle_size (GTK_MENU (menu), FALSE);
	  __gtk_widget_show (menu);
	  __gtk_menu_item_set_submenu (GTK_MENU_ITEM (parent), menu);
	  
	  /* Ugly - since menus can only activate leaves, we have to
	   * duplicate the item inside the submenu.
	   */
	  __gtk_tree_model_iter_parent (model, &piter, iter);
	  ...
	  g_signal_connect (item, "activate",
			    ...
			    combo_box);
	  __gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
	  __gtk_menu_shell_append (GTK_MENU_SHELL (menu), separator);
	  if (cell_view_is_sensitive (GTK_CELL_VIEW (gtk_bin_get_props (GTK_BIN (item))->child)))
	    {
	      __gtk_widget_show (item);
	      __gtk_widget_show (separator);
	    }
  ...
  __gtk_widget_show (item);
  __gtk_menu_shell_insert (GTK_MENU_SHELL (menu), item, pos);
}
                                ...
                                gpointer      user_data)
{
  ...
  menu = __gtk_widget_get_parent (item);
  __gtk_container_remove (GTK_CONTAINER (menu), item);
  ...
  if (__gtk_tree_path_get_depth (path) > 1)
    {
      ...
      parent_path = __gtk_tree_path_copy (path);
      __gtk_tree_path_up (parent_path);
      __gtk_tree_model_get_iter (model, &iter, parent_path);

      if (!__gtk_tree_model_iter_has_child (model, &iter))
	{
	  parent = find_menu_by_path (priv->popup_widget, 
				      parent_path, FALSE);
	  __gtk_menu_item_set_submenu (GTK_MENU_ITEM (parent), NULL);
	}
    }
}
                                ...
                                gpointer      user_data)
{
  ...
  if (priv->wrap_width && gtk_widget_get_props (item)->parent == priv->popup_widget)
    {
      GtkWidget *pitem = NULL;
      GtkTreePath *prev;

      prev = __gtk_tree_path_copy (path);

      if (__gtk_tree_path_prev (prev))
        pitem = find_menu_by_path (priv->popup_widget, prev, FALSE);

      __gtk_tree_path_free (prev);

      /* unattach item so gtk_combo_box_relayout_item() won't spuriously
         move it */
      __gtk_container_child_set (GTK_CONTAINER (priv->popup_widget),
                               item, 
			       "left-attach", -1, 
			       "right-attach", -1,
                               "top-attach", -1, 
  ...
  if (width > priv->width)
    {
      if (priv->cell_view)
	{
	  __gtk_widget_set_size_request (priv->cell_view, width, -1);
	  __gtk_widget_queue_resize (priv->cell_view);
	}
      priv->width = width;
    }
}
...
gtk_combo_box_list_setup (GtkComboBox *combo_box)
{
  ...
  if (priv->cell_view)
    {
      ...
      __gtk_cell_view_set_background_color (GTK_CELL_VIEW (priv->cell_view),
                                          &style->base[__gtk_widget_get_state (widget)]);

      priv->box = __gtk_event_box_new ();
      __gtk_event_box_set_visible_window (GTK_EVENT_BOX (priv->box), 
					FALSE);

      if (priv->has_frame)
	{
	  priv->cell_view_frame = __gtk_frame_new (NULL);
	  __gtk_frame_set_shadow_type (GTK_FRAME (priv->cell_view_frame),
				     GTK_SHADOW_IN);
	}
      else 
	{
	  gtk_combo_box_get_props (combo_box)->priv->cell_view_frame = __gtk_event_box_new ();
	  __gtk_event_box_set_visible_window (GTK_EVENT_BOX (gtk_combo_box_get_props (combo_box)->priv->cell_view_frame), 
					    FALSE);
	}
  ...
  priv->tree_view = __gtk_tree_view_new ();
  sel = __gtk_tree_view_get_selection (GTK_TREE_VIEW (priv->tree_view));
  __gtk_tree_selection_set_mode (sel, GTK_SELECTION_BROWSE);
  __gtk_tree_selection_set_select_function (sel,
					  gtk_combo_box_list_select_func,
					  NULL, NULL);
  __gtk_tree_view_set_headers_visible (GTK_TREE_VIEW (priv->tree_view),
                                     FALSE);
  __gtk_tree_view_set_hover_selection (GTK_TREE_VIEW (priv->tree_view),
				     TRUE);
  if (priv->row_separator_func)
    __gtk_tree_view_set_row_separator_func (GTK_TREE_VIEW (priv->tree_view), 
					  priv->row_separator_func, 
					  priv->row_separator_data, 
					  NULL);
  if (priv->model)
    __gtk_tree_view_set_model (GTK_TREE_VIEW (priv->tree_view), priv->model);
    
  priv->column = __gtk_tree_view_column_new ();
  __gtk_tree_view_append_column (GTK_TREE_VIEW (priv->tree_view), priv->column);
  ...
  __gtk_widget_show (priv->tree_view);
...
gtk_combo_box_list_destroy (GtkComboBox *combo_box)
{
  ...
  __gtk_widget_destroy (priv->tree_view);
                                   ...
                                   gpointer        data)
{
  ...
  GtkWidget *ewidget = __gtk_get_event_widget ((GdkEvent *)event);

  if (ewidget == priv->popup_window)
    return TRUE;

  if ((ewidget != priv->button && ewidget != priv->box) ||
      __gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (priv->button)))
    return FALSE;
  ...
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->button), TRUE);

  priv->auto_scroll = FALSE;
  if (priv->scroll_timer == 0)
    priv->scroll_timer = __gdk_threads_add_timeout (SCROLL_TIME, 
                                    ...
                                    gpointer        data)
{
  ...
  ret = __gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (priv->tree_view),
                                       event->x, event->y,
                                       &path,
                                       NULL, NULL, NULL);
  ...
  __gtk_tree_model_get_iter (priv->model, &iter, path);
                              ...
                              gpointer     data)
{
      ...
      event->keyval == GDK_space || event->keyval == GDK_KP_Space) 
  {
    ...
    if (gtk_combo_box_get_props (combo_box)->priv->model)
      {
	GtkTreeSelection *sel;

	sel = __gtk_tree_view_get_selection (GTK_TREE_VIEW (gtk_combo_box_get_props (combo_box)->priv->tree_view));
...
gtk_combo_box_list_auto_scroll (GtkComboBox *combo_box,
				...
				gint         y)
{
  GtkWidget *tree_view = gtk_combo_box_get_props (combo_box)->priv->tree_view;
  GtkAdjustment *adj;
  gdouble value;

  adj = __gtk_scrolled_window_get_hadjustment (GTK_SCROLLED_WINDOW (gtk_combo_box_get_props (combo_box)->priv->scrolled_window));
  if (gtk_adjustment_get_props (adj) && gtk_adjustment_get_props (adj)->upper - gtk_adjustment_get_props (adj)->lower > gtk_adjustment_get_props (adj)->page_size)
    {
      if (x <= gtk_widget_get_props (tree_view)->allocation.x && 
  ...
  adj = __gtk_scrolled_window_get_vadjustment (GTK_SCROLLED_WINDOW (gtk_combo_box_get_props (combo_box)->priv->scrolled_window));
  if (gtk_adjustment_get_props (adj) && gtk_adjustment_get_props (adj)->upper - gtk_adjustment_get_props (adj)->lower > gtk_adjustment_get_props (adj)->page_size)
    {
      if (y <= gtk_widget_get_props (tree_view)->allocation.y && 
	  gtk_adjustment_get_props (adj)->lower < gtk_adjustment_get_props (adj)->value)
	{
				 ...
				 gpointer          data)
{
  ...
  gtk_combo_box_get_props (combo_box)->priv->auto_scroll = TRUE;
				...
				gpointer          data)
{
  ...
  for (list = gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->columns; list && !sensitive; list = list->next)
	...
	continue;
      ...
      __gtk_tree_view_column_cell_set_cell_data (column, model, &iter,
					       FALSE, FALSE);

      cell = cells = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (column));
      while (cell)
        {
                                      ...
                                      gboolean         expand)
{
  ...
  priv = gtk_combo_box_get_props (combo_box)->priv;
  ...
  if (priv->cell_view)
    __gtk_cell_layout_pack_start (GTK_CELL_LAYOUT (priv->cell_view),
                                cell, expand);

  if (priv->column)
    __gtk_tree_view_column_pack_start (priv->column, cell, expand);
                                    ...
                                    gboolean         expand)
{
  ...
  if (priv->cell_view)
    __gtk_cell_layout_pack_end (GTK_CELL_LAYOUT (priv->cell_view),
                              cell, expand);

  if (priv->column)
    __gtk_tree_view_column_pack_end (priv->column, cell, expand);
...
gtk_combo_box_cell_layout_get_cells (GtkCellLayout *layout)
{
  ...
  for (list = gtk_combo_box_get_props (combo_box)->priv->cells; list; list = list->next)
    {
...
gtk_combo_box_cell_layout_clear (GtkCellLayout *layout)
{
  ...
  if (priv->cell_view)
    __gtk_cell_layout_clear (GTK_CELL_LAYOUT (priv->cell_view));

  if (priv->column)
    __gtk_tree_view_column_clear (priv->column);
                                         ...
                                         gint             column)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->cell_view)
    __gtk_cell_layout_add_attribute (GTK_CELL_LAYOUT (gtk_combo_box_get_props (combo_box)->priv->cell_view),
                                   cell, attribute, column);

  if (gtk_combo_box_get_props (combo_box)->priv->column)
    __gtk_cell_layout_add_attribute (GTK_CELL_LAYOUT (gtk_combo_box_get_props (combo_box)->priv->column),
                                   cell, attribute, column);

  if (GTK_IS_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget))
    add_attribute_recurse (gtk_combo_box_get_props (combo_box)->priv->popup_widget, cell, attribute, column);
  __gtk_widget_queue_resize (GTK_WIDGET (combo_box));
}
		      ...
		      gpointer         data)
{
  ...
  if (GTK_IS_WIDGET (cell_layout))
    parent = __gtk_widget_get_parent (GTK_WIDGET (cell_layout));
  
  if (GTK_IS_MENU_ITEM (parent) && 
      __gtk_menu_item_get_submenu (GTK_MENU_ITEM (parent)))
 ...
 list = __gtk_container_get_children (GTK_CONTAINER (menu));
  for (i = list; i; i = i->next)
      ...
      if (GTK_IS_CELL_LAYOUT (cell_view))
	{
	   ...
	   */ 
	  __gtk_cell_layout_set_cell_data_func (GTK_CELL_LAYOUT (cell_view), 
					      cell, 
                                              ...
                                              GDestroyNotify         destroy)
{
  ...
  if (priv->cell_view)
    __gtk_cell_layout_set_cell_data_func (GTK_CELL_LAYOUT (priv->cell_view), cell, func, func_data, NULL);

  if (priv->column)
    __gtk_cell_layout_set_cell_data_func (GTK_CELL_LAYOUT (priv->column), cell, func, func_data, NULL);
                                            ...
                                            GtkCellRenderer *cell)
{
  ...
  if (priv->cell_view)
    __gtk_cell_layout_clear_attributes (GTK_CELL_LAYOUT (priv->cell_view), cell);

  if (priv->column)
    __gtk_cell_layout_clear_attributes (GTK_CELL_LAYOUT (priv->column), cell);
                                   ...
                                   gint             position)
{
  ...
  if (priv->cell_view)
    __gtk_cell_layout_reorder (GTK_CELL_LAYOUT (priv->cell_view),
                             cell, position);

  if (priv->column)
    __gtk_cell_layout_reorder (GTK_CELL_LAYOUT (priv->column),
                             cell, position);

  if (GTK_IS_MENU (priv->popup_widget))
    reorder_recurse (priv->popup_widget, cell, position);

  __gtk_widget_queue_draw (GTK_WIDGET (combo_box));
}
 ...
 */
GtkWidget *
__gtk_combo_box_new (void)
{
  return g_object_new (GTK_TYPE_COMBO_BOX, NULL);
}

/**
 * __gtk_combo_box_new_with_entry:
 *
 ...
 */
GtkWidget *
__gtk_combo_box_new_with_entry (void)
{
  return g_object_new (GTK_TYPE_COMBO_BOX, "has-entry", TRUE, NULL);
}

/**
 * __gtk_combo_box_new_with_model:
 ...
 */
GtkWidget *
__gtk_combo_box_new_with_model (GtkTreeModel *model)
{
  GtkComboBox *combo_box;
...
/**
 * __gtk_combo_box_new_with_model_and_entry:
 *
 * Creates a new empty #GtkComboBox with an entry
 ...
 */
GtkWidget *
__gtk_combo_box_new_with_model_and_entry (GtkTreeModel *model)
{
...
/**
 * __gtk_combo_box_get_wrap_width:
 * @combo_box: A #GtkComboBox
 *
 ...
 */
gint
__gtk_combo_box_get_wrap_width (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), -1);

  return gtk_combo_box_get_props (combo_box)->priv->wrap_width;
}

/**
 * __gtk_combo_box_set_wrap_width:
 * @combo_box: A #GtkComboBox
 ...
 */
void
__gtk_combo_box_set_wrap_width (GtkComboBox *combo_box,
                              gint         width)
{
  GtkComboBoxPrivate *priv;
...
/**
 * __gtk_combo_box_get_row_span_column:
 * @combo_box: A #GtkComboBox
 *
 ...
 */
gint
__gtk_combo_box_get_row_span_column (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), -1);

  return gtk_combo_box_get_props (combo_box)->priv->row_column;
}

/**
 * __gtk_combo_box_set_row_span_column:
 * @combo_box: A #GtkComboBox.
 ...
 */
void
__gtk_combo_box_set_row_span_column (GtkComboBox *combo_box,
                                   gint         row_span)
{
  GtkComboBoxPrivate *priv;
  gint col;
  ...
  col = __gtk_tree_model_get_n_columns (priv->model);
...
/**
 * __gtk_combo_box_get_column_span_column:
 * @combo_box: A #GtkComboBox
 *
 ...
 */
gint
__gtk_combo_box_get_column_span_column (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), -1);

  return gtk_combo_box_get_props (combo_box)->priv->col_column;
}

/**
 * __gtk_combo_box_set_column_span_column:
 * @combo_box: A #GtkComboBox
 ...
 */
void
__gtk_combo_box_set_column_span_column (GtkComboBox *combo_box,
                                      gint         column_span)
{
  GtkComboBoxPrivate *priv;
  gint col;
...
/**
 * __gtk_combo_box_get_active:
 * @combo_box: A #GtkComboBox
 *
 * Returns the index of the currently active item, or -1 if there's no
 * active item. If the model is a non-flat treemodel, and the active item 
 * is not an immediate child of the root of the tree, this function returns 
 * <literal>__gtk_tree_path_get_indices (path)[0]</literal>, where 
 ...
 */
gint
__gtk_combo_box_get_active (GtkComboBox *combo_box)
{
  GtkComboBoxPrivate *priv;
  gint result;
  ...
  if (__gtk_tree_row_reference_valid (priv->active_row))
    {
      ...
      path = __gtk_tree_row_reference_get_path (priv->active_row);      
      result = __gtk_tree_path_get_indices (path)[0];
      __gtk_tree_path_free (path);
    }
  else
    result = -1;
 ...
 */
void
__gtk_combo_box_set_active (GtkComboBox *combo_box,
                          gint         index_)
{
  GtkTreePath *path = NULL;
  g_return_if_fail (GTK_IS_COMBO_BOX (combo_box));
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->model == NULL)
    {
      /* Save index, in case the model is set after the index */
      gtk_combo_box_get_props (combo_box)->priv->active = index_;
      if (index_ != -1)
        return;
    }

  if (index_ != -1)
    path = __gtk_tree_path_new_from_indices (index_, -1);
...
static void
__gtk_combo_box_set_active_internal (GtkComboBox *combo_box,
				   GtkTreePath *path)
{
  GtkComboBoxPrivate *priv = gtk_combo_box_get_props (combo_box)->priv;
  GtkTreePath *active_path;
  ...
  gboolean is_valid_row_reference = __gtk_tree_row_reference_valid (priv->active_row);

  if (path && is_valid_row_reference)
    {
      active_path = __gtk_tree_row_reference_get_path (priv->active_row);
      path_cmp = __gtk_tree_path_compare (path, active_path);
      __gtk_tree_path_free (active_path);
      if (path_cmp == 0)
	return;
    }
  ...
  if (!path)
    {
      if (priv->tree_view)
        __gtk_tree_selection_unselect_all (__gtk_tree_view_get_selection (GTK_TREE_VIEW (priv->tree_view)));
      else
        {
          GtkMenu *menu = GTK_MENU (priv->popup_widget);

          if (GTK_IS_MENU (menu))
            __gtk_menu_set_active (menu, -1);
        }
    ...
    {
      priv->active_row = 
	__gtk_tree_row_reference_new (priv->model, path);
      ...
      if (priv->tree_view)
	{
	  __gtk_tree_view_set_cursor (GTK_TREE_VIEW (priv->tree_view), 
        ...
        {
	  /* FIXME handle nested menus better */
	  __gtk_menu_set_active (GTK_MENU (priv->popup_widget), 
			       __gtk_tree_path_get_indices (path)[0]);
        }

      if (priv->cell_view)
	__gtk_cell_view_set_displayed_row (GTK_CELL_VIEW (priv->cell_view), 
					 path);
    }
...
/**
 * __gtk_combo_box_get_active_iter:
 * @combo_box: A #GtkComboBox
 ...
 */
gboolean
__gtk_combo_box_get_active_iter (GtkComboBox     *combo_box,
                               GtkTreeIter     *iter)
{
  GtkTreePath *path;
  gboolean result;
  ...
  if (!__gtk_tree_row_reference_valid (gtk_combo_box_get_props (combo_box)->priv->active_row))
    return FALSE;

  path = __gtk_tree_row_reference_get_path (gtk_combo_box_get_props (combo_box)->priv->active_row);
  result = __gtk_tree_model_get_iter (gtk_combo_box_get_props (combo_box)->priv->model, iter, path);
  __gtk_tree_path_free (path);
...
/**
 * __gtk_combo_box_set_active_iter:
 * @combo_box: A #GtkComboBox
 ...
 */
void
__gtk_combo_box_set_active_iter (GtkComboBox     *combo_box,
                               GtkTreeIter     *iter)
{
  GtkTreePath *path = NULL;
  ...
  if (iter)
    path = __gtk_tree_model_get_path (__gtk_combo_box_get_model (combo_box), iter);
 ...
 * call __gtk_cell_layout_clear() yourself if you need to set up different 
 * cell renderers for the new model.
 *
 * Since: 2.4
 */
void
__gtk_combo_box_set_model (GtkComboBox  *combo_box,
                         GtkTreeModel *model)
{
  g_return_if_fail (GTK_IS_COMBO_BOX (combo_box));
  g_return_if_fail (model == NULL || GTK_IS_TREE_MODEL (model));

  if (model == gtk_combo_box_get_props (combo_box)->priv->model)
    return;
  ...
  gtk_combo_box_get_props (combo_box)->priv->model = model;
  g_object_ref (gtk_combo_box_get_props (combo_box)->priv->model);

  gtk_combo_box_get_props (combo_box)->priv->inserted_id =
    g_signal_connect (gtk_combo_box_get_props (combo_box)->priv->model, "row-inserted",
		      G_CALLBACK (gtk_combo_box_model_row_inserted),
		      combo_box);
  gtk_combo_box_get_props (combo_box)->priv->deleted_id =
    g_signal_connect (gtk_combo_box_get_props (combo_box)->priv->model, "row-deleted",
		      G_CALLBACK (gtk_combo_box_model_row_deleted),
		      combo_box);
  gtk_combo_box_get_props (combo_box)->priv->reordered_id =
    g_signal_connect (gtk_combo_box_get_props (combo_box)->priv->model, "rows-reordered",
		      G_CALLBACK (gtk_combo_box_model_rows_reordered),
		      combo_box);
  gtk_combo_box_get_props (combo_box)->priv->changed_id =
    g_signal_connect (gtk_combo_box_get_props (combo_box)->priv->model, "row-changed",
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->tree_view)
    {
      /* list mode */
      __gtk_tree_view_set_model (GTK_TREE_VIEW (gtk_combo_box_get_props (combo_box)->priv->tree_view),
                               gtk_combo_box_get_props (combo_box)->priv->model);
      gtk_combo_box_list_popup_resize (combo_box);
    }
  else
    {
      /* menu mode */
      if (gtk_combo_box_get_props (combo_box)->priv->popup_widget)
	gtk_combo_box_menu_fill (combo_box);

    }

  if (gtk_combo_box_get_props (combo_box)->priv->cell_view)
    __gtk_cell_view_set_model (GTK_CELL_VIEW (gtk_combo_box_get_props (combo_box)->priv->cell_view),
                             gtk_combo_box_get_props (combo_box)->priv->model);
 ...
 */
GtkTreeModel *
__gtk_combo_box_get_model (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), NULL);

  return gtk_combo_box_get_props (combo_box)->priv->model;
}
 ...
 * following convenience functions: __gtk_combo_box_append_text(),
 * __gtk_combo_box_insert_text(), __gtk_combo_box_prepend_text() and
 * __gtk_combo_box_remove_text().
 *
 ...
 */
GtkWidget *
__gtk_combo_box_new_text (void)
{
  GtkWidget *combo_box;
  GtkCellRenderer *cell;
  GtkListStore *store;

  store = __gtk_list_store_new (1, G_TYPE_STRING);
  combo_box = __gtk_combo_box_new_with_model (GTK_TREE_MODEL (store));
  g_object_unref (store);

  cell = __gtk_cell_renderer_text_new ();
  __gtk_cell_layout_pack_start (GTK_CELL_LAYOUT (combo_box), cell, TRUE);
  __gtk_cell_layout_set_attributes (GTK_CELL_LAYOUT (combo_box), cell,
                                  "text", 0,
                                  NULL);
...
/**
 * __gtk_combo_box_append_text:
 * @combo_box: A #GtkComboBox constructed using __gtk_combo_box_new_text()
 * @text: A string
 *
 ...
 */
void
__gtk_combo_box_append_text (GtkComboBox *combo_box,
                           const gchar *text)
{
  GtkTreeIter iter;
  GtkListStore *store;
  ...
  g_return_if_fail (GTK_IS_COMBO_BOX (combo_box));
  g_return_if_fail (GTK_IS_LIST_STORE (gtk_combo_box_get_props (combo_box)->priv->model));
  g_return_if_fail (__gtk_tree_model_get_column_type (gtk_combo_box_get_props (combo_box)->priv->model, 0)
		    == G_TYPE_STRING);
  g_return_if_fail (text != NULL);

  store = GTK_LIST_STORE (gtk_combo_box_get_props (combo_box)->priv->model);

  __gtk_list_store_append (store, &iter);
  __gtk_list_store_set (store, &iter, 0, text, -1);
}

/**
 * __gtk_combo_box_insert_text:
 * @combo_box: A #GtkComboBox constructed using __gtk_combo_box_new_text()
 ...
 */
void
__gtk_combo_box_insert_text (GtkComboBox *combo_box,
                           gint         position,
                           const gchar *text)
{
  GtkTreeIter iter;
  ...
  __gtk_list_store_insert (store, &iter, position);
  __gtk_list_store_set (store, &iter, 0, text, -1);
}

/**
 * __gtk_combo_box_prepend_text:
 * @combo_box: A #GtkComboBox constructed with __gtk_combo_box_new_text()
 * @text: A string
 *
 ...
 */
void
__gtk_combo_box_prepend_text (GtkComboBox *combo_box,
                            const gchar *text)
{
  GtkTreeIter iter;
  GtkListStore *store;
  ...
  __gtk_list_store_prepend (store, &iter);
  __gtk_list_store_set (store, &iter, 0, text, -1);
}
 ...
 * this function with combo boxes constructed with __gtk_combo_box_new_text().
 *
 * Since: 2.4
 *
 * Deprecated: 2.24: Use #GtkComboBoxText
 */
void
__gtk_combo_box_remove_text (GtkComboBox *combo_box,
                           gint         position)
{
  GtkTreeIter iter;
  GtkListStore *store;
  ...
  if (__gtk_tree_model_iter_nth_child (gtk_combo_box_get_props (combo_box)->priv->model, &iter,
                                     NULL, position))
    __gtk_list_store_remove (store, &iter);
}

/**
 * __gtk_combo_box_get_active_text:
 * @combo_box: A #GtkComboBox constructed with __gtk_combo_box_new_text()
 *
 * Returns the currently active string in @combo_box or %NULL if none
 * is selected. Note that you can only use this function with combo
 * boxes constructed with __gtk_combo_box_new_text() and with
 * #GtkComboBoxEntry<!-- -->s.
 *
 ...
 * __gtk_combo_box_new_text() then you should now use #GtkComboBoxText and 
 * __gtk_combo_box_text_get_active_text() instead. Or if you used this with a
 * #GtkComboBoxEntry then you should now use #GtkComboBox with 
 * #GtkComboBox:has-entry as %TRUE and use
 * __gtk_entry_get_text (GTK_ENTRY (__gtk_bin_get_child (GTK_BIN (combobox))).
 */
gchar *
__gtk_combo_box_get_active_text (GtkComboBox *combo_box)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->has_entry)
    {
      ...
      child = __gtk_bin_get_child (combo);
      if (child)
	return g_strdup (__gtk_entry_get_text (GTK_ENTRY (child)));

      return NULL;
    }
  else
    {
      g_return_val_if_fail (GTK_IS_LIST_STORE (gtk_combo_box_get_props (combo_box)->priv->model), NULL);
      g_return_val_if_fail (__gtk_tree_model_get_column_type (gtk_combo_box_get_props (combo_box)->priv->model, 0)
			    == G_TYPE_STRING, NULL);

      if (__gtk_combo_box_get_active_iter (combo_box, &iter))
        __gtk_tree_model_get (gtk_combo_box_get_props (combo_box)->priv->model, &iter,
			    0, &text, -1);
                                ...
                                GtkScrollType  scroll)
{
  ...
  if (!gtk_combo_box_get_props (combo_box)->priv->model)
    {
      __gtk_widget_error_bell (GTK_WIDGET (combo_box));
      return;
    }

  active_iter = __gtk_combo_box_get_active_iter (combo_box, &iter);
  ...
  if (found && active_iter)
    {
      ...
      old_path = __gtk_tree_model_get_path (gtk_combo_box_get_props (combo_box)->priv->model, &iter);
      new_path = __gtk_tree_model_get_path (gtk_combo_box_get_props (combo_box)->priv->model, &new_iter);

      if (__gtk_tree_path_compare (old_path, new_path) == 0)
        found = FALSE;

      __gtk_tree_path_free (old_path);
      __gtk_tree_path_free (new_path);
    }
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->has_entry)
    {
      ...
      child = __gtk_bin_get_child (GTK_BIN (combo_box));
      if (child)
	__gtk_widget_grab_focus (child);
    }
  else
    __gtk_widget_grab_focus (gtk_combo_box_get_props (combo_box)->priv->button);
                                      ...
                                      gpointer  user_data)
{
   ...
   */
  if (__gtk_combo_box_get_active(combo_box) == -1)
    g_signal_emit_by_name (combo_box, "changed");
  else
    __gtk_combo_box_set_active (combo_box, -1);
}
                                    ...
                                    gpointer     user_data)
{
  ...
  if (__gtk_combo_box_get_active_iter (combo_box, &iter))
    {
      GtkEntry *entry = GTK_ENTRY (__gtk_bin_get_child (GTK_BIN (combo_box)));
  ...
  if (priv->has_entry)
    {
      ...
      __gtk_container_add (GTK_CONTAINER (combo_box), entry);

      priv->text_renderer = __gtk_cell_renderer_text_new ();
      __gtk_cell_layout_pack_start (GTK_CELL_LAYOUT (combo_box),
				  priv->text_renderer, TRUE);

      __gtk_combo_box_set_active (GTK_COMBO_BOX (combo_box), -1);
...
gtk_combo_box_dispose(GObject* object)
{
  ...
  if (GTK_IS_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget))
    {
      gtk_combo_box_menu_destroy (combo_box);
      __gtk_menu_detach (GTK_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget));
      gtk_combo_box_get_props (combo_box)->priv->popup_widget = NULL;
    }
...
gtk_combo_box_finalize (GObject *object)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->popup_window)
    __gtk_widget_destroy (gtk_combo_box_get_props (combo_box)->priv->popup_window);
  ...
  for (i = gtk_combo_box_get_props (combo_box)->priv->cells; i; i = i->next)
   ...
   g_slist_free (gtk_combo_box_get_props (combo_box)->priv->cells);

   g_free (gtk_combo_box_get_props (combo_box)->priv->tearoff_title);
  ...
  if (event->keyval == GDK_Escape)
    {
      g_object_set (combo_box,
                    ...
                    NULL);
      __gtk_cell_editable_editing_done (GTK_CELL_EDITABLE (combo_box));
      __gtk_cell_editable_remove_widget (GTK_CELL_EDITABLE (combo_box));
...
popdown_handler (GtkWidget *widget,
		 gpointer   data)
{
  __gdk_threads_add_idle (popdown_idle, g_object_ref (data));
}
...
popup_idle (gpointer data)
{
  ...
  if (GTK_IS_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget) &&
      gtk_combo_box_get_props (combo_box)->priv->cell_view)
    g_signal_connect_object (gtk_combo_box_get_props (combo_box)->priv->popup_widget,
  ...
  gtk_combo_box_get_props (combo_box)->priv->popup_idle_id = 0;
  gtk_combo_box_get_props (combo_box)->priv->activate_button = 0;
  gtk_combo_box_get_props (combo_box)->priv->activate_time = 0;
			     ...
			     GdkEvent        *event)
{
  ...
  gtk_combo_box_get_props (combo_box)->priv->is_cell_renderer = TRUE;

  if (gtk_combo_box_get_props (combo_box)->priv->cell_view)
    {
      g_signal_connect_object (gtk_combo_box_get_props (combo_box)->priv->button, "key-press-event",
   ...
   * appearance 
   */  
  if (gtk_combo_box_get_props (combo_box)->priv->is_cell_renderer && 
      gtk_combo_box_get_props (combo_box)->priv->cell_view && !gtk_combo_box_get_props (combo_box)->priv->tree_view)
    {
      if (event && event->type == GDK_BUTTON_PRESS)
        {
          GdkEventButton *event_button = (GdkEventButton *)event;

          gtk_combo_box_get_props (combo_box)->priv->activate_button = event_button->button;
          gtk_combo_box_get_props (combo_box)->priv->activate_time = event_button->time;
        }

      gtk_combo_box_get_props (combo_box)->priv->popup_idle_id = 
          __gdk_threads_add_idle (popup_idle, combo_box);
    }
}


/**
 * __gtk_combo_box_get_add_tearoffs:
 * @combo_box: a #GtkComboBox
 * 
 ...
 */
gboolean
__gtk_combo_box_get_add_tearoffs (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), FALSE);

  return gtk_combo_box_get_props (combo_box)->priv->add_tearoffs;
}

/**
 * __gtk_combo_box_set_add_tearoffs:
 * @combo_box: a #GtkComboBox 
 ...
 */
void
__gtk_combo_box_set_add_tearoffs (GtkComboBox *combo_box,
				gboolean     add_tearoffs)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->add_tearoffs != add_tearoffs)
    {
      gtk_combo_box_get_props (combo_box)->priv->add_tearoffs = add_tearoffs;
      gtk_combo_box_check_appearance (combo_box);
      gtk_combo_box_relayout (combo_box);
 ...
 */
const gchar*
__gtk_combo_box_get_title (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), NULL);
  
  return gtk_combo_box_get_props (combo_box)->priv->tearoff_title;
}
...
gtk_combo_box_update_title (GtkComboBox *combo_box)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->popup_widget && 
      GTK_IS_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget))
    __gtk_menu_set_title (GTK_MENU (gtk_combo_box_get_props (combo_box)->priv->popup_widget), 
			gtk_combo_box_get_props (combo_box)->priv->tearoff_title);
}

/**
 * __gtk_combo_box_set_title:
 * @combo_box: a #GtkComboBox 
 ...
 */
void
__gtk_combo_box_set_title (GtkComboBox *combo_box,
			 const gchar *title)
{
  GtkComboBoxPrivate *priv;
...
/**
 * __gtk_combo_box_get_popup_accessible:
 * @combo_box: a #GtkComboBox
 *
 ...
 */
AtkObject*
__gtk_combo_box_get_popup_accessible (GtkComboBox *combo_box)
{
  AtkObject *atk_obj;
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->popup_widget)
    {
      atk_obj = __gtk_widget_get_accessible (gtk_combo_box_get_props (combo_box)->priv->popup_widget);
      return atk_obj;
    }
...
/**
 * __gtk_combo_box_get_row_separator_func:
 * @combo_box: a #GtkComboBox
 * 
...
__gtk_combo_box_get_row_separator_func (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), NULL);

  return gtk_combo_box_get_props (combo_box)->priv->row_separator_func;
}

/**
 * __gtk_combo_box_set_row_separator_func:
 * @combo_box: a #GtkComboBox
 ...
 */
void
__gtk_combo_box_set_row_separator_func (GtkComboBox                 *combo_box,
				      ...
				      GDestroyNotify               destroy)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->row_separator_destroy)
    gtk_combo_box_get_props (combo_box)->priv->row_separator_destroy (gtk_combo_box_get_props (combo_box)->priv->row_separator_data);

  gtk_combo_box_get_props (combo_box)->priv->row_separator_func = func;
  gtk_combo_box_get_props (combo_box)->priv->row_separator_data = data;
  gtk_combo_box_get_props (combo_box)->priv->row_separator_destroy = destroy;

  if (gtk_combo_box_get_props (combo_box)->priv->tree_view)
    __gtk_tree_view_set_row_separator_func (GTK_TREE_VIEW (gtk_combo_box_get_props (combo_box)->priv->tree_view), 
					  func, data, NULL);
...
/**
 * __gtk_combo_box_set_button_sensitivity:
 * @combo_box: a #GtkComboBox
 ...
 **/
void
__gtk_combo_box_set_button_sensitivity (GtkComboBox        *combo_box,
                                      GtkSensitivityType  sensitivity)
{
  g_return_if_fail (GTK_IS_COMBO_BOX (combo_box));

  if (gtk_combo_box_get_props (combo_box)->priv->button_sensitivity != sensitivity)
    {
      gtk_combo_box_get_props (combo_box)->priv->button_sensitivity = sensitivity;
      gtk_combo_box_update_sensitivity (combo_box);
...
/**
 * __gtk_combo_box_get_button_sensitivity:
 * @combo_box: a #GtkComboBox
 *
 ...
 **/
GtkSensitivityType
__gtk_combo_box_get_button_sensitivity (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), FALSE);

  return gtk_combo_box_get_props (combo_box)->priv->button_sensitivity;
}


/**
 * __gtk_combo_box_get_has_entry:
 * @combo_box: a #GtkComboBox
 *
 ...
 **/
gboolean
__gtk_combo_box_get_has_entry (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), FALSE);

  return gtk_combo_box_get_props (combo_box)->priv->has_entry;
}

/**
 * __gtk_combo_box_set_entry_text_column:
 * @combo_box: A #GtkComboBox
 ...
 */
void
__gtk_combo_box_set_entry_text_column (GtkComboBox *combo_box,
				     gint         text_column)
{
  GtkComboBoxPrivate *priv = gtk_combo_box_get_props (combo_box)->priv;
  GtkTreeModel *model;
  ...
  if (priv->text_renderer)
    __gtk_cell_layout_set_attributes (GTK_CELL_LAYOUT (combo_box),
                                    priv->text_renderer,
                                    "text", text_column,
                                    NULL);
}
...
/**
 * __gtk_combo_box_get_entry_text_column:
 * @combo_box: A #GtkComboBox.
 *
 ...
 */
gint
__gtk_combo_box_get_entry_text_column (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), 0);

  return gtk_combo_box_get_props (combo_box)->priv->text_column;
}

/**
 * __gtk_combo_box_set_focus_on_click:
 * @combo: a #GtkComboBox
 ...
 */
void
__gtk_combo_box_set_focus_on_click (GtkComboBox *combo_box,
				  gboolean     focus_on_click)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->focus_on_click != focus_on_click)
    {
      gtk_combo_box_get_props (combo_box)->priv->focus_on_click = focus_on_click;

      if (gtk_combo_box_get_props (combo_box)->priv->button)
	__gtk_button_set_focus_on_click (GTK_BUTTON (gtk_combo_box_get_props (combo_box)->priv->button),
				       focus_on_click);
...
/**
 * __gtk_combo_box_get_focus_on_click:
 * @combo: a #GtkComboBox
 * 
 * Returns whether the combo box grabs focus when it is clicked 
 * with the mouse. See __gtk_combo_box_set_focus_on_click().
 *
 ...
 */
gboolean
__gtk_combo_box_get_focus_on_click (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_COMBO_BOX (combo_box), FALSE);
  
  return gtk_combo_box_get_props (combo_box)->priv->focus_on_click;
}
					    ...
					    const gchar  *childname)
{
  ...
  if (gtk_combo_box_get_props (combo_box)->priv->has_entry && strcmp (childname, "entry") == 0)
    return G_OBJECT (__gtk_bin_get_child (GTK_BIN (buildable)));
