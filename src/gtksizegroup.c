			     ...
			     GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_MODE:
      __gtk_size_group_set_mode (size_group, g_value_get_enum (value));
      break;
    case PROP_IGNORE_HIDDEN:
      __gtk_size_group_set_ignore_hidden (size_group, g_value_get_boolean (value));
      break;
    default:
 ...
 **/
GtkSizeGroup *
__gtk_size_group_new (GtkSizeGroupMode mode)
{
 ...
 **/
void
__gtk_size_group_set_mode (GtkSizeGroup     *size_group,
			 GtkSizeGroupMode  mode)
{
...
/**
 * __gtk_size_group_get_mode:
 * @size_group: a #GtkSizeGroup
 * 
 * Gets the current mode of the size group. See __gtk_size_group_set_mode().
 * 
 * Return value: the current mode of the size group.
 **/
GtkSizeGroupMode
__gtk_size_group_get_mode (GtkSizeGroup *size_group)
{
...
/**
 * __gtk_size_group_set_ignore_hidden:
 * @size_group: a #GtkSizeGroup
 ...
 */
void
__gtk_size_group_set_ignore_hidden (GtkSizeGroup *size_group,
...
/**
 * __gtk_size_group_get_ignore_hidden:
 * @size_group: a #GtkSizeGroup
 *
 ...
 */
gboolean
__gtk_size_group_get_ignore_hidden (GtkSizeGroup *size_group)
{
...
{
  __gtk_size_group_remove_widget (size_group, widget);
}

/**
 * __gtk_size_group_add_widget:
 * @size_group: a #GtkSizeGroup
 ...
 * depends on the mode of the size group. See __gtk_size_group_set_mode().
 *
 * When the widget is destroyed or no longer referenced elsewhere, it will 
 * be removed from the size group.
 */
void
__gtk_size_group_add_widget (GtkSizeGroup     *size_group,
			   GtkWidget        *widget)
{
  GSList *groups;
...
/**
 * __gtk_size_group_remove_widget:
 ...
 **/
void
__gtk_size_group_remove_widget (GtkSizeGroup *size_group,
			      GtkWidget    *widget)
{
  GSList *groups;
...
/**
 * ___gtk_size_group_get_child_requisition:
 * @widget: a #GtkWidget
 ...
 **/
void
___gtk_size_group_get_child_requisition (GtkWidget      *widget,
				       GtkRequisition *requisition)
{
  initialize_size_group_quarks ();
...
/**
 * ___gtk_size_group_compute_requisition:
 * @widget: a #GtkWidget
 * @requisition: location to store computed requisition.
 * 
 ...
 **/
void
___gtk_size_group_compute_requisition (GtkWidget      *widget,
				     GtkRequisition *requisition)
{
  gint width;
  gint height;
...
/**
 * ___gtk_size_group_queue_resize:
 * @widget: a #GtkWidget
 * 
 * Queue a resize on a widget, and on all other widgets grouped with this widget.
 **/
void
___gtk_size_group_queue_resize (GtkWidget *widget)
{
  initialize_size_group_quarks ();
  ...
  for (l = data->items; l; l = l->next)
      ...
      if (!object)
	{
	  g_warning ("Unknown object %s specified in sizegroup %s",
		     (const gchar*)l->data,
		     __gtk_buildable_get_name (GTK_BUILDABLE (data->object)));
	  continue;
	}
      __gtk_size_group_add_widget (GTK_SIZE_GROUP (data->object),
				 GTK_WIDGET (object));
      g_free (l->data);
    }
