 ...
 **/
void
__gtk_tree_selection_set_mode (GtkTreeSelection *selection,
  ...
  if (type == GTK_SELECTION_NONE)
    {
      ...
      __gtk_tree_row_reference_free (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor);
      gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor = NULL;
    }
	   ...
	   type == GTK_SELECTION_BROWSE)
    {
      ...
      if (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor)
	{
          anchor_path = __gtk_tree_row_reference_get_path (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor);
 ...
 **/
GtkSelectionMode
__gtk_tree_selection_get_mode (GtkTreeSelection *selection)
{
...
/**
 * __gtk_tree_selection_set_select_function:
 * @selection: A #GtkTreeSelection.
 ...
 **/
void
__gtk_tree_selection_set_select_function (GtkTreeSelection     *selection,
...
/**
 * __gtk_tree_selection_get_select_function: (skip)
 * @selection: A #GtkTreeSelection.
 *
...
__gtk_tree_selection_get_select_function (GtkTreeSelection *selection)
{
...
/**
 * __gtk_tree_selection_get_user_data: (skip)
 * @selection: A #GtkTreeSelection.
 *
 ...
 **/
gpointer
__gtk_tree_selection_get_user_data (GtkTreeSelection *selection)
{
  g_return_val_if_fail (GTK_IS_TREE_SELECTION (selection), NULL);
...
/**
 * __gtk_tree_selection_get_tree_view:
 * @selection: A #GtkTreeSelection
 * 
 ...
 **/
GtkTreeView *
__gtk_tree_selection_get_tree_view (GtkTreeSelection *selection)
{
  g_return_val_if_fail (GTK_IS_TREE_SELECTION (selection), NULL);
...
/**
 * __gtk_tree_selection_get_selected:
 * @selection: A #GtkTreeSelection.
 ...
 **/
gboolean
__gtk_tree_selection_get_selected (GtkTreeSelection  *selection,
				 GtkTreeModel     **model,
				 GtkTreeIter       *iter)
{
  GtkRBTree *tree;
  ...
  if (model)
    *model = gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model;

  if (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor == NULL)
    return FALSE;
  ...
  if (found_node && GTK_RBNODE_FLAG_SET (node, GTK_RBNODE_IS_SELECTED))
	...
	retval = TRUE;
        ...
        retval = __gtk_tree_model_get_iter (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model,
                                          iter,
                                          anchor_path);
    }
  else
...
/**
 * __gtk_tree_selection_get_selected_rows:
 * @selection: A #GtkTreeSelection.
 * @model: (out) (allow-none) (transfer none): A pointer to set to the #GtkTreeModel, or %NULL.
 *
 ...
 **/
GList *
__gtk_tree_selection_get_selected_rows (GtkTreeSelection   *selection,
                                      GtkTreeModel      **model)
{
  GList *list = NULL;
  GtkRBTree *tree = NULL;
  ...
  if (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree == NULL ||
      gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree->root == NULL)
    return NULL;
  ...
  if (gtk_tree_selection_get_props (selection)->type == GTK_SELECTION_NONE)
  ...
  else if (gtk_tree_selection_get_props (selection)->type != GTK_SELECTION_MULTIPLE)
    {
	  ...
	  path = __gtk_tree_model_get_path (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model, &iter);
  ...
  tree = gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree;
  node = gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree->root;
  ...
  do
	...
	list = g_list_prepend (list, __gtk_tree_path_copy (path));
	  ...
	  __gtk_tree_path_append_index (path, 0);
	}
      else
        {
	  gboolean done = FALSE;
...
static void
__gtk_tree_selection_count_selected_rows_helper (GtkRBTree *tree,
					       GtkRBNode *node,
					       gpointer   data)
{
  ...
  if (node->children)
    _gtk_rbtree_traverse (node->children, node->children->root,
			  G_PRE_ORDER,
			  __gtk_tree_selection_count_selected_rows_helper, data);
}

/**
 * __gtk_tree_selection_count_selected_rows:
 * @selection: A #GtkTreeSelection.
 *
 ...
 **/
gint
__gtk_tree_selection_count_selected_rows (GtkTreeSelection *selection)
{
  gint count = 0;
  ...
  _gtk_rbtree_traverse (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree,
                        gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree->root,
			G_PRE_ORDER,
...
/* __gtk_tree_selection_selected_foreach helper */
static void
...
/**
 * __gtk_tree_selection_selected_foreach:
 * @selection: A #GtkTreeSelection.
 ...
 * __gtk_tree_selection_get_selected_rows() might be more useful.
 **/
void
__gtk_tree_selection_selected_foreach (GtkTreeSelection            *selection,
				     ...
				     gpointer                     data)
{
  ...
  if (func == NULL ||
      gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree == NULL ||
      gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->tree->root == NULL)
    return;
  ...
  if (gtk_tree_selection_get_props (selection)->type == GTK_SELECTION_SINGLE ||
      gtk_tree_selection_get_props (selection)->type == GTK_SELECTION_BROWSE)
    {
      if (__gtk_tree_row_reference_valid (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor))
	{
	  path = __gtk_tree_row_reference_get_path (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor);
	  __gtk_tree_model_get_iter (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model, &iter, path);
	  (* func) (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model, path, &iter, data);
	  __gtk_tree_path_free (path);
	}
      return;
    }
...
out:
  ...
  if (stop)
    g_warning ("The model has been modified from within __gtk_tree_selection_selected_foreach.\n"
	       ...
	       "__gtk_tree_selection_get_selected_rows instead.\n");
}

/**
 * __gtk_tree_selection_select_path:
 * @selection: A #GtkTreeSelection.
 ...
 **/
void
__gtk_tree_selection_select_path (GtkTreeSelection *selection,
				GtkTreePath      *path)
{
  GtkRBNode *node;
  GtkRBTree *tree;
...
/**
 * __gtk_tree_selection_unselect_path:
 * @selection: A #GtkTreeSelection.
 ...
 **/
void
__gtk_tree_selection_unselect_path (GtkTreeSelection *selection,
				  GtkTreePath      *path)
{
  GtkRBNode *node;
  GtkRBTree *tree;
...
/**
 * __gtk_tree_selection_select_iter:
 * @selection: A #GtkTreeSelection.
 ...
 **/
void
__gtk_tree_selection_select_iter (GtkTreeSelection *selection,
				GtkTreeIter      *iter)
{
  GtkTreePath *path;
  ...
  g_return_if_fail (GTK_IS_TREE_SELECTION (selection));
  g_return_if_fail (gtk_tree_selection_get_props (selection)->tree_view != NULL);
  g_return_if_fail (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model != NULL);
  g_return_if_fail (iter != NULL);

  path = __gtk_tree_model_get_path (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model,
				  iter);
...
/**
 * __gtk_tree_selection_unselect_iter:
 * @selection: A #GtkTreeSelection.
 ...
 **/
void
__gtk_tree_selection_unselect_iter (GtkTreeSelection *selection,
				  GtkTreeIter      *iter)
{
  GtkTreePath *path;
  ...
  __gtk_tree_selection_unselect_path (selection, path);
  __gtk_tree_path_free (path);
}

/**
 * __gtk_tree_selection_path_is_selected:
 * @selection: A #GtkTreeSelection.
 ...
 **/
gboolean
__gtk_tree_selection_path_is_selected (GtkTreeSelection *selection,
				     GtkTreePath      *path)
{
  GtkRBNode *node;
  GtkRBTree *tree;
  ...
  if (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model == NULL)
    return FALSE;
...
/**
 * __gtk_tree_selection_iter_is_selected:
 * @selection: A #GtkTreeSelection
 ...
 **/
gboolean
__gtk_tree_selection_iter_is_selected (GtkTreeSelection *selection,
				     GtkTreeIter      *iter)
{
  GtkTreePath *path;
  gboolean retval;
  ...
  g_return_val_if_fail (gtk_tree_selection_get_props (selection)->tree_view != NULL, FALSE);
  g_return_val_if_fail (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model != NULL, FALSE);

  path = __gtk_tree_model_get_path (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model, iter);
  if (path == NULL)
    return FALSE;

  retval = __gtk_tree_selection_path_is_selected (selection, path);
  __gtk_tree_path_free (path);
...
/**
 * __gtk_tree_selection_select_all:
 * @selection: A #GtkTreeSelection.
 *
...
/**
 * __gtk_tree_selection_unselect_all:
 * @selection: A #GtkTreeSelection.
 *
				      ...
				      GtkTreePath      *end_path)
{
  ...
  if (anchor_path)
	...
	__gtk_tree_row_reference_free (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor);
      ...
      gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor =
	__gtk_tree_row_reference_new_proxy (G_OBJECT (gtk_tree_selection_get_props (selection)->tree_view),
	                                  gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model,
					  anchor_path);
    }
...
/**
 * __gtk_tree_selection_select_range:
 * @selection: A #GtkTreeSelection.
 ...
 **/
void
__gtk_tree_selection_select_range (GtkTreeSelection *selection,
				 GtkTreePath      *start_path,
				 GtkTreePath      *end_path)
{
  g_return_if_fail (GTK_IS_TREE_SELECTION (selection));
...
/**
 * __gtk_tree_selection_unselect_range:
 * @selection: A #GtkTreeSelection.
 * @start_path: The initial node of the range.
 ...
 **/
void
__gtk_tree_selection_unselect_range (GtkTreeSelection *selection,
                                   GtkTreePath      *start_path,
				   GtkTreePath      *end_path)
{
  g_return_if_fail (GTK_IS_TREE_SELECTION (selection));
				       ...
				       GtkTreePath      *path)
{
  ...
  if (!__gtk_tree_model_get_iter (gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model, &iter, path))
    sensitive = TRUE;
					  ...
					  gboolean          override_browse_mode)
{
  ...
  if (gtk_tree_selection_get_props (selection)->type == GTK_SELECTION_SINGLE ||
	  ...
	  if (anchor_path)
	      ...
	      if (dirty)
		{
		  ...
		  if (gtk_tree_selection_real_select_node (selection, tree, node, TRUE))
		    {
		      gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->anchor =
			__gtk_tree_row_reference_new_proxy (G_OBJECT (gtk_tree_selection_get_props (selection)->tree_view), gtk_tree_view_get_props (gtk_tree_selection_get_props (selection)->tree_view)->priv->model, path);
		    }
		}
	    }
	  else
	...
	{
	  __gtk_tree_selection_select_range (selection,
					   anchor_path,
					   path);
	}
