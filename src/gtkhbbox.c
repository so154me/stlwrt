...
STLWRT_DEFINE_FTYPE_VPARENT (GtkHButtonBox, gtk_hbutton_box, GTK_TYPE_BUTTON_BOX,
                             G_TYPE_FLAG_NONE, ;)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (hbutton_box),
                                  GTK_ORIENTATION_HORIZONTAL);
}

GtkWidget *
__gtk_hbutton_box_new (void)
{
...
void
__gtk_hbutton_box_set_spacing_default (gint spacing)
{
...
void
__gtk_hbutton_box_set_layout_default (GtkButtonBoxStyle layout)
{
...
gint
__gtk_hbutton_box_get_spacing_default (void)
{
