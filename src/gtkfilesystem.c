...
gtk_file_system_dispose (GObject *object)
{
  ...
  priv = _gtk_file_system_get_instance_private (object);
			...
			gpointer           data)
{
  ...
  priv = _gtk_file_system_get_instance_private (data);
...
get_volumes_list (GtkFileSystem *file_system)
{
  ...
  priv = _gtk_file_system_get_instance_private (file_system);
			 ...
			 GParamSpec   *pspec)
{
  ...
  priv = _gtk_folder_get_instance_private (object);
			   ...
			   gpointer           data)
{
  ...
  priv = _gtk_folder_get_instance_private (folder);
  files = g_slist_prepend (NULL, file);
		       ...
		       GError    **error)
{
  ...
  icon_info = __gtk_icon_theme_lookup_by_gicon (icon_theme,
					      icon,
					      icon_size,
  ...
  pixbuf = __gtk_icon_info_load_icon (icon_info, error);
  __gtk_icon_info_free (icon_info);
