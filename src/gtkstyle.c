...
static GdkFont *__gtk_style_get_font_internal (GtkStyle *style);
...
/**
 * ___gtk_style_init_for_settings:
 * @style: a #GtkStyle
 * @settings: a #GtkSettings
 * 
 * Initializes the font description in @style according to the default
 * font name of @settings. This is called for __gtk_style_new() with
 ...
 **/
void
___gtk_style_init_for_settings (GtkStyle    *style,
			      GtkSettings *settings)
{
  const gchar *font_name = ___gtk_rc_context_get_default_font_name (settings);
...
gtk_style_init (GtkStyle *style)
{
  ...
  GtkSettings *settings = __gtk_settings_get_default ();
  
  if (settings)
    ___gtk_style_init_for_settings (style, settings);
  else
...
gtk_style_finalize (GObject *object)
{
  ...
  if (style->private_font)
    __gdk_font_unref (style->private_font);
 ...
 */
GtkStyle*
__gtk_style_copy (GtkStyle *style)
{
  GtkStyle *new_style;
...
gtk_style_duplicate (GtkStyle *style)
{
  ...
  new_style = __gtk_style_copy (style);
 ...
 * <literal>style = __gtk_style_attach (style, window)</literal>
 *
 ...
 */
GtkStyle*
__gtk_style_attach (GtkStyle  *style,
                  GdkWindow *window)
{
  GSList *styles;
  ...
  colormap = __gdk_drawable_get_colormap ((GdkDrawable *)window);
  ...
  if (!new_style)
    {
      ...
      if (__gdk_colormap_get_screen (style->colormap) != __gdk_colormap_get_screen (colormap) &&
	  new_style->private_font)
	{
	  __gdk_font_unref (new_style->private_font);
 ...
 * to any windows anymore, it is unrealized. See __gtk_style_attach().
 * 
 */
void
__gtk_style_detach (GtkStyle *style)
{
 ...
 */
GtkStyle*
__gtk_style_ref (GtkStyle *style)
{
 ...
 */
void
__gtk_style_unref (GtkStyle *style)
{
  g_object_unref (style);
}
                   ...
                   GdkColormap *colormap)
{
  ...
  style->depth = __gdk_colormap_get_visual (colormap)->depth;

  g_signal_emit (style, realize_signal, 0);
}

/**
 * __gtk_style_lookup_icon_set:
 * @style: a #GtkStyle
 ...
 */
GtkIconSet*
__gtk_style_lookup_icon_set (GtkStyle   *style,
                           const char *stock_id)
{
  GSList *iter;
  ...
  while (iter != NULL)
    {
      GtkIconSet *icon_set = __gtk_icon_factory_lookup (GTK_ICON_FACTORY (iter->data),
						      stock_id);
      if (icon_set)
        return icon_set;
 ...
 **/
gboolean
__gtk_style_lookup_color (GtkStyle   *style,
 ...
 * 
 * Deprecated: 2.0: Use __gtk_paint_hline() instead.
 **/
void
__gtk_draw_hline (GtkStyle     *style,
                GdkWindow    *window,
                GtkStateType  state_type,
                gint          x1,
                gint          x2,
 ...
 * using the given style and state.
 * 
 * Deprecated: 2.0: Use __gtk_paint_vline() instead.
 **/
void
__gtk_draw_vline (GtkStyle     *style,
                GdkWindow    *window,
                GtkStateType  state_type,
                gint          y1_,
                gint          y2_,
 ...
 * 
 * Deprecated: 2.0: Use __gtk_paint_shadow() instead.
 */
void
__gtk_draw_shadow (GtkStyle      *style,
                 GdkWindow     *window,
                 GtkStateType   state_type,
                 GtkShadowType  shadow_type,
                 gint           x,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_polygon() instead.
 */ 
void
__gtk_draw_polygon (GtkStyle      *style,
                  GdkWindow     *window,
                  GtkStateType   state_type,
                  GtkShadowType  shadow_type,
                  GdkPoint      *points,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_arrow() instead.
 */
void
__gtk_draw_arrow (GtkStyle      *style,
                GdkWindow     *window,
                GtkStateType   state_type,
                GtkShadowType  shadow_type,
                GtkArrowType   arrow_type,
 ...
 * parameters.
 *
 * Deprecated: 2.0: Use __gtk_paint_diamond() instead.
 */
void
__gtk_draw_diamond (GtkStyle      *style,
                  GdkWindow     *window,
                  GtkStateType   state_type,
                  GtkShadowType  shadow_type,
                  gint           x,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_layout() instead.
 */
void
__gtk_draw_string (GtkStyle      *style,
                 GdkWindow     *window,
                 GtkStateType   state_type,
                 gint           x,
                 gint           y,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_box() instead.
 */
void
__gtk_draw_box (GtkStyle      *style,
              GdkWindow     *window,
              GtkStateType   state_type,
              GtkShadowType  shadow_type,
              gint           x,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_flat_box() instead.
 */
void
__gtk_draw_flat_box (GtkStyle      *style,
                   GdkWindow     *window,
                   GtkStateType   state_type,
                   GtkShadowType  shadow_type,
                   gint           x,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_check() instead.
 */
void
__gtk_draw_check (GtkStyle      *style,
                GdkWindow     *window,
                GtkStateType   state_type,
                GtkShadowType  shadow_type,
                gint           x,
 ...
 * the given parameters.
 *
 * Deprecated: 2.0: Use __gtk_paint_option() instead.
 */
void
__gtk_draw_option (GtkStyle      *style,
		 GdkWindow     *window,
		 GtkStateType   state_type,
		 GtkShadowType  shadow_type,
		 gint           x,
 ...
 * 
 * Deprecated: 2.0: Use __gtk_paint_tab() instead.
 */ 
void
__gtk_draw_tab (GtkStyle      *style,
	      GdkWindow     *window,
	      GtkStateType   state_type,
	      GtkShadowType  shadow_type,
	      gint           x,
 ...
 * gap in one side.
 * 
 * Deprecated: 2.0: Use __gtk_paint_shadow_gap() instead.
*/
void
__gtk_draw_shadow_gap (GtkStyle       *style,
                     GdkWindow      *window,
                     GtkStateType    state_type,
                     GtkShadowType   shadow_type,
                     gint            x,
 ...
 * 
 * Deprecated: 2.0: Use __gtk_paint_box_gap() instead.
 */
void
__gtk_draw_box_gap (GtkStyle       *style,
                  GdkWindow      *window,
                  GtkStateType    state_type,
                  GtkShadowType   shadow_type,
                  gint            x,
 ...
 *
 * Deprecated: 2.0: Use __gtk_paint_extension() instead.
 **/
void
__gtk_draw_extension (GtkStyle       *style,
                    GdkWindow      *window,
                    GtkStateType    state_type,
                    GtkShadowType   shadow_type,
                    gint            x,
 ...
 * given style.
 * 
 * Deprecated: 2.0: Use __gtk_paint_focus() instead.
 */
void
__gtk_draw_focus (GtkStyle      *style,
		GdkWindow     *window,
		gint           x,
		gint           y,
		gint           width,
 ...
 */
void 
__gtk_draw_slider (GtkStyle      *style,
		 GdkWindow     *window,
		 GtkStateType   state_type,
		 GtkShadowType  shadow_type,
		 gint           x,
 ...
 * 
 * Deprecated: 2.0: Use __gtk_paint_handle() instead.
 **/
void 
__gtk_draw_handle (GtkStyle      *style,
		 GdkWindow     *window,
		 GtkStateType   state_type,
		 GtkShadowType  shadow_type,
		 gint           x,
 ...
 * 
 * Deprecated: 2.0: Use __gtk_paint_expander() instead.
 **/
void
__gtk_draw_expander (GtkStyle        *style,
                   GdkWindow       *window,
                   GtkStateType     state_type,
                   gint             x,
                   gint             y,
 ...
 */
void
__gtk_draw_layout (GtkStyle        *style,
                 GdkWindow       *window,
                 GtkStateType     state_type,
		 gboolean         use_text,
                 gint             x,
 ...
 * parameters. 
 * 
 * Deprecated: 2.0: Use __gtk_paint_resize_grip() instead.
 */
void
__gtk_draw_resize_grip (GtkStyle     *style,
                      GdkWindow    *window,
                      GtkStateType  state_type,
                      GdkWindowEdge edge,
                      gint          x,
 ...
 */
void
__gtk_style_set_background (GtkStyle    *style,
                          GdkWindow   *window,
                          GtkStateType state_type)
{
  g_return_if_fail (GTK_IS_STYLE (style));
		     ...
		     GtkStyle *src)
{
  ...
  if (style->private_font)
    __gdk_font_ref (style->private_font);
			     ...
			     GtkRcStyle *rc_style)
{
  ...
  priv->color_hashes = g_slist_copy (___gtk_rc_style_get_color_hashes (rc_style));
  g_slist_foreach (priv->color_hashes, (GFunc) g_hash_table_ref, NULL);
}
...
/**
 * __gtk_style_get_style_property:
 * @style: a #GtkStyle
 ...
 */
void 
__gtk_style_get_style_property (GtkStyle     *style,
                              GType        widget_type,
                              ...
                              GValue      *value)
{
  ...
  pspec = __gtk_widget_class_find_style_property (klass, property_name);
  ...
  peek_value = ___gtk_style_peek_property_value (style, widget_type, pspec, parser);
 ...
 *
 * Non-vararg variant of __gtk_style_get().
 * Used primarily by language bindings.
 *
 * Since: 2.16
 */
void 
__gtk_style_get_valist (GtkStyle    *style,
                      GType        widget_type,
 ...
 */
void
__gtk_style_get (GtkStyle    *style,
               GType        widget_type,
               const gchar *first_property_name,
               ...)
{
  ...
  __gtk_style_get_valist (style, widget_type, first_property_name, var_args);
  va_end (var_args);
}

const GValue*
___gtk_style_peek_property_value (GtkStyle           *style,
				GType               widget_type,
				GParamSpec         *pspec,
				GtkRcPropertyParser parser)
{
  ...
  if (style->rc_style)
    {
      ...
      do
	{
	  rcprop = ___gtk_rc_style_lookup_rc_property (style->rc_style,
  ...
  if (rcprop && !___gtk_settings_parse_convert (parser, &rcprop->value,
					      pspec, &pcache->value))
    {
	       ...
	       const gchar *filename)
{
  if (strcmp (filename, "<parent>") == 0)
    ...
    {
      return __gdk_pixmap_colormap_create_from_xpm (NULL, colormap, NULL,
						  bg_color,
						  filename);
    }
}
...
gtk_style_real_realize (GtkStyle *style)
{
  ...
  for (i = 0; i < 5; i++)
    {
      ___gtk_style_shade (&style->bg[i], &style->light[i], LIGHTNESS_MULT);
      ___gtk_style_shade (&style->bg[i], &style->dark[i], DARKNESS_MULT);
  ...
  __gdk_colormap_alloc_color (style->colormap, &style->black, FALSE, TRUE);

  style->white.red = 0xffff;
  style->white.green = 0xffff;
  style->white.blue = 0xffff;
  __gdk_colormap_alloc_color (style->colormap, &style->white, FALSE, TRUE);

  gc_values_mask = GDK_GC_FOREGROUND | GDK_GC_BACKGROUND;
  
  gc_values.foreground = style->black;
  gc_values.background = style->white;
  style->black_gc = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
  
  gc_values.foreground = style->white;
  gc_values.background = style->black;
  style->white_gc = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
  ...
  for (i = 0; i < 5; i++)
	...
	style->bg_pixmap[i] = load_bg_image (style->colormap,
      ...
      if (!__gdk_colormap_alloc_color (style->colormap, &style->fg[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->fg[i].red, style->fg[i].green, style->fg[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->bg[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->bg[i].red, style->bg[i].green, style->bg[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->light[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->light[i].red, style->light[i].green, style->light[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->dark[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->dark[i].red, style->dark[i].green, style->dark[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->mid[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->mid[i].red, style->mid[i].green, style->mid[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->text[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->text[i].red, style->text[i].green, style->text[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->base[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->base[i].red, style->base[i].green, style->base[i].blue);
      if (!__gdk_colormap_alloc_color (style->colormap, &style->text_aa[i], FALSE, TRUE))
        g_warning ("unable to allocate color: ( %d %d %d )",
                   style->text_aa[i].red, style->text_aa[i].green, style->text_aa[i].blue);
      
      gc_values.foreground = style->fg[i];
      style->fg_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
      
      gc_values.foreground = style->bg[i];
      style->bg_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
      
      gc_values.foreground = style->light[i];
      style->light_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
      
      gc_values.foreground = style->dark[i];
      style->dark_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
      
      gc_values.foreground = style->mid[i];
      style->mid_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
      
      gc_values.foreground = style->text[i];
      style->text_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
      
      gc_values.foreground = style->base[i];
      style->base_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);

      gc_values.foreground = style->text_aa[i];
      style->text_aa_gc[i] = __gtk_gc_get (style->depth, style->colormap, &gc_values, gc_values_mask);
    }
}
...
gtk_style_real_unrealize (GtkStyle *style)
{
  ...
  __gtk_gc_release (style->black_gc);
  __gtk_gc_release (style->white_gc);
      
  for (i = 0; i < 5; i++)
    {
      __gtk_gc_release (style->fg_gc[i]);
      __gtk_gc_release (style->bg_gc[i]);
      __gtk_gc_release (style->light_gc[i]);
      __gtk_gc_release (style->dark_gc[i]);
      __gtk_gc_release (style->mid_gc[i]);
      __gtk_gc_release (style->text_gc[i]);
      __gtk_gc_release (style->base_gc[i]);
      __gtk_gc_release (style->text_aa_gc[i]);
  ...
  __gdk_colormap_free_colors (style->colormap, style->fg, 5);
  __gdk_colormap_free_colors (style->colormap, style->bg, 5);
  __gdk_colormap_free_colors (style->colormap, style->light, 5);
  __gdk_colormap_free_colors (style->colormap, style->dark, 5);
  __gdk_colormap_free_colors (style->colormap, style->mid, 5);
  __gdk_colormap_free_colors (style->colormap, style->text, 5);
  __gdk_colormap_free_colors (style->colormap, style->base, 5);
  __gdk_colormap_free_colors (style->colormap, style->text_aa, 5);
			       ...
			       GtkStateType state_type)
{
  ...
  if (style->bg_pixmap[state_type])
    ...
    __gdk_window_set_background (window, &style->bg[state_type]);
}

/**
 * __gtk_style_render_icon:
 * @style: a #GtkStyle
 ...
 */
GdkPixbuf *
__gtk_style_render_icon (GtkStyle            *style,
                       const GtkIconSource *source,
                       GtkTextDirection     direction,
                       GtkStateType         state,
                       GtkIconSize          size,
...
/**
 * __gtk_style_apply_default_background:
 * @style:
 * @window:
 * @set_bg:
 * @state_type:
 ...
 */
void
__gtk_style_apply_default_background (GtkStyle          *style,
                                    GdkWindow         *window,
                                    gboolean           set_bg,
                                    GtkStateType        state_type,
                                    ...
                                    gint                height)
{
  ...
  if (area)
    {
      ...
      if (!__gdk_rectangle_intersect (area, &old_rect, &new_rect))
        return;
    }
  else
    {
  ...
  if (!style->bg_pixmap[state_type] ||
      ...
      (!set_bg && style->bg_pixmap[state_type] != (GdkPixmap*) GDK_PARENT_RELATIVE))
    {
      ...
      if (style->bg_pixmap[state_type])
        {
          __gdk_gc_set_fill (gc, GDK_TILED);
          __gdk_gc_set_tile (gc, style->bg_pixmap[state_type]);
        }
      
      __gdk_draw_rectangle ((GdkDrawable *)window, gc, TRUE, 
                          new_rect.x, new_rect.y, new_rect.width, new_rect.height);
      if (style->bg_pixmap[state_type])
        __gdk_gc_set_fill (gc, GDK_SOLID);
    }
  else
    {
      if (set_bg)
        {
          if (style->bg_pixmap[state_type] == (GdkPixmap*) GDK_PARENT_RELATIVE)
            __gdk_window_set_back_pixmap (window, NULL, TRUE);
          else
            __gdk_window_set_back_pixmap (window, style->bg_pixmap[state_type], FALSE);
        }
      
      __gdk_window_clear_area (window, 
		  ...
		  gint        *height)
{
  ...
  if (widget && __gtk_widget_has_screen (widget))
    {
    ...
    {
      screen = __gdk_colormap_get_screen (style->colormap);
      settings = __gtk_settings_get_for_screen (screen);
    }
  else
    {
                         ...
                         const gchar         *detail)
{
  ...
  base_pixbuf = __gtk_icon_source_get_pixbuf (source);
   ...
   * leave it alone.
   */
  if (size != (GtkIconSize)-1 && __gtk_icon_source_get_size_wildcarded (source))
    scaled = scale_or_ref (base_pixbuf, width, height);
  else
    scaled = g_object_ref (base_pixbuf);

  /* If the state was wildcarded, then generate a state. */
  if (__gtk_icon_source_get_state_wildcarded (source))
    {
...
{
  if ((*width == -1) && (*height == -1))
    __gdk_drawable_get_size ((GdkDrawable *)window, width, height);
  else if (*width == -1)
    __gdk_drawable_get_size ((GdkDrawable *)window, width, NULL);
  else if (*height == -1)
    __gdk_drawable_get_size ((GdkDrawable *)window, NULL, height);
}
                        ...
                        gint          y)
{
  ...
  if (area)
    {
      ...
      __gdk_gc_set_clip_rectangle (style->dark_gc[state_type], area);
    }
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (style->light_gc[state_type], NULL);
      __gdk_gc_set_clip_rectangle (style->dark_gc[state_type], NULL);
    }
}
		  ...
		  gint           height)
{
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (gc1, area);
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (gc1, NULL);
      __gdk_gc_set_clip_rectangle (gc2, NULL);
    }
}
			...
			gint             height)
{
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (style->black_gc, area);
      __gdk_gc_set_clip_rectangle (style->bg_gc[state], area);
      __gdk_gc_set_clip_rectangle (style->dark_gc[state], area);
      __gdk_gc_set_clip_rectangle (style->light_gc[state], area);
    }
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (style->black_gc, NULL);
      __gdk_gc_set_clip_rectangle (style->bg_gc[state], NULL);
      __gdk_gc_set_clip_rectangle (style->dark_gc[state], NULL);
      __gdk_gc_set_clip_rectangle (style->light_gc[state], NULL);
    }
}
...
get_direction (GtkWidget *widget)
{
  ...
  if (widget)
    dir = __gtk_widget_get_direction (widget);
  else
                         ...
                         gint           height)
{
  ...
  if (shadow_type == GTK_SHADOW_IN)
      ...
      if (detail && strcmp (detail, "buttondefault") == 0)
	{
	  ...
	  __gdk_draw_rectangle ((GdkDrawable *)window, style->black_gc, FALSE,
  ...
  if (area)
    {
      ...
      if (shadow_type == GTK_SHADOW_IN || 
        ...
        {
          __gdk_gc_set_clip_rectangle (style->black_gc, area);
          __gdk_gc_set_clip_rectangle (style->bg_gc[state_type], area);
        }
    }
  ...
  if (shadow_type == GTK_SHADOW_IN &&
      ...
      if (get_direction (widget) == GTK_TEXT_DIR_LTR)
	{
	  ...
	  __gdk_draw_point ((GdkDrawable *)window,
			  style->black_gc,
			  x + width - 1, y + 1);
	  __gdk_draw_point ((GdkDrawable *)window,
  ...
  if (area)
    {
      ...
      if (shadow_type == GTK_SHADOW_IN || 
        ...
        {
          __gdk_gc_set_clip_rectangle (style->black_gc, NULL);
          __gdk_gc_set_clip_rectangle (style->bg_gc[state_type], NULL);
        }
    }
}
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (gc1, area);
      __gdk_gc_set_clip_rectangle (gc2, area);
      __gdk_gc_set_clip_rectangle (gc3, area);
      __gdk_gc_set_clip_rectangle (gc4, area);
    }
  
  if (fill)
    __gdk_draw_polygon ((GdkDrawable *)window, style->bg_gc[state_type], TRUE, points, npoints);
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (gc1, NULL);
      __gdk_gc_set_clip_rectangle (gc2, NULL);
      __gdk_gc_set_clip_rectangle (gc3, NULL);
      __gdk_gc_set_clip_rectangle (gc4, NULL);
    }
}
                         ...
                         const gchar   *string)
{
  if (area)
    {
      __gdk_gc_set_clip_rectangle (style->white_gc, area);
      __gdk_gc_set_clip_rectangle (style->fg_gc[state_type], area);
    }

  if (state_type == GTK_STATE_INSENSITIVE)
    __gdk_draw_string ((GdkDrawable *)window,
		     __gtk_style_get_font_internal (style),
  ...
  if (area)
    {
      __gdk_gc_set_clip_rectangle (style->white_gc, NULL);
      __gdk_gc_set_clip_rectangle (style->fg_gc[state_type], NULL);
    }
}
		      ...
		      gint           height)
{
  ...
  if (!style->bg_pixmap[state_type] || 
	...
	{
	  if (widget && !__gtk_widget_has_focus (widget))
	    gc = style->base_gc[GTK_STATE_ACTIVE];
	}

      if (area)
	__gdk_gc_set_clip_rectangle (gc, area);
    ...
    __gtk_style_apply_default_background (style, window,
                                        widget && __gtk_widget_get_has_window (widget),
                 ...
                 gint            darken_count)
{
  ...
  while (darken_count)
    {
      ___gtk_style_shade (&src, &shaded, 0.93);
      src = shaded;
      --darken_count;
    }
   
  __gdk_gc_set_rgb_fg_color (gc, &shaded);
                           ...
                           gint           height)
{
  ...
  if (!style->bg_pixmap[state_type] || gc1 != style->bg_gc[state_type] ||
	...
	__gdk_gc_set_clip_rectangle (gc1, area);
      ...
      __gdk_draw_rectangle ((GdkDrawable *)window, gc1, TRUE,
                          x, y, width, height);
			...
			gint           height)
{
  ...
  switch (type)
    ...
    case CELL:
      if (type == BUTTON)
	__gdk_cairo_set_source_color (cr, &style->fg[state_type]);
      else
	__gdk_cairo_set_source_color (cr, &style->text[state_type]);
	
      cairo_set_line_width (cr, 1.0);
      cairo_rectangle (cr, x + 0.5, y + 0.5, exterior_size - 1, exterior_size - 1);
      cairo_stroke (cr);

      __gdk_cairo_set_source_color (cr, &style->base[state_type]);
                         ...
                         GtkOrientation orientation)
{
  ...
  __gtk_paint_box (style, window, state_type, shadow_type,
  ...
  if (detail &&
       ...
       strcmp ("vscale", detail) == 0))
    {
      ...
      {
        __gtk_paint_vline (style, window, state_type, area, widget, detail, 
                         y + style->ythickness, 
                         y + height - style->ythickness - 1, x + width / 2);
      }
      else
      {
        __gtk_paint_hline (style, window, state_type, area, widget, detail, 
                         x + style->xthickness, 
	  ...
	  gushort       size)
{
  ...
  if (size == 2)
    {
      __gdk_draw_point ((GdkDrawable *)window, light_gc, x, y);
      __gdk_draw_point ((GdkDrawable *)window, light_gc, x+1, y+1);
    }
  else if (size == 3)
    {
      __gdk_draw_point ((GdkDrawable *)window, light_gc, x, y);
      __gdk_draw_point ((GdkDrawable *)window, light_gc, x+1, y);
      __gdk_draw_point ((GdkDrawable *)window, light_gc, x, y+1);
      __gdk_draw_point ((GdkDrawable *)window, dark_gc, x+1, y+2);
      __gdk_draw_point ((GdkDrawable *)window, dark_gc, x+2, y+1);
      __gdk_draw_point ((GdkDrawable *)window, dark_gc, x+2, y+2);
    }
}
			 ...
			 GtkOrientation orientation)
{
  ...
  __gtk_paint_box (style, window, state_type, shadow_type, area, widget, 
  ...
  if (detail && !strcmp (detail, "paned"))
    {
      ...
      if (state_type == GTK_STATE_SELECTED && widget && !__gtk_widget_has_focus (widget))
	{
  ...
  if (area)
    intersect = __gdk_rectangle_intersect (area, &rect, &dest);
  else
    {
      intersect = TRUE;
      dest = rect;
  ...
  __gdk_gc_set_clip_rectangle (light_gc, &dest);
  __gdk_gc_set_clip_rectangle (dark_gc, &dest);
  ...
  __gdk_gc_set_clip_rectangle (light_gc, NULL);
  __gdk_gc_set_clip_rectangle (dark_gc, NULL);
...
#define DEFAULT_EXPANDER_SIZE 12
  ...
  if (widget &&
      __gtk_widget_class_find_style_property (GTK_WIDGET_GET_CLASS (widget),
					    "expander-size"))
    {
      __gtk_widget_style_get (widget,
  ...
  while (tmp_list != NULL)
    {
      ...
      attr = __gdk_pango_attr_embossed_new (TRUE);
...
#define gray50_height 2
          ...
          stipple = __gdk_bitmap_create_from_data (drawable,
                                                 gray50_bits, gray50_width,
                                                 gray50_height);
        }
      
      attr = __gdk_pango_attr_stipple_new (stipple);
                         ...
                         PangoLayout     *layout)
{
  ...
  if (state_type == GTK_STATE_INSENSITIVE)
    ...
    {
      __gdk_draw_layout ((GdkDrawable *)window, gc, x, y, layout);
    }
                              ...
                              gint            height)
{
  ...
  __gdk_draw_polygon ((GdkDrawable *)window, style->bg_gc[state_type], TRUE, 
		    points, skip < 0 ? 4 : 3);
...
void
___gtk_style_shade (const GdkColor *a,
                  GdkColor       *b,
                  gdouble         k)
{
  gdouble red;
 ...
 **/ 
void 
__gtk_paint_hline (GtkStyle           *style,
                 GdkWindow          *window,
                 GtkStateType        state_type,
                 const GdkRectangle *area,
                 GtkWidget          *widget,
                 ...
                 gint                y)
{
  g_return_if_fail (GTK_IS_STYLE (style));
  g_return_if_fail (GTK_STYLE_GET_CLASS (style)->draw_hline != NULL);
  g_return_if_fail (style->depth == __gdk_drawable_get_depth ((GdkDrawable *)window));
 ...
 */
void
__gtk_paint_vline (GtkStyle           *style,
                 GdkWindow          *window,
                 GtkStateType        state_type,
                 const GdkRectangle *area,
                 GtkWidget          *widget,
 ...
 */
void
__gtk_paint_shadow (GtkStyle           *style,
                  GdkWindow          *window,
                  GtkStateType        state_type,
                  GtkShadowType       shadow_type,
                  const GdkRectangle *area,
 ...
 */ 
void
__gtk_paint_polygon (GtkStyle           *style,
                   GdkWindow          *window,
                   GtkStateType        state_type,
                   GtkShadowType       shadow_type,
                   const GdkRectangle *area,
 ...
 */
void
__gtk_paint_arrow (GtkStyle           *style,
                 GdkWindow          *window,
                 GtkStateType        state_type,
                 GtkShadowType       shadow_type,
                 const GdkRectangle *area,
 ...
 */
void
__gtk_paint_diamond (GtkStyle           *style,
                   GdkWindow          *window,
                   GtkStateType        state_type,
                   GtkShadowType       shadow_type,
                   const GdkRectangle *area,
 ...
 */
void
__gtk_paint_string (GtkStyle           *style,
                  GdkWindow          *window,
                  GtkStateType        state_type,
                  const GdkRectangle *area,
                  GtkWidget          *widget,
 ...
 */
void
__gtk_paint_box (GtkStyle           *style,
               GdkWindow          *window,
               GtkStateType        state_type,
               GtkShadowType       shadow_type,
               const GdkRectangle *area,
 ...
 */
void
__gtk_paint_flat_box (GtkStyle           *style,
                    GdkWindow          *window,
                    GtkStateType        state_type,
                    GtkShadowType       shadow_type,
                    const GdkRectangle *area,
 ...
 */
void
__gtk_paint_check (GtkStyle           *style,
                 GdkWindow          *window,
                 GtkStateType        state_type,
                 GtkShadowType       shadow_type,
                 const GdkRectangle *area,
 ...
 */
void
__gtk_paint_option (GtkStyle           *style,
                  GdkWindow          *window,
                  GtkStateType        state_type,
                  GtkShadowType       shadow_type,
                  const GdkRectangle *area,
 ...
 */ 
void
__gtk_paint_tab (GtkStyle           *style,
               GdkWindow          *window,
               GtkStateType        state_type,
               GtkShadowType       shadow_type,
               const GdkRectangle *area,
...
*/
void
__gtk_paint_shadow_gap (GtkStyle           *style,
                      GdkWindow          *window,
                      GtkStateType        state_type,
                      GtkShadowType       shadow_type,
                      const GdkRectangle *area,
 ...
 */
void
__gtk_paint_box_gap (GtkStyle           *style,
                   GdkWindow          *window,
                   GtkStateType        state_type,
                   GtkShadowType       shadow_type,
                   const GdkRectangle *area,
 ...
 **/
void
__gtk_paint_extension (GtkStyle           *style,
                     GdkWindow          *window,
                     GtkStateType        state_type,
                     GtkShadowType       shadow_type,
                     const GdkRectangle *area,
 ...
 */
void
__gtk_paint_focus (GtkStyle           *style,
                 GdkWindow          *window,
		 GtkStateType        state_type,
                 const GdkRectangle *area,
                 GtkWidget          *widget,
 ...
 **/
void
__gtk_paint_slider (GtkStyle           *style,
                  GdkWindow          *window,
                  GtkStateType        state_type,
                  GtkShadowType       shadow_type,
                  const GdkRectangle *area,
 ...
 **/
void
__gtk_paint_handle (GtkStyle           *style,
                  GdkWindow          *window,
                  GtkStateType        state_type,
                  GtkShadowType       shadow_type,
                  const GdkRectangle *area,
 ...
 **/
void
__gtk_paint_expander (GtkStyle           *style,
                    GdkWindow          *window,
                    GtkStateType        state_type,
                    const GdkRectangle *area,
                    GtkWidget          *widget,
 ...
 **/
void
__gtk_paint_layout (GtkStyle           *style,
                  GdkWindow          *window,
                  GtkStateType        state_type,
                  gboolean            use_text,
                  const GdkRectangle *area,
 ...
 */
void
__gtk_paint_resize_grip (GtkStyle           *style,
                       GdkWindow          *window,
                       GtkStateType        state_type,
                       const GdkRectangle *area,
                       GtkWidget          *widget,
 ...
 */
void
__gtk_paint_spinner (GtkStyle           *style,
		   GdkWindow          *window,
		   GtkStateType        state_type,
                   const GdkRectangle *area,
                   GtkWidget          *widget,
 ...
 *     freed with __gtk_border_free()
 *
 * Since: 2.14
 **/
GtkBorder *
__gtk_border_new (void)
{
 ...
 **/
GtkBorder *
__gtk_border_copy (const GtkBorder *border)
{
 ...
 **/
void
__gtk_border_free (GtkBorder *border)
{
  ...
  if (!style->private_font)
    {
      ...
      if (style->colormap)
	{
	  display = __gdk_screen_get_display (__gdk_colormap_get_screen (style->colormap));
	}
      else
	{
      ...
      if (style->font_desc)
	{
	  style->private_font = __gdk_font_from_description_for_display (display, style->font_desc);
	  style->private_font_desc = pango_font_description_copy (style->font_desc);
	}

      if (!style->private_font)
	style->private_font = __gdk_font_load_for_display (display, "fixed");
 ...
 **/
GdkFont *
__gtk_style_get_font (GtkStyle *style)
{
  g_return_val_if_fail (GTK_IS_STYLE (style), NULL);

  return __gtk_style_get_font_internal (style);
}

/**
 * __gtk_style_set_font:
 * @style: a #GtkStyle.
 ...
 **/
void
__gtk_style_set_font (GtkStyle *style,
		    GdkFont  *font)
{
  GdkFont *old_font;
...
style_unrealize_cursor_gcs (GtkStyle *style)
{
  ...
  if (cursor_info)
	...
	__gtk_gc_release (cursor_info->primary_gc);

      if (cursor_info->secondary_gc)
	__gtk_gc_release (cursor_info->secondary_gc);
		...
		const GdkColor *fallback)
{
  ...
  __gtk_widget_style_get (widget, property_name, &cursor_color, NULL);
  
  gc_values_mask = GDK_GC_FOREGROUND;
  if (cursor_color)
    {
      gc_values.foreground = *cursor_color;
      __gdk_color_free (cursor_color);
    }
  else
			 ...
			 gboolean   is_primary)
{
  ...
  /* We have to keep track of the type because __gtk_widget_style_get()
...
GdkGC *
___gtk_widget_get_cursor_gc (GtkWidget *widget)
{
  g_return_val_if_fail (GTK_IS_WIDGET (widget), NULL);
  g_return_val_if_fail (__gtk_widget_get_realized (widget), NULL);
  return get_insertion_cursor_gc (widget, TRUE);
}

void
___gtk_widget_get_cursor_color (GtkWidget *widget,
			      GdkColor  *color)
{
  ...
  __gtk_widget_style_get (widget, "cursor-color", &style_color, NULL);
		       ...
		       gboolean            draw_arrow)
{
  ...
  __gtk_widget_style_get (widget, "cursor-aspect-ratio", &cursor_aspect_ratio, NULL);
 ...
 **/
void
__gtk_draw_insertion_cursor (GtkWidget          *widget,
			   GdkDrawable        *drawable,
			   const GdkRectangle *area,
			   const GdkRectangle *location,
			   gboolean            is_primary,
