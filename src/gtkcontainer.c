...
static void     gtk_container_get_property         (GObject         *object,
						    ...
						    GValue          *value,
						    GParamSpec      *pspec);
static void     __gtk_container_add_unimplemented    (GtkContainer      *container,
						    GtkWidget         *widget);
static void     __gtk_container_remove_unimplemented (GtkContainer      *container,
						    GtkWidget         *widget);
...
gtk_container_class_init (GtkContainerClass *class)
{
  ...
  class->add = __gtk_container_add_unimplemented;
  class->remove = __gtk_container_remove_unimplemented;
					    ...
					    const gchar  *value)
{
  ...
  pspec = __gtk_container_class_find_child_property
  ...
  if (!__gtk_builder_value_from_string (builder, pspec, value, &gvalue, &error))
    {
  ...
  __gtk_container_child_set_property (container, child, name, &gvalue);
			 ...
			 GError             **error)
{
  ...
  if (parser_data->translatable && text_len)
    {
      const gchar* domain;
      domain = __gtk_builder_get_translation_domain (parser_data->builder);
 ...
 **/
GType
__gtk_container_child_type (GtkContainer *container)
{
  GType slot;
...
/**
 * __gtk_container_child_get_valist:
 * @container: a #GtkContainer
 ...
 **/
void
__gtk_container_child_get_valist (GtkContainer *container,
				GtkWidget    *child,
				...
				va_list       var_args)
{
  ...
  g_return_if_fail (gtk_widget_get_props (child)->parent == GTK_WIDGET (container));
...
/**
 * __gtk_container_child_get_property:
 * @container: a #GtkContainer
 * @child: a widget which is a child of @container
 ...
 **/
void
__gtk_container_child_get_property (GtkContainer *container,
				  GtkWidget    *child,
...
/**
 * __gtk_container_child_set_valist:
 * @container: a #GtkContainer
 * @child: a widget which is a child of @container
 ...
 **/
void
__gtk_container_child_set_valist (GtkContainer *container,
				GtkWidget    *child,
				const gchar  *first_property_name,
				va_list       var_args)
{
...
/**
 * __gtk_container_child_set_property:
 * @container: a #GtkContainer
 * @child: a widget which is a child of @container
 ...
 **/
void
__gtk_container_child_set_property (GtkContainer *container,
				  GtkWidget    *child,
				  const gchar  *property_name,
				  const GValue *value)
{
...
/**
 * __gtk_container_add_with_properties:
 * @container: a #GtkContainer 
 ...
 * See __gtk_container_add() and __gtk_container_child_set() for more details.
 **/
void
__gtk_container_add_with_properties (GtkContainer *container,
				   GtkWidget    *widget,
  ...
  if (gtk_widget_get_props (widget)->parent)
    {
      ...
      __gtk_container_child_set_valist (container, widget, first_prop_name, var_args);
      va_end (var_args);
    }
 ...
 **/
void
__gtk_container_child_set (GtkContainer      *container,
			 GtkWidget         *child,
			 const gchar       *first_prop_name,
			 ...)
{
  ...
  va_start (var_args, first_prop_name);
  __gtk_container_child_set_valist (container, child, first_prop_name, var_args);
  va_end (var_args);
}

/**
 * __gtk_container_child_get:
 * @container: a #GtkContainer
 * @child: a widget which is a child of @container
 ...
 **/
void
__gtk_container_child_get (GtkContainer      *container,
			 GtkWidget         *child,
			 const gchar       *first_prop_name,
			 ...)
{
  ...
  va_start (var_args, first_prop_name);
  __gtk_container_child_get_valist (container, child, first_prop_name, var_args);
  va_end (var_args);
}

/**
 * __gtk_container_class_install_child_property:
 ...
 **/
void
__gtk_container_class_install_child_property (GtkContainerClass *cclass,
					    guint              property_id,
					    GParamSpec        *pspec)
{
...
/**
 * __gtk_container_class_find_child_property:
 ...
 */
GParamSpec*
__gtk_container_class_find_child_property (GObjectClass *cclass,
					 const gchar  *property_name)
{
...
/**
 * __gtk_container_class_list_child_properties:
 * @cclass: (type GtkContainerClass): a #GtkContainerClass
 ...
 */
GParamSpec**
__gtk_container_class_list_child_properties (GObjectClass *cclass,
					   guint        *n_properties)
{
  GParamSpec **pspecs;
  guint n;
...
static void
__gtk_container_add_unimplemented (GtkContainer     *container,
				 GtkWidget        *widget)
{
...
static void
__gtk_container_remove_unimplemented (GtkContainer     *container,
				    GtkWidget        *widget)
{
...
gtk_container_init (GtkContainer *container)
{
  ...
  gtk_container_get_props (container)->border_width = 0;
  gtk_container_get_props (container)->need_resize = FALSE;
  gtk_container_get_props (container)->resize_mode = GTK_RESIZE_PARENT;
  gtk_container_get_props (container)->reallocate_redraws = FALSE;
}
			    ...
			    GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_BORDER_WIDTH:
      __gtk_container_set_border_width (container, g_value_get_uint (value));
      break;
    case PROP_RESIZE_MODE:
      __gtk_container_set_resize_mode (container, g_value_get_enum (value));
      break;
    case PROP_CHILD:
      __gtk_container_add (container, GTK_WIDGET (g_value_get_object (value)));
      break;
    default:
			    ...
			    GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_BORDER_WIDTH:
      g_value_set_uint (value, gtk_container_get_props (container)->border_width);
      break;
    case PROP_RESIZE_MODE:
      g_value_set_enum (value, gtk_container_get_props (container)->resize_mode);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
/**
 * __gtk_container_set_border_width:
 * @container: a #GtkContainer
 ...
 * create a #GtkAlignment widget, call __gtk_widget_set_size_request()
 * to give it a size, and place it on the side of the container as
 * a spacer.
 **/
void
__gtk_container_set_border_width (GtkContainer *container,
				guint         border_width)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));

  if (gtk_container_get_props (container)->border_width != border_width)
    {
      gtk_container_get_props (container)->border_width = border_width;
      g_object_notify (G_OBJECT (container), "border-width");
      
      if (__gtk_widget_get_realized (GTK_WIDGET (container)))
	__gtk_widget_queue_resize (GTK_WIDGET (container));
    }
}

/**
 * __gtk_container_get_border_width:
 * @container: a #GtkContainer
 * 
 ...
 **/
guint
__gtk_container_get_border_width (GtkContainer *container)
{
  g_return_val_if_fail (GTK_IS_CONTAINER (container), 0);

  return gtk_container_get_props (container)->border_width;
}
 ...
 * consider functions such as __gtk_box_pack_start() and
 * __gtk_table_attach() as an alternative to __gtk_container_add() in
 * those cases. A widget may be added to only one container at a time;
 * you can't place the same widget inside two different containers.
 **/
void
__gtk_container_add (GtkContainer *container,
		   GtkWidget    *widget)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));
  g_return_if_fail (GTK_IS_WIDGET (widget));
  ...
  if (gtk_widget_get_props (widget)->parent != NULL)
    {
      g_warning ("Attempting to add a widget with type %s to a container of "
                 ...
                 g_type_name (G_OBJECT_TYPE (container)),
                 g_type_name (G_OBJECT_TYPE (gtk_widget_get_props (widget)->parent)));
      return;
    }
 ...
 * using __gtk_widget_destroy() since this will remove it from the
 * container and help break any circular reference count cycles.
 **/
void
__gtk_container_remove (GtkContainer *container,
		      GtkWidget    *widget)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));
  g_return_if_fail (GTK_IS_WIDGET (widget));
  ...
  g_return_if_fail (GTK_IS_TOOLBAR (container) ||
		    gtk_widget_get_props (widget)->parent == GTK_WIDGET (container));
  
  g_signal_emit (container, container_signals[REMOVE], 0, widget);
}

void
___gtk_container_dequeue_resize_handler (GtkContainer *container)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));
...
/**
 * __gtk_container_set_resize_mode:
 * @container: a #GtkContainer
 ...
 **/
void
__gtk_container_set_resize_mode (GtkContainer  *container,
			       GtkResizeMode  resize_mode)
{
  ...
  if (gtk_container_get_props (container)->resize_mode != resize_mode)
    {
      gtk_container_get_props (container)->resize_mode = resize_mode;
...
/**
 * __gtk_container_get_resize_mode:
 * @container: a #GtkContainer
 * 
 ...
 **/
GtkResizeMode
__gtk_container_get_resize_mode (GtkContainer *container)
{
  g_return_val_if_fail (GTK_IS_CONTAINER (container), GTK_RESIZE_PARENT);

  return gtk_container_get_props (container)->resize_mode;
}

/**
 * __gtk_container_set_reallocate_redraws:
 * @container: a #GtkContainer
 ...
 **/ 
void
__gtk_container_set_reallocate_redraws (GtkContainer *container,
				      gboolean      needs_redraws)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));

  gtk_container_get_props (container)->reallocate_redraws = needs_redraws ? TRUE : FALSE;
}
  ...
  while (container_resize_queue)
    {
      ...
      __gtk_container_check_resize (GTK_CONTAINER (widget));
    }
...
void
___gtk_container_queue_resize (GtkContainer *container)
{
  ...
  if (resize_container)
    {
      if (__gtk_widget_get_visible (GTK_WIDGET (resize_container)) &&
          (__gtk_widget_is_toplevel (GTK_WIDGET (resize_container)) ||
           __gtk_widget_get_realized (GTK_WIDGET (resize_container))))
	{
	  switch (gtk_container_get_props (resize_container)->resize_mode)
	    {
	      ...
	      if (!GTK_CONTAINER_RESIZE_PENDING (resize_container))
		{
		  ...
		  if (container_resize_queue == NULL)
		    __gdk_threads_add_idle_full (GTK_PRIORITY_RESIZE,
	    ...
	    case GTK_RESIZE_IMMEDIATE:
	      __gtk_container_check_resize (resize_container);
	      break;
      ...
      else
	{
	   ...
	   * toplevels).
	   */
	  gtk_container_get_props (resize_container)->need_resize = TRUE;
	}
    }
}

void
__gtk_container_check_resize (GtkContainer *container)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));
...
gtk_container_real_check_resize (GtkContainer *container)
{
  ...
  if (requisition.width > gtk_widget_get_props (widget)->allocation.width ||
      requisition.height > gtk_widget_get_props (widget)->allocation.height)
    {
 ...
 */
void
__gtk_container_resize_children (GtkContainer *container)
{
  GtkWidget *widget;
 ...
 * itself.  Most applications should use __gtk_container_foreach(),
 * rather than __gtk_container_forall().
 **/
void
__gtk_container_forall (GtkContainer *container,
...
/**
 * __gtk_container_foreach:
 * @container: a #GtkContainer
 * @callback: (scope call):  a callback
 * @callback_data: callback user data
 * 
 * Invokes @callback on each non-internal child of @container. See
 * __gtk_container_forall() for details on what constitutes an
 * "internal" child.  Most applications should use
 * __gtk_container_foreach(), rather than __gtk_container_forall().
 **/
void
__gtk_container_foreach (GtkContainer *container,
		       GtkCallback   callback,
		       gpointer      callback_data)
{
  GtkContainerClass *class;
...
static void
__gtk_container_foreach_unmarshal (GtkWidget *child,
				 gpointer data)
{
...
void
__gtk_container_foreach_full (GtkContainer       *container,
			    GtkCallback         callback,
  ...
  if (marshal)
    {
      ...
      __gtk_container_foreach (container, __gtk_container_foreach_unmarshal, &fdata);
    }
  else
    {
      g_return_if_fail (callback != NULL);

      __gtk_container_foreach (container, callback, &callback_data);
    }
...
/**
 * __gtk_container_set_focus_child:
 * @container: a #GtkContainer
 ...
 * __gtk_widget_grab_focus() to manualy set the focus to a specific widget.
 */
void
__gtk_container_set_focus_child (GtkContainer *container,
			       GtkWidget    *child)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));
  if (child)
...
/**
 * __gtk_container_get_focus_child:
 * @container: a #GtkContainer
 *
...
__gtk_container_get_focus_child (GtkContainer *container)
{
  ...
  return gtk_container_get_props (container)->focus_child;
}

/**
 * __gtk_container_get_children:
 * @container: a #GtkContainer
 * 
 * Returns the container's non-internal children. See
 * __gtk_container_forall() for details on what constitutes an "internal" child.
 *
 * Return value: (element-type GtkWidget) (transfer container): a newly-allocated list of the container's non-internal children.
 **/
GList*
__gtk_container_get_children (GtkContainer *container)
{
  GList *children = NULL;
					    ...
					    GtkWidget    *child)
{
  ...
  data.i = 0;
  data.index = 0;
  __gtk_container_forall (container,
...
gchar*
___gtk_container_child_composite_name (GtkContainer *container,
				    GtkWidget    *child)
{
  ...
  g_return_val_if_fail (gtk_widget_get_props (child)->parent == GTK_WIDGET (container), NULL);
				    ...
				    GtkWidget        *child)
{
  ...
  if (child != gtk_container_get_props (container)->focus_child)
    {
      if (gtk_container_get_props (container)->focus_child)
	g_object_unref (gtk_container_get_props (container)->focus_child);

      gtk_container_get_props (container)->focus_child = child;

      if (gtk_container_get_props (container)->focus_child)
	g_object_ref (gtk_container_get_props (container)->focus_child);
    }
  ...
  if (gtk_container_get_props (container)->focus_child)
      ...
      if (hadj || vadj) 
	{
	  ...
	  while (GTK_IS_CONTAINER (focus_child) && 
	   ...
	   x += gtk_widget_get_props (gtk_container_get_props (container)->focus_child)->allocation.x;
	   y += gtk_widget_get_props (gtk_container_get_props (container)->focus_child)->allocation.y;
	  
	  if (vadj)
	    __gtk_adjustment_clamp_page (vadj, y, y + gtk_widget_get_props (focus_child)->allocation.height);
	  
	  if (hadj)
	    __gtk_adjustment_clamp_page (hadj, x, x + gtk_widget_get_props (focus_child)->allocation.width);
	}
    }
}
...
/* same as __gtk_container_get_children, except it includes internals
 */
static GList *
                     ...
                     GtkDirectionType  direction)
{
  ...
  if (__gtk_widget_get_can_focus (widget))
  ...
  else
    {
       ...
       * chain to override.
       */
      if (gtk_container_get_props (container)->has_focus_chain)
	...
	sorted_children = ___gtk_container_focus_sort (container, children, direction, NULL);
	     ...
	     gpointer      data)
{
  ...
  gint y2 = gtk_widget_get_props (child2)->allocation.y + gtk_widget_get_props (child2)->allocation.height / 2;

  if (y1 == y2)
    {
      gint x1 = gtk_widget_get_props (child1)->allocation.x + gtk_widget_get_props (child1)->allocation.width / 2;
      gint x2 = gtk_widget_get_props (child2)->allocation.x + gtk_widget_get_props (child2)->allocation.width / 2;
...
___gtk_container_focus_sort_tab (GtkContainer     *container,
			      ...
			      GtkWidget        *old_focus)
{
  GtkTextDirection text_direction = __gtk_widget_get_direction (GTK_WIDGET (container));
		       ...
		       GdkRectangle  *allocation)
{
  *allocation = gtk_widget_get_props (widget)->allocation;
  ...
  return __gtk_widget_translate_coordinates (widget, GTK_WIDGET (container),
  ...
  if (old_focus && get_allocation_coords (container, old_focus, &old_allocation))
      ...
      else
	{
	  if (!__gtk_widget_get_has_window (widget))
	    compare.x = gtk_widget_get_props (widget)->allocation.x + gtk_widget_get_props (widget)->allocation.width / 2;
	  else
	    compare.x = gtk_widget_get_props (widget)->allocation.width / 2;
	}
      
      if (!__gtk_widget_get_has_window (widget))
	compare.y = (direction == GTK_DIR_DOWN) ? gtk_widget_get_props (widget)->allocation.y : gtk_widget_get_props (widget)->allocation.y + gtk_widget_get_props (widget)->allocation.height;
      else
	compare.y = (direction == GTK_DIR_DOWN) ? 0 : + gtk_widget_get_props (widget)->allocation.height;
    }
				     ...
				     GtkWidget        *old_focus)
{
  ...
  if (old_focus && get_allocation_coords (container, old_focus, &old_allocation))
	...
	{
	  if (!__gtk_widget_get_has_window (widget))
	    compare.y = gtk_widget_get_props (widget)->allocation.y + gtk_widget_get_props (widget)->allocation.height / 2;
	  else
	    compare.y = gtk_widget_get_props (widget)->allocation.height / 2;
	}
      
      if (!__gtk_widget_get_has_window (widget))
	compare.x = (direction == GTK_DIR_RIGHT) ? gtk_widget_get_props (widget)->allocation.x : gtk_widget_get_props (widget)->allocation.x + gtk_widget_get_props (widget)->allocation.width;
      else
	compare.x = (direction == GTK_DIR_RIGHT) ? 0 : gtk_widget_get_props (widget)->allocation.width;
    }
 ...
 **/
GList *
___gtk_container_focus_sort (GtkContainer     *container,
			   GList            *children,
			   GtkDirectionType  direction,
			   GtkWidget        *old_focus)
{
  ...
  while (children)
    {
      if (__gtk_widget_get_realized (children->data))
  ...
  while (children)
	...
	continue;
      ...
      if (focus_child)
		...
		if (__gtk_widget_child_focus (child, direction))
		  return TRUE;
            }
        }
      else if (__gtk_widget_is_drawable (child) &&
               __gtk_widget_is_ancestor (child, GTK_WIDGET (container)))
        {
          if (__gtk_widget_child_focus (child, direction))
            return TRUE;
        }
...
/**
 * __gtk_container_set_focus_chain:
 * @container: a #GtkContainer
 ...
 **/
void
__gtk_container_set_focus_chain (GtkContainer *container,
                               GList        *focusable_widgets)
{
  ...
  gtk_container_get_props (container)->has_focus_chain = TRUE;
...
/**
 * __gtk_container_get_focus_chain:
 * @container:         a #GtkContainer
 ...
 **/
gboolean
__gtk_container_get_focus_chain (GtkContainer *container,
			       GList       **focus_chain)
{
  ...
  return gtk_container_get_props (container)->has_focus_chain;
}

/**
 * __gtk_container_unset_focus_chain:
 * @container: a #GtkContainer
 * 
 * Removes a focus chain explicitly set with __gtk_container_set_focus_chain().
 **/
void
__gtk_container_unset_focus_chain (GtkContainer  *container)
{  
  g_return_if_fail (GTK_IS_CONTAINER (container));
  ...
  if (gtk_container_get_props (container)->has_focus_chain)
    {
      ...
      gtk_container_get_props (container)->has_focus_chain = FALSE;
...
/**
 * __gtk_container_set_focus_vadjustment:
 * @container: a #GtkContainer
 ...
 * __gtk_scrolled_window_get_vadjustment() for a typical way of obtaining 
 * the adjustment and __gtk_container_set_focus_hadjustment() for setting
 ...
 */
void
__gtk_container_set_focus_vadjustment (GtkContainer  *container,
...
/**
 * __gtk_container_get_focus_vadjustment:
 * @container: a #GtkContainer
 *
 ...
 **/
GtkAdjustment *
__gtk_container_get_focus_vadjustment (GtkContainer *container)
{
...
/**
 * __gtk_container_set_focus_hadjustment:
 * @container: a #GtkContainer
 ...
 * the adjustment and __gtk_container_set_focus_vadjustment() for setting
 ...
 */
void
__gtk_container_set_focus_hadjustment (GtkContainer  *container,
				     GtkAdjustment *adjustment)
{
  g_return_if_fail (GTK_IS_CONTAINER (container));
  if (adjustment)
...
/**
 * __gtk_container_get_focus_hadjustment:
 * @container: a #GtkContainer
 *
 ...
 **/
GtkAdjustment *
__gtk_container_get_focus_hadjustment (GtkContainer *container)
{
...
gtk_container_show_all (GtkWidget *widget)
{
  ...
  __gtk_container_foreach (GTK_CONTAINER (widget),
			 (GtkCallback) __gtk_widget_show_all,
			 NULL);
...
gtk_container_hide_all (GtkWidget *widget)
{
  ...
  __gtk_container_foreach (GTK_CONTAINER (widget),
			 (GtkCallback) __gtk_widget_hide_all,
			 NULL);
}
			    ...
			    gpointer   client_data)
{
  ...
  __gtk_container_propagate_expose (GTK_CONTAINER (data->container),
				  child,
				  data->event);
}
			 ...
			 gpointer   client_data)
{
  if (__gtk_widget_get_visible (child) &&
      ...
      !__gtk_widget_get_mapped (child))
    __gtk_widget_map (child);
}
...
gtk_container_unmap (GtkWidget *widget)
{
  ...
  if (__gtk_widget_get_has_window (widget))
    ...
    __gtk_container_forall (GTK_CONTAINER (widget),
			  (GtkCallback)__gtk_widget_unmap,
			  NULL);
}

/**
 * __gtk_container_propagate_expose:
 * @container: a #GtkContainer
 ...
 * when it receives an expose event, calls __gtk_container_propagate_expose()
 * once for each child, passing in the event the container received.
 *
 * __gtk_container_propagate_expose() takes care of deciding whether
 ...
 * signal in GTK+ 3, and consequently, __gtk_container_propagate_expose()
 ...
 **/
void
__gtk_container_propagate_expose (GtkContainer   *container,
				GtkWidget      *child,
				GdkEventExpose *event)
{
  ...
  if (__gtk_widget_is_drawable (child) &&
      ...
      (gtk_widget_get_props (child)->window == event->window))
    {
      ...
      child_event->expose.region = __gtk_widget_region_intersect (child, event->region);
      if (!__gdk_region_empty (child_event->expose.region))
	{
	  __gdk_region_get_clipbox (child_event->expose.region, &child_event->expose.area);
	  __gtk_widget_send_expose (child, child_event);
	}
