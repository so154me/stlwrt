 ...
 *    __gtk_file_chooser_get_filename() to
 ...
 * __gtk_file_chooser_set_preview_widget().  Then, connect to the
 * #GtkFileChooser::update-preview signal to get notified when
 * you need to update the contents of the preview.
 * </para>
 * <para>
 * Your callback should use
 * __gtk_file_chooser_get_preview_filename() to see what needs
 * previewing.  Once you have generated the preview for the
 * corresponding file, you must call
 * __gtk_file_chooser_set_preview_widget_active() with a boolean
 ...
 *   ...
 *
 *   preview = __gtk_image_new (<!-- -->);
 *
 *   __gtk_file_chooser_set_preview_widget (my_file_chooser, preview);
 ...
 *   filename = __gtk_file_chooser_get_preview_filename (file_chooser);
 *
 *   pixbuf = gdk_pixbuf_new_from_file_at_size (filename, 128, 128, NULL);
 *   have_preview = (pixbuf != NULL);
 *   g_free (filename);
 *
 *   __gtk_image_set_from_pixbuf (GTK_IMAGE (preview), pixbuf);
 *   if (pixbuf)
 *     g_object_unref (pixbuf);
 *
 *   __gtk_file_chooser_set_preview_widget_active (file_chooser, have_preview);
 * }
 * </programlisting>
 * </example>
 * </refsect2>
 ...
 * __gtk_file_chooser_set_extra_widget() to insert additional
 ...
 *   ...
 *
 *   toggle = __gtk_check_button_new_with_label ("Open file read-only");
 *   __gtk_widget_show (toggle);
 *   __gtk_file_chooser_set_extra_widget (my_file_chooser, toggle);
 * }
 * </programlisting>
 * </example>
 * <note>
...
gtk_file_chooser_class_init (gpointer g_iface)
{
   ...
   *
   * See also:  __gtk_file_chooser_set_current_folder(),
   * __gtk_file_chooser_get_current_folder(),
   * __gtk_file_chooser_set_current_folder_uri(),
   * __gtk_file_chooser_get_current_folder_uri().
   */
   ...
   *
   * See also: __gtk_file_chooser_select_filename(),
   * __gtk_file_chooser_unselect_filename(), __gtk_file_chooser_get_filename(),
   * __gtk_file_chooser_get_filenames(), __gtk_file_chooser_select_uri(),
   * __gtk_file_chooser_unselect_uri(), __gtk_file_chooser_get_uri(),
   * __gtk_file_chooser_get_uris().
   */
   ...
   * __gtk_file_chooser_set_preview_widget(), you should update it when this
   * signal is emitted.  You can use the functions
   * __gtk_file_chooser_get_preview_filename() or
   * __gtk_file_chooser_get_preview_uri() to get the name of the file to preview.
   * Your widget may not be able to preview all kinds of files; your callback
   * must call __gtk_file_chooser_set_preview_widget_active() to inform the file
   * chooser about whether the preview was generated successfully or not.
   *
   * Please see the example code in <xref linkend="gtkfilechooser-preview"/>.
   *
   * See also: __gtk_file_chooser_set_preview_widget(),
   * __gtk_file_chooser_set_preview_widget_active(),
   * __gtk_file_chooser_set_use_preview_label(),
   * __gtk_file_chooser_get_preview_filename(),
   * __gtk_file_chooser_get_preview_uri().
   */
   ...
   * dialog.
   *
   * See also: __gtk_file_chooser_get_filename(),
   * __gtk_file_chooser_get_filenames(), __gtk_file_chooser_get_uri(),
   * __gtk_file_chooser_get_uris().
   */
   ...
   * __gtk_file_chooser_set_do_overwrite_confirmation() function), and
   ...
   *   char *uri;
   *
   *   uri = __gtk_file_chooser_get_uri (chooser);
   *
   ...
   * ...
   *
   * chooser = __gtk_file_chooser_dialog_new (...);
   *
   * __gtk_file_chooser_set_do_overwrite_confirmation (GTK_FILE_CHOOSER (dialog), TRUE);
   * g_signal_connect (chooser, "confirm-overwrite",
   *                   G_CALLBACK (confirm_overwrite_callback), NULL);
   *
   * if (__gtk_dialog_run (chooser) == GTK_RESPONSE_ACCEPT)
   *         save_to_file (__gtk_file_chooser_get_filename (GTK_FILE_CHOOSER (chooser));
   *
   * __gtk_widget_destroy (chooser);
   * </programlisting>
   * </example>
   *
...
/**
 * __gtk_file_chooser_error_quark:
 *
 ...
 **/
GQuark
__gtk_file_chooser_error_quark (void)
{
  return g_quark_from_static_string ("gtk-file-chooser-error-quark");
}

/**
 * __gtk_file_chooser_set_action:
 ...
 **/
void
__gtk_file_chooser_set_action (GtkFileChooser       *chooser,
...
__gtk_file_chooser_get_action (GtkFileChooser *chooser)
{
  GtkFileChooserAction action;
...
/**
 * __gtk_file_chooser_set_local_only:
 * @chooser: a #GtkFileChooser
 ...
 * #GtkFileChooser, like __gtk_file_chooser_get_filename(),
 * rather than the URI functions like
 * __gtk_file_chooser_get_uri(),
 *
 ...
 **/
void
__gtk_file_chooser_set_local_only (GtkFileChooser *chooser,
				 gboolean        local_only)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_get_local_only:
 * @chooser: a #GtkFileChooser
 * 
 * Gets whether only local files can be selected in the
 * file selector. See __gtk_file_chooser_set_local_only()
 * 
 ...
 **/
gboolean
__gtk_file_chooser_get_local_only (GtkFileChooser *chooser)
{
  gboolean local_only;
...
/**
 * __gtk_file_chooser_set_select_multiple:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_set_select_multiple (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_get_select_multiple:
 * @chooser: a #GtkFileChooser
 * 
 * Gets whether multiple files can be selected in the file
 * selector. See __gtk_file_chooser_set_select_multiple().
 * 
 ...
 **/
gboolean
__gtk_file_chooser_get_select_multiple (GtkFileChooser *chooser)
{
  gboolean select_multiple;
...
/**
 * __gtk_file_chooser_set_create_folders:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_set_create_folders (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_get_create_folders:
 * @chooser: a #GtkFileChooser
 * 
 * Gets whether file choser will offer to create new folders.
 * See __gtk_file_chooser_set_create_folders().
 * 
 ...
 **/
gboolean
__gtk_file_chooser_get_create_folders (GtkFileChooser *chooser)
{
  gboolean create_folders;
...
/**
 * __gtk_file_chooser_get_filename:
 * @chooser: a #GtkFileChooser
 * 
 ...
 **/
gchar *
__gtk_file_chooser_get_filename (GtkFileChooser *chooser)
{
  GFile *file;
  gchar *result = NULL;
  ...
  file = __gtk_file_chooser_get_file (chooser);
...
/**
 * __gtk_file_chooser_set_filename:
 * @chooser: a #GtkFileChooser
 ...
 * is equivalent to a sequence of __gtk_file_chooser_unselect_all() followed by
 * __gtk_file_chooser_select_filename().
 *
 ...
 *     __gtk_file_chooser_set_current_folder (chooser, default_folder_for_saving);
 *     __gtk_file_chooser_set_current_name (chooser, "Untitled document");
 *   }
 * else
 *   {
 *     /&ast; the user edited an existing document &ast;/ 
 *     __gtk_file_chooser_set_filename (chooser, existing_filename);
 *   }
 * ]|
 * 
 ...
 **/
gboolean
__gtk_file_chooser_set_filename (GtkFileChooser *chooser,
			       const gchar    *filename)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), FALSE);

  __gtk_file_chooser_unselect_all (chooser);
  return __gtk_file_chooser_select_filename (chooser, filename);
}
 ...
 **/
gboolean
__gtk_file_chooser_select_filename (GtkFileChooser *chooser,
				  const gchar    *filename)
{
  GFile *file;
  gboolean result;
  ...
  result = __gtk_file_chooser_select_file (chooser, file, NULL);
  g_object_unref (file);
...
/**
 * __gtk_file_chooser_unselect_filename:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_unselect_filename (GtkFileChooser *chooser,
				    const char     *filename)
{
  GFile *file;
  ...
  file = g_file_new_for_path (filename);
  __gtk_file_chooser_unselect_file (chooser, file);
  g_object_unref (file);
}
...
/**
 * __gtk_file_chooser_get_filenames:
 * @chooser: a #GtkFileChooser
 * 
 ...
 **/
GSList *
__gtk_file_chooser_get_filenames (GtkFileChooser *chooser)
{
  GSList *files, *result;
  
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), NULL);

  files = __gtk_file_chooser_get_files (chooser);
...
/**
 * __gtk_file_chooser_set_current_folder:
 * @chooser: a #GtkFileChooser
 ...
 **/
gboolean
__gtk_file_chooser_set_current_folder (GtkFileChooser *chooser,
				     const gchar    *filename)
{
  GFile *file;
  gboolean result;
  ...
  file = g_file_new_for_path (filename);
  result = __gtk_file_chooser_set_current_folder_file (chooser, file, NULL);
  g_object_unref (file);
 ...
 * See __gtk_file_chooser_set_current_folder().
 *
 ...
 * currently-selected folder in that mode, use __gtk_file_chooser_get_uri() as the
 ...
 * __gtk_file_chooser_set_current_folder() on a nonexistent folder.
 *
 * Since: 2.4
 **/
gchar *
__gtk_file_chooser_get_current_folder (GtkFileChooser *chooser)
{
  GFile *file;
  gchar *filename;
  ...
  file = __gtk_file_chooser_get_current_folder_file (chooser);
  if (!file)
    return NULL;
...
/**
 * __gtk_file_chooser_set_current_name:
 * @chooser: a #GtkFileChooser
 ...
 * __gtk_file_chooser_set_filename() or __gtk_file_chooser_set_uri() instead.
 * Please see the documentation for those functions for an example of using
 * __gtk_file_chooser_set_current_name() as well.
 *
 * Since: 2.4
 **/
void
__gtk_file_chooser_set_current_name  (GtkFileChooser *chooser,
				    const gchar    *name)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
 ...
 *  if no file is selected. If __gtk_file_chooser_set_local_only() is set to %TRUE
 ...
 **/
gchar *
__gtk_file_chooser_get_uri (GtkFileChooser *chooser)
{
  GFile *file;
  gchar *result = NULL;
  ...
  if (file)
    {
      if (__gtk_file_chooser_get_local_only (chooser))
        {
 ...
 * to a sequence of __gtk_file_chooser_unselect_all() followed by
 * __gtk_file_chooser_select_uri().
 *
 ...
 *   {
 *     /&ast; the user just created a new document &ast;/
 *     __gtk_file_chooser_set_current_folder_uri (chooser, default_folder_for_saving);
 *     __gtk_file_chooser_set_current_name (chooser, "Untitled document");
 *   }
 * else
 *   {
 *     /&ast; the user edited an existing document &ast;/ 
 *     __gtk_file_chooser_set_uri (chooser, existing_uri);
 *   }
 * ]|
 *
 ...
 **/
gboolean
__gtk_file_chooser_set_uri (GtkFileChooser *chooser,
			  const char     *uri)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), FALSE);

  __gtk_file_chooser_unselect_all (chooser);
  return __gtk_file_chooser_select_uri (chooser, uri);
}
 ...
 **/
gboolean
__gtk_file_chooser_select_uri (GtkFileChooser *chooser,
			     const char     *uri)
{
  GFile *file;
  gboolean result;
...
/**
 * __gtk_file_chooser_unselect_uri:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_unselect_uri (GtkFileChooser *chooser,
			       const char     *uri)
{
  GFile *file;
 ...
 **/
void
__gtk_file_chooser_select_all (GtkFileChooser *chooser)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_unselect_all:
 * @chooser: a #GtkFileChooser
 * 
 ...
 **/
void
__gtk_file_chooser_unselect_all (GtkFileChooser *chooser)
{
 ...
 **/
GSList *
__gtk_file_chooser_get_uris (GtkFileChooser *chooser)
{
  GSList *files, *result;
 ...
 **/
gboolean
__gtk_file_chooser_set_current_folder_uri (GtkFileChooser *chooser,
					 const gchar    *uri)
{
  GFile *file;
  gboolean result;
 ...
 * See __gtk_file_chooser_set_current_folder_uri().
 *
 * Note that this is the folder that the file chooser is currently displaying
 ...
 * __gtk_file_chooser_set_current_folder_uri() on a nonexistent folder.
 *
 * Since: 2.4
 */
gchar *
__gtk_file_chooser_get_current_folder_uri (GtkFileChooser *chooser)
{
  GFile *file;
  gchar *uri;
...
/**
 * __gtk_file_chooser_set_current_folder_file:
 * @chooser: a #GtkFileChooser
 * @file: the #GFile for the new folder
 * @error: (allow-none): location to store error, or %NULL.
 *
 * Sets the current folder for @chooser from a #GFile.
 * Internal function, see __gtk_file_chooser_set_current_folder_uri().
 *
 * Return value: %TRUE if the folder could be changed successfully, %FALSE
 * otherwise.
 *
 ...
 **/
gboolean
__gtk_file_chooser_set_current_folder_file (GtkFileChooser  *chooser,
                                          GFile           *file,
                                          GError         **error)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), FALSE);
...
/**
 * __gtk_file_chooser_get_current_folder_file:
 * @chooser: a #GtkFileChooser
 *
 * Gets the current folder of @chooser as #GFile.
 * See __gtk_file_chooser_get_current_folder_uri().
 *
 ...
 */
GFile *
__gtk_file_chooser_get_current_folder_file (GtkFileChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), NULL);
...
/**
 * __gtk_file_chooser_select_file:
 * @chooser: a #GtkFileChooser
 * @file: the file to select
 * @error: (allow-none): location to store error, or %NULL
 * 
 * Selects the file referred to by @file. An internal function. See
 * ___gtk_file_chooser_select_uri().
 *
 ...
 **/
gboolean
__gtk_file_chooser_select_file (GtkFileChooser  *chooser,
                              GFile           *file,
                              GError         **error)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), FALSE);
...
/**
 * __gtk_file_chooser_unselect_file:
 * @chooser: a #GtkFileChooser
 * @file: a #GFile
 * 
 ...
 **/
void
__gtk_file_chooser_unselect_file (GtkFileChooser *chooser,
                                GFile          *file)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_get_files:
 * @chooser: a #GtkFileChooser
 * 
 * Lists all the selected files and subfolders in the current folder of @chooser
 * as #GFile. An internal function, see __gtk_file_chooser_get_uris().
 *
 ...
 **/
GSList *
__gtk_file_chooser_get_files (GtkFileChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), NULL);
 ...
 *   {
 *     /&ast; the user just created a new document &ast;/
 *     __gtk_file_chooser_set_current_folder_file (chooser, default_file_for_saving);
 *     __gtk_file_chooser_set_current_name (chooser, "Untitled document");
 *   }
 * else
 *   {
 *     /&ast; the user edited an existing document &ast;/
 *     __gtk_file_chooser_set_file (chooser, existing_file);
 *   }
 * ]|
 *
 * Return value: %TRUE if both the folder could be changed and the file was
 ...
 **/
gboolean
__gtk_file_chooser_set_file (GtkFileChooser  *chooser,
                           GFile           *file,
                           GError         **error)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), FALSE);
  ...
  __gtk_file_chooser_unselect_all (chooser);
  return __gtk_file_chooser_select_file (chooser, file, error);
}

/**
 * __gtk_file_chooser_get_file:
 * @chooser: a #GtkFileChooser
 *
 ...
 **/
GFile *
__gtk_file_chooser_get_file (GtkFileChooser *chooser)
{
  GSList *list;
  GFile *result = NULL;
  ...
  list = __gtk_file_chooser_get_files (chooser);
  if (list)
    {
      result = list->data;
...
/**
 * ___gtk_file_chooser_get_file_system:
 * @chooser: a #GtkFileChooser
 * 
 ...
 **/
GtkFileSystem *
___gtk_file_chooser_get_file_system (GtkFileChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), NULL);
 ...
 */
/**
 * __gtk_file_chooser_set_preview_widget:
 * @chooser: a #GtkFileChooser
 ...
 * signal, and call __gtk_file_chooser_get_preview_filename() or
 * __gtk_file_chooser_get_preview_uri() on each change. If you can
 * display a preview of the new file, update your widget and
 * set the preview active using __gtk_file_chooser_set_preview_widget_active().
 ...
 **/
void
__gtk_file_chooser_set_preview_widget (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_get_preview_widget:
 * @chooser: a #GtkFileChooser
 *
 ...
 **/
GtkWidget *
__gtk_file_chooser_get_preview_widget (GtkFileChooser *chooser)
{
  GtkWidget *preview_widget;
 ...
 * __gtk_file_chooser_set_preview_widget() should be shown for the
 * current filename. When @active is set to false, the file chooser
 * may display an internally generated preview of the current file
 * or it may display no preview at all. See
 * __gtk_file_chooser_set_preview_widget() for more details.
 *
 * Since: 2.4
 **/
void
__gtk_file_chooser_set_preview_widget_active (GtkFileChooser *chooser,
					    gboolean        active)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_get_preview_widget_active:
 * @chooser: a #GtkFileChooser
 * 
 * Gets whether the preview widget set by __gtk_file_chooser_set_preview_widget()
 ...
 **/
gboolean
__gtk_file_chooser_get_preview_widget_active (GtkFileChooser *chooser)
{
  gboolean active;
 ...
 **/
void
__gtk_file_chooser_set_use_preview_label (GtkFileChooser *chooser,
					gboolean        use_label)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_get_use_preview_label:
 * @chooser: a #GtkFileChooser
 * 
 * Gets whether a stock label should be drawn with the name of the previewed
 * file.  See __gtk_file_chooser_set_use_preview_label().
 * 
 * Return value: %TRUE if the file chooser is set to display a label with the
 * name of the previewed file, %FALSE otherwise.
 **/
gboolean
__gtk_file_chooser_get_use_preview_label (GtkFileChooser *chooser)
{
  gboolean use_label;
...
/**
 * __gtk_file_chooser_get_preview_file:
 * @chooser: a #GtkFileChooser
 *
 * Gets the #GFile that should be previewed in a custom preview
 * Internal function, see __gtk_file_chooser_get_preview_uri().
 *
 ...
 **/
GFile *
__gtk_file_chooser_get_preview_file (GtkFileChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), NULL);
 ...
 * widget. See __gtk_file_chooser_set_preview_widget().
 * 
 ...
 **/
char *
__gtk_file_chooser_get_preview_filename (GtkFileChooser *chooser)
{
  GFile *file;
  gchar *result = NULL;
  ...
  file = __gtk_file_chooser_get_preview_file (chooser);
  if (file)
    {
      result = g_file_get_path (file);
      g_object_unref (file);
 ...
 **/
char *
__gtk_file_chooser_get_preview_uri (GtkFileChooser *chooser)
{
  GFile *file;
  gchar *result = NULL;
...
/**
 * __gtk_file_chooser_set_extra_widget:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_set_extra_widget (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_get_extra_widget:
 * @chooser: a #GtkFileChooser
 *
 * Gets the current preview widget; see
 * __gtk_file_chooser_set_extra_widget().
 ...
 **/
GtkWidget *
__gtk_file_chooser_get_extra_widget (GtkFileChooser *chooser)
{
  GtkWidget *extra_widget;
 ...
 **/
void
__gtk_file_chooser_add_filter (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_remove_filter:
 * @chooser: a #GtkFileChooser
 * @filter: a #GtkFileFilter
 * 
 ...
 **/
void
__gtk_file_chooser_remove_filter (GtkFileChooser *chooser,
				GtkFileFilter  *filter)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_list_filters:
 * @chooser: a #GtkFileChooser
 * 
 * Lists the current set of user-selectable filters; see
 * __gtk_file_chooser_add_filter(), __gtk_file_chooser_remove_filter().
 *
 ...
 **/
GSList *
__gtk_file_chooser_list_filters  (GtkFileChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_FILE_CHOOSER (chooser), NULL);
 ...
 **/
void
__gtk_file_chooser_set_filter (GtkFileChooser *chooser,
			     GtkFileFilter  *filter)
{
  g_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
...
/**
 * __gtk_file_chooser_get_filter:
 * @chooser: a #GtkFileChooser
 *
 * Gets the current filter; see __gtk_file_chooser_set_filter().
 *
 ...
 **/
GtkFileFilter *
__gtk_file_chooser_get_filter (GtkFileChooser *chooser)
{
  GtkFileFilter *filter;
 ...
 *
 * See also: __gtk_file_chooser_add_shortcut_folder()
 *
 * Since: 2.4
 **/
gboolean
...
/**
 * __gtk_file_chooser_list_shortcut_folders:
 * @chooser: a #GtkFileChooser
 * 
 ...
 **/
GSList *
__gtk_file_chooser_list_shortcut_folders (GtkFileChooser *chooser)
{
  GSList *folders;
  GSList *result;
...
/**
 * __gtk_file_chooser_add_shortcut_folder_uri:
 * @chooser: a #GtkFileChooser
 ...
 **/
gboolean
__gtk_file_chooser_add_shortcut_folder_uri (GtkFileChooser    *chooser,
					  const char        *uri,
					  GError           **error)
{
  GFile *file;
...
/**
 * __gtk_file_chooser_remove_shortcut_folder_uri:
 * @chooser: a #GtkFileChooser
 ...
 * In the latter case, the @error will be set as appropriate.
 *
 * See also: __gtk_file_chooser_add_shortcut_folder_uri()
 *
 * Since: 2.4
 **/
gboolean
__gtk_file_chooser_remove_shortcut_folder_uri (GtkFileChooser    *chooser,
					     const char        *uri,
					     GError           **error)
{
  GFile *file;
...
/**
 * __gtk_file_chooser_list_shortcut_folder_uris:
 * @chooser: a #GtkFileChooser
 * 
 * Queries the list of shortcut folders in the file chooser, as set by
 * __gtk_file_chooser_add_shortcut_folder_uri().
 ...
 **/
GSList *
__gtk_file_chooser_list_shortcut_folder_uris (GtkFileChooser *chooser)
{
  GSList *folders;
  GSList *result;
...
/**
 * __gtk_file_chooser_set_show_hidden:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_set_show_hidden (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_get_show_hidden:
 * @chooser: a #GtkFileChooser
 * 
 * Gets whether hidden files and folders are displayed in the file selector.   
 * See __gtk_file_chooser_set_show_hidden().
 * 
 ...
 **/
gboolean
__gtk_file_chooser_get_show_hidden (GtkFileChooser *chooser)
{
  gboolean show_hidden;
...
/**
 * __gtk_file_chooser_set_do_overwrite_confirmation:
 * @chooser: a #GtkFileChooser
 ...
 **/
void
__gtk_file_chooser_set_do_overwrite_confirmation (GtkFileChooser *chooser,
...
/**
 * __gtk_file_chooser_get_do_overwrite_confirmation:
 * @chooser: a #GtkFileChooser
 * 
 ...
 **/
gboolean
__gtk_file_chooser_get_do_overwrite_confirmation (GtkFileChooser *chooser)
{
  gboolean do_overwrite_confirmation;
...
#undef __gtk_file_chooser_get_filename

gchar *
__gtk_file_chooser_get_filename (GtkFileChooser *chooser)
{
  gchar *utf8_filename = __gtk_file_chooser_get_filename_utf8 (chooser);
...
#undef __gtk_file_chooser_set_filename
			       ...
			       const gchar    *filename)
{
  ...
  gboolean retval = __gtk_file_chooser_set_filename_utf8 (chooser, utf8_filename);
...
#undef __gtk_file_chooser_select_filename
...
{
  gchar *utf8_filename = g_locale_to_utf8 (filename, -1, NULL, NULL, NULL);
  gboolean retval = __gtk_file_chooser_select_filename_utf8 (chooser, utf8_filename);
...
#undef __gtk_file_chooser_unselect_filename
				    ...
				    const char     *filename)
{
  ...
  __gtk_file_chooser_unselect_filename_utf8 (chooser, utf8_filename);
  g_free (utf8_filename);
}

#undef __gtk_file_chooser_get_filenames

GSList *
__gtk_file_chooser_get_filenames (GtkFileChooser *chooser)
{
  GSList *list = __gtk_file_chooser_get_filenames_utf8 (chooser);
  GSList *rover = list;
...
#undef __gtk_file_chooser_set_current_folder
...
{
  gchar *utf8_filename = g_locale_to_utf8 (filename, -1, NULL, NULL, NULL);
  gboolean retval = __gtk_file_chooser_set_current_folder_utf8 (chooser, utf8_filename);
...
#undef __gtk_file_chooser_get_current_folder

gchar *
__gtk_file_chooser_get_current_folder (GtkFileChooser *chooser)
{
  gchar *utf8_folder = __gtk_file_chooser_get_current_folder_utf8 (chooser);
...
#undef __gtk_file_chooser_get_preview_filename

char *
__gtk_file_chooser_get_preview_filename (GtkFileChooser *chooser)
{
  char *utf8_filename = __gtk_file_chooser_get_preview_filename_utf8 (chooser);
...
#undef __gtk_file_chooser_add_shortcut_folder
				      ...
				      GError           **error)
{
  ...
  gboolean retval =
    __gtk_file_chooser_add_shortcut_folder_utf8 (chooser, utf8_folder, error);
...
#undef __gtk_file_chooser_remove_shortcut_folder
					 ...
					 GError           **error)
{
  char *utf8_folder = g_locale_to_utf8 (folder, -1, NULL, NULL, NULL);
  gboolean retval =
    __gtk_file_chooser_remove_shortcut_folder_utf8 (chooser, utf8_folder, error);
...
#undef __gtk_file_chooser_list_shortcut_folders

GSList *
__gtk_file_chooser_list_shortcut_folders (GtkFileChooser *chooser)
{
  GSList *list = __gtk_file_chooser_list_shortcut_folders_utf8 (chooser);
  GSList *rover = list;
