...
/**
 * __gtk_text_buffer_register_serialize_format:
 ...
 **/
GdkAtom
__gtk_text_buffer_register_serialize_format (GtkTextBuffer              *buffer,
                                           const gchar                *mime_type,
...
/**
 * __gtk_text_buffer_register_serialize_tagset:
 * @buffer: a #GtkTextBuffer
 ...
 * __gtk_text_buffer_register_serialize_format(). The mime type used
 ...
 **/
GdkAtom
__gtk_text_buffer_register_serialize_tagset (GtkTextBuffer *buffer,
...
/**
 * __gtk_text_buffer_register_deserialize_format:
 * @buffer: a #GtkTextBuffer
 * @mime_type: the format's mime-type
 ...
 **/
GdkAtom
__gtk_text_buffer_register_deserialize_format (GtkTextBuffer                *buffer,
                                             const gchar                  *mime_type,
...
/**
 * __gtk_text_buffer_register_deserialize_tagset:
 * @buffer: a #GtkTextBuffer
 * @tagset_name: (allow-none): an optional tagset name, on %NULL
 *
 * This function registers GTK+'s internal rich text serialization
 * format with the passed @buffer. See
 * __gtk_text_buffer_register_serialize_tagset() for details.
 *
 * Return value: (transfer none): the #GdkAtom that corresponds to the
 *               newly registered format's mime-type.
 *
 ...
 **/
GdkAtom
__gtk_text_buffer_register_deserialize_tagset (GtkTextBuffer *buffer,
                                             const gchar   *tagset_name)
{
  gchar   *mime_type = "application/x-gtk-text-buffer-rich-text";
  GdkAtom  format;
...
/**
 * __gtk_text_buffer_unregister_serialize_format:
 * @buffer: a #GtkTextBuffer
 * @format: a #GdkAtom representing a registered rich text format.
 *
 * This function unregisters a rich text format that was previously
 * registered using __gtk_text_buffer_register_serialize_format() or
 * __gtk_text_buffer_register_serialize_tagset()
 *
 * Since: 2.10
 **/
void
__gtk_text_buffer_unregister_serialize_format (GtkTextBuffer *buffer,
                                             GdkAtom        format)
{
  GList *formats;
...
/**
 * __gtk_text_buffer_unregister_deserialize_format:
 * @buffer: a #GtkTextBuffer
 * @format: a #GdkAtom representing a registered rich text format.
 *
 * This function unregisters a rich text format that was previously
 * registered using __gtk_text_buffer_register_deserialize_format() or
 * __gtk_text_buffer_register_deserialize_tagset().
 *
 * Since: 2.10
 **/
void
__gtk_text_buffer_unregister_deserialize_format (GtkTextBuffer *buffer,
                                               GdkAtom        format)
{
  GList *formats;
...
/**
 * __gtk_text_buffer_deserialize_set_can_create_tags:
 * @buffer: a #GtkTextBuffer
 * @format: a #GdkAtom representing a registered rich text format
 ...
 * is registered using __gtk_text_buffer_register_deserialize_tagset(),
 ...
 **/
void
__gtk_text_buffer_deserialize_set_can_create_tags (GtkTextBuffer *buffer,
                                                 GdkAtom        format,
                                                 gboolean       can_create_tags)
{
  GList *formats;
  ...
  format_name = __gdk_atom_name (format);
...
/**
 * __gtk_text_buffer_deserialize_get_can_create_tags:
 * @buffer: a #GtkTextBuffer
 * @format: a #GdkAtom representing a registered rich text format
 *
 ...
 **/
gboolean
__gtk_text_buffer_deserialize_get_can_create_tags (GtkTextBuffer *buffer,
                                                 GdkAtom        format)
{
  GList *formats;
  GList *list;
...
/**
 * __gtk_text_buffer_get_serialize_formats:
 * @buffer: a #GtkTextBuffer
 * @n_formats: return location for the number of formats
 *
 * This function returns the rich text serialize formats registered
 * with @buffer using __gtk_text_buffer_register_serialize_format() or
 * __gtk_text_buffer_register_serialize_tagset()
 *
 ...
 **/
GdkAtom *
__gtk_text_buffer_get_serialize_formats (GtkTextBuffer *buffer,
                                       gint          *n_formats)
{
  GList *formats;
...
/**
 * __gtk_text_buffer_get_deserialize_formats:
 * @buffer: a #GtkTextBuffer
 * @n_formats: return location for the number of formats
 *
 * This function returns the rich text deserialize formats registered
 * with @buffer using __gtk_text_buffer_register_deserialize_format() or
 * __gtk_text_buffer_register_deserialize_tagset()
 *
 * Return value: (array length=n_formats) (transfer container): an array of
 *               #GdkAtom<!-- -->s representing the registered formats.
 ...
 **/
GdkAtom *
__gtk_text_buffer_get_deserialize_formats (GtkTextBuffer *buffer,
                                         gint          *n_formats)
{
  GList *formats;
 ...
 * __gtk_text_buffer_register_serialize_tagset() beforehand.
 *
 ...
 **/
guint8 *
__gtk_text_buffer_serialize (GtkTextBuffer     *register_buffer,
 ...
 *
 * @format<!-- -->s to be used must be registered using
 * __gtk_text_buffer_register_deserialize_format() or
 * __gtk_text_buffer_register_deserialize_tagset() beforehand.
 *
 ...
 **/
gboolean
__gtk_text_buffer_deserialize (GtkTextBuffer  *register_buffer,
                             GtkTextBuffer  *content_buffer,
                             GdkAtom         format,
                             GtkTextIter    *iter,
                             const guint8   *data,
      ...
      if (fmt->atom == format)
        {
           ...
           */
          split_tags = __gtk_text_iter_get_tags (iter);
          ...
          while (list)
            {
               ...
               */
              if (__gtk_text_iter_begins_tag (iter, tag))
          ...
          if (split_tags)
            {
               ...
               */
              left_end = __gtk_text_buffer_create_mark (content_buffer,
                                                      NULL, iter, TRUE);
              right_start = __gtk_text_buffer_create_mark (content_buffer,
                                                         NULL, iter, FALSE);

              for (list = split_tags; list; list = g_slist_next (list))
                {
                  GtkTextTag  *tag             = list->data;
                  GtkTextIter *backward_toggle = __gtk_text_iter_copy (iter);
                  GtkTextIter *forward_toggle  = __gtk_text_iter_copy (iter);
                  GtkTextMark *left_start      = NULL;
                  GtkTextMark *right_end       = NULL;

                  __gtk_text_iter_backward_to_tag_toggle (backward_toggle, tag);
                  left_start = __gtk_text_buffer_create_mark (content_buffer,
                                                            NULL,
                                                            backward_toggle,
                                                            FALSE);

                  __gtk_text_iter_forward_to_tag_toggle (forward_toggle, tag);
                  right_end = __gtk_text_buffer_create_mark (content_buffer,
                                                           NULL,
                                                           forward_toggle,
                                                           TRUE);
                  ...
                  __gtk_text_buffer_remove_tag (content_buffer, tag,
                                              backward_toggle,
                                              forward_toggle);

                  __gtk_text_iter_free (forward_toggle);
                  __gtk_text_iter_free (backward_toggle);
                }
          ...
          if (split_tags)
            {
               ...
               */
              __gtk_text_buffer_get_iter_at_mark (content_buffer,
                                                &left_e, left_end);
              __gtk_text_buffer_get_iter_at_mark (content_buffer,
                                                &right_s, right_start);
              ...
              for (list = split_tags,
                     ...
                     right_list = g_slist_next (right_list))
                {
                  ...
                  __gtk_text_buffer_apply_tag (content_buffer, tag,
                                             &left_s, &left_e);
                  __gtk_text_buffer_apply_tag (content_buffer, tag,
                                             &right_s, &right_e);

                  __gtk_text_buffer_delete_mark (content_buffer, left_start);
                  __gtk_text_buffer_delete_mark (content_buffer, right_end);
                }

              __gtk_text_buffer_delete_mark (content_buffer, left_end);
              __gtk_text_buffer_delete_mark (content_buffer, right_start);
                 ...
                 GdkAtom        *atom)
{
  ...
  *atom = __gdk_atom_intern (mime_type, FALSE);
