 ...
 *   other than 0 through __gtk_widget_set_size_request().
 *
		    ...
		    gboolean        horizontal)
{
  ...
  __gtk_binding_entry_add_signal (binding_set, keypad_keyval, mask,
                                "scroll-child", 2,
                                GTK_TYPE_SCROLL_TYPE, scroll,
				G_TYPE_BOOLEAN, horizontal);
}
...
{
  __gtk_widget_set_has_window (GTK_WIDGET (scrolled_window), FALSE);
  __gtk_widget_set_can_focus (GTK_WIDGET (scrolled_window), TRUE);

  gtk_scrolled_window_get_props (scrolled_window)->hscrollbar = NULL;
  gtk_scrolled_window_get_props (scrolled_window)->vscrollbar = NULL;
  gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy = GTK_POLICY_ALWAYS;
  gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy = GTK_POLICY_ALWAYS;
  gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible = FALSE;
  gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible = FALSE;
  gtk_scrolled_window_get_props (scrolled_window)->focus_out = FALSE;
  gtk_scrolled_window_get_props (scrolled_window)->window_placement = GTK_CORNER_TOP_LEFT;
  gtk_scrolled_window_update_real_placement (scrolled_window);
}

/**
 * __gtk_scrolled_window_new:
 ...
 */
GtkWidget*
__gtk_scrolled_window_new (GtkAdjustment *hadjustment,
...
/**
 * __gtk_scrolled_window_set_hadjustment:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 */
void
__gtk_scrolled_window_set_hadjustment (GtkScrolledWindow *scrolled_window,
				     GtkAdjustment     *hadjustment)
{
  ...
  if (!gtk_scrolled_window_get_props (scrolled_window)->hscrollbar)
    {
      __gtk_widget_push_composite_child ();
      gtk_scrolled_window_get_props (scrolled_window)->hscrollbar = __gtk_hscrollbar_new (hadjustment);
  ...
  else
    {
      ...
      old_adjustment = __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar));
	...
	return;
      ...
      g_signal_handlers_disconnect_by_func (old_adjustment,
					    ...
					    scrolled_window);
      __gtk_range_set_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar),
				hadjustment);
    }
  hadjustment = __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar));
  ...
  if (gtk_bin_get_props (bin)->child)
    __gtk_widget_set_scroll_adjustments (gtk_bin_get_props (bin)->child,
				       __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar)),
				       __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar)));

  g_object_notify (G_OBJECT (scrolled_window), "hadjustment");
}

/**
 * __gtk_scrolled_window_set_vadjustment:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 */
void
__gtk_scrolled_window_set_vadjustment (GtkScrolledWindow *scrolled_window,
				     GtkAdjustment     *vadjustment)
{
  GtkBin *bin;
  ...
  if (!gtk_scrolled_window_get_props (scrolled_window)->vscrollbar)
    {
      __gtk_widget_push_composite_child ();
      gtk_scrolled_window_get_props (scrolled_window)->vscrollbar = __gtk_vscrollbar_new (vadjustment);
  ...
  else
    {
      ...
      old_adjustment = __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar));
	...
	return;
      ...
      g_signal_handlers_disconnect_by_func (old_adjustment,
					    gtk_scrolled_window_adjustment_changed,
					    scrolled_window);
      __gtk_range_set_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar),
				vadjustment);
    }
  vadjustment = __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar));
...
/**
 * __gtk_scrolled_window_get_hadjustment:
 * @scrolled_window: a #GtkScrolledWindow
 *
 ...
 */
GtkAdjustment*
__gtk_scrolled_window_get_hadjustment (GtkScrolledWindow *scrolled_window)
{
  g_return_val_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window), NULL);

  return (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar ?
	  __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar)) :
	  NULL);
}

/**
 * __gtk_scrolled_window_get_vadjustment:
 * @scrolled_window: a #GtkScrolledWindow
 * 
 ...
 */
GtkAdjustment*
__gtk_scrolled_window_get_vadjustment (GtkScrolledWindow *scrolled_window)
{
  g_return_val_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window), NULL);

  return (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar ?
	  __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar)) :
	  NULL);
}

/**
 * __gtk_scrolled_window_get_hscrollbar:
 * @scrolled_window: a #GtkScrolledWindow
 *
 ...
 */
GtkWidget*
__gtk_scrolled_window_get_hscrollbar (GtkScrolledWindow *scrolled_window)
{
  g_return_val_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window), NULL);
...
/**
 * __gtk_scrolled_window_get_vscrollbar:
 * @scrolled_window: a #GtkScrolledWindow
 * 
 ...
 */
GtkWidget*
__gtk_scrolled_window_get_vscrollbar (GtkScrolledWindow *scrolled_window)
{
  g_return_val_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window), NULL);
...
/**
 * __gtk_scrolled_window_set_policy:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 */
void
__gtk_scrolled_window_set_policy (GtkScrolledWindow *scrolled_window,
				...
				GtkPolicyType      vscrollbar_policy)
{
  ...
  if ((gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy != hscrollbar_policy) ||
      (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy != vscrollbar_policy))
    {
      gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy = hscrollbar_policy;
      gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy = vscrollbar_policy;

      __gtk_widget_queue_resize (GTK_WIDGET (scrolled_window));
...
/**
 * __gtk_scrolled_window_get_policy:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 * scrollbars. See __gtk_scrolled_window_set_policy().
 */
void
__gtk_scrolled_window_get_policy (GtkScrolledWindow *scrolled_window,
				GtkPolicyType     *hscrollbar_policy,
				GtkPolicyType     *vscrollbar_policy)
{
  g_return_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window));
  ...
  if (hscrollbar_policy)
    *hscrollbar_policy = gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy;
  if (vscrollbar_policy)
    *vscrollbar_policy = gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy;
}
...
gtk_scrolled_window_update_real_placement (GtkScrolledWindow *scrolled_window)
{
  ...
  settings = __gtk_widget_get_settings (GTK_WIDGET (scrolled_window));

  if (priv->window_placement_set || settings == NULL)
    priv->real_window_placement = gtk_scrolled_window_get_props (scrolled_window)->window_placement;
  else
...
static void
__gtk_scrolled_window_set_placement_internal (GtkScrolledWindow *scrolled_window,
					    GtkCornerType      window_placement)
{
  if (gtk_scrolled_window_get_props (scrolled_window)->window_placement != window_placement)
    {
      gtk_scrolled_window_get_props (scrolled_window)->window_placement = window_placement;
...
static void
__gtk_scrolled_window_set_placement_set (GtkScrolledWindow *scrolled_window,
...
/**
 * __gtk_scrolled_window_set_placement:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 *
 * See also __gtk_scrolled_window_get_placement() and
 * __gtk_scrolled_window_unset_placement().
 */
void
__gtk_scrolled_window_set_placement (GtkScrolledWindow *scrolled_window,
				   GtkCornerType      window_placement)
{
  g_return_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window));

  __gtk_scrolled_window_set_placement_set (scrolled_window, TRUE, FALSE);
  __gtk_scrolled_window_set_placement_internal (scrolled_window, window_placement);
}

/**
 * __gtk_scrolled_window_get_placement:
 * @scrolled_window: a #GtkScrolledWindow
 *
 * Gets the placement of the contents with respect to the scrollbars
 * for the scrolled window. See __gtk_scrolled_window_set_placement().
 *
 * Return value: the current placement value.
 *
 * See also __gtk_scrolled_window_set_placement() and
 * __gtk_scrolled_window_unset_placement().
 **/
GtkCornerType
__gtk_scrolled_window_get_placement (GtkScrolledWindow *scrolled_window)
{
  g_return_val_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window), GTK_CORNER_TOP_LEFT);

  return gtk_scrolled_window_get_props (scrolled_window)->window_placement;
}
 ...
 **/
void
__gtk_scrolled_window_unset_placement (GtkScrolledWindow *scrolled_window)
{
  GtkScrolledWindowPrivate *priv = gtk_scrolled_window_get_instance_private (scrolled_window);
...
/**
 * __gtk_scrolled_window_set_shadow_type:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 **/
void
__gtk_scrolled_window_set_shadow_type (GtkScrolledWindow *scrolled_window,
				     GtkShadowType      type)
{
  g_return_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window));
  g_return_if_fail (type >= GTK_SHADOW_NONE && type <= GTK_SHADOW_ETCHED_OUT);
  
  if (gtk_scrolled_window_get_props (scrolled_window)->shadow_type != type)
    {
      gtk_scrolled_window_get_props (scrolled_window)->shadow_type = type;

      if (__gtk_widget_is_drawable (GTK_WIDGET (scrolled_window)))
	__gtk_widget_queue_draw (GTK_WIDGET (scrolled_window));
...
/**
 * __gtk_scrolled_window_get_shadow_type:
 * @scrolled_window: a #GtkScrolledWindow
 *
 ...
 **/
GtkShadowType
__gtk_scrolled_window_get_shadow_type (GtkScrolledWindow *scrolled_window)
{
  g_return_val_if_fail (GTK_IS_SCROLLED_WINDOW (scrolled_window), GTK_SHADOW_NONE);

  return gtk_scrolled_window_get_props (scrolled_window)->shadow_type;
}
				  ...
				  GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_HADJUSTMENT:
      __gtk_scrolled_window_set_hadjustment (scrolled_window,
					   g_value_get_object (value));
      break;
    case PROP_VADJUSTMENT:
      __gtk_scrolled_window_set_vadjustment (scrolled_window,
					   g_value_get_object (value));
      break;
    case PROP_HSCROLLBAR_POLICY:
      __gtk_scrolled_window_set_policy (scrolled_window,
				      g_value_get_enum (value),
				      gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy);
      break;
    case PROP_VSCROLLBAR_POLICY:
      __gtk_scrolled_window_set_policy (scrolled_window,
				      gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy,
				      g_value_get_enum (value));
      break;
    case PROP_WINDOW_PLACEMENT:
      __gtk_scrolled_window_set_placement_internal (scrolled_window,
		      				  g_value_get_enum (value));
      break;
    case PROP_WINDOW_PLACEMENT_SET:
      __gtk_scrolled_window_set_placement_set (scrolled_window,
		      			     g_value_get_boolean (value),
					     TRUE);
      break;
    case PROP_SHADOW_TYPE:
      __gtk_scrolled_window_set_shadow_type (scrolled_window,
					   g_value_get_enum (value));
      break;
    default:
  ...
  switch (prop_id)
    ...
    case PROP_HADJUSTMENT:
      g_value_set_object (value,
			  G_OBJECT (__gtk_scrolled_window_get_hadjustment (scrolled_window)));
      break;
    case PROP_VADJUSTMENT:
      g_value_set_object (value,
			  G_OBJECT (__gtk_scrolled_window_get_vadjustment (scrolled_window)));
      break;
    case PROP_HSCROLLBAR_POLICY:
      g_value_set_enum (value, gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy);
      break;
    case PROP_VSCROLLBAR_POLICY:
      g_value_set_enum (value, gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy);
      break;
    case PROP_WINDOW_PLACEMENT:
      g_value_set_enum (value, gtk_scrolled_window_get_props (scrolled_window)->window_placement);
      break;
    case PROP_WINDOW_PLACEMENT_SET:
      g_value_set_boolean (value, priv->window_placement_set);
      break;
    case PROP_SHADOW_TYPE:
      g_value_set_enum (value, gtk_scrolled_window_get_props (scrolled_window)->shadow_type);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
		    ...
		    gpointer   data)
{
  if (GTK_IS_SCROLLED_WINDOW (widget))
    ...
    __gtk_container_forall (GTK_CONTAINER (widget), traverse_container, NULL);
}
...
gtk_scrolled_window_settings_changed (GtkSettings *settings)
{
  ...
  for (l = list; l; l = l->next)
    __gtk_container_forall (GTK_CONTAINER (l->data), 
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->shadow_type != GTK_SHADOW_NONE)
    {
      ...
      __gtk_widget_style_get (widget, "scrollbars-within-bevel", &scrollbars_within_bevel, NULL);
      
      if (!scrollbars_within_bevel)
        {
          gtk_scrolled_window_relative_allocation (widget, &relative_allocation);

          relative_allocation.x -= gtk_widget_get_props (widget)->style->xthickness;
          relative_allocation.y -= gtk_widget_get_props (widget)->style->ythickness;
          relative_allocation.width += 2 * gtk_widget_get_props (widget)->style->xthickness;
          relative_allocation.height += 2 * gtk_widget_get_props (widget)->style->ythickness;
        }
      else
        {
          GtkContainer *container = GTK_CONTAINER (widget);

          relative_allocation.x = gtk_container_get_props (container)->border_width;
          relative_allocation.y = gtk_container_get_props (container)->border_width;
          relative_allocation.width = gtk_widget_get_props (widget)->allocation.width - 2 * gtk_container_get_props (container)->border_width;
          relative_allocation.height = gtk_widget_get_props (widget)->allocation.height - 2 * gtk_container_get_props (container)->border_width;
        }

      __gtk_paint_shadow (gtk_widget_get_props (widget)->style, gtk_widget_get_props (widget)->window,
			GTK_STATE_NORMAL, gtk_scrolled_window_get_props (scrolled_window)->shadow_type,
			area, widget, "scrolled_window",
			gtk_widget_get_props (widget)->allocation.x + relative_allocation.x,
			gtk_widget_get_props (widget)->allocation.y + relative_allocation.y,
  ...
  if (include_internals)
    {
      ...
      if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar)
	callback (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar, callback_data);
      if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar)
	callback (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar, callback_data);
    }
}
				  ...
				  gboolean           horizontal)
{
  ...
  if ((horizontal && (!gtk_scrolled_window_get_props (scrolled_window)->hscrollbar || !gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible)) ||
      (!horizontal && (!gtk_scrolled_window_get_props (scrolled_window)->vscrollbar || !gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible)))
    return FALSE;

  if (horizontal)
    {
      if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar)
	adjustment = __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar));
    }
  else
    {
      if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar)
	adjustment = __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar));
    }
  ...
  if (adjustment)
	...
	{
	case GTK_SCROLL_STEP_FORWARD:
	  value += gtk_adjustment_get_props (adjustment)->step_increment;
	  break;
	case GTK_SCROLL_STEP_BACKWARD:
	  value -= gtk_adjustment_get_props (adjustment)->step_increment;
	  break;
	case GTK_SCROLL_PAGE_FORWARD:
	  value += gtk_adjustment_get_props (adjustment)->page_increment;
	  break;
	case GTK_SCROLL_PAGE_BACKWARD:
	  value -= gtk_adjustment_get_props (adjustment)->page_increment;
	  break;
	case GTK_SCROLL_START:
	  value = gtk_adjustment_get_props (adjustment)->lower;
	  break;
	case GTK_SCROLL_END:
	  value = gtk_adjustment_get_props (adjustment)->upper;
	  break;
	default:
      ...
      value = CLAMP (value, gtk_adjustment_get_props (adjustment)->lower, gtk_adjustment_get_props (adjustment)->upper - gtk_adjustment_get_props (adjustment)->page_size);
				    ...
				    GtkDirectionType   direction_type)
{
   ...
   */
  toplevel = __gtk_widget_get_toplevel (GTK_WIDGET (scrolled_window));
  if (!__gtk_widget_is_toplevel (toplevel))
    return;

  g_object_ref (scrolled_window);
  
  gtk_scrolled_window_get_props (scrolled_window)->focus_out = TRUE;
				  ...
				  GtkRequisition *requisition)
{
  ...
  scrollbar_spacing = ___gtk_scrolled_window_get_scrollbar_spacing (scrolled_window);
  ...
  __gtk_widget_size_request (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar,
			   &hscrollbar_requisition);
  __gtk_widget_size_request (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar,
  ...
  if (gtk_bin_get_props (bin)->child && __gtk_widget_get_visible (gtk_bin_get_props (bin)->child))
    {
      ...
      if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_NEVER)
	requisition->width += child_requisition.width;
      else
	{
	  GtkWidgetAuxInfo *aux_info = ___gtk_widget_get_aux_info (gtk_bin_get_props (bin)->child, FALSE);
      ...
      if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_NEVER)
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_AUTOMATIC ||
      gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_ALWAYS)
    {
      requisition->width = MAX (requisition->width, hscrollbar_requisition.width);
      if (!extra_height || gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_ALWAYS)
	extra_height = scrollbar_spacing + hscrollbar_requisition.height;
    }

  if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_AUTOMATIC ||
      gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_ALWAYS)
    {
      requisition->height = MAX (requisition->height, vscrollbar_requisition.height);
      if (!extra_height || gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_ALWAYS)
					 ...
					 GtkAllocation *allocation)
{
  ...
  priv = gtk_scrolled_window_get_instance_private (scrolled_window);
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->shadow_type != GTK_SHADOW_NONE)
    {
      allocation->x += gtk_widget_get_props (widget)->style->xthickness;
      allocation->y += gtk_widget_get_props (widget)->style->ythickness;
    }
  
  allocation->width = MAX (1, (gint)gtk_widget_get_props (widget)->allocation.width - allocation->x * 2);
  allocation->height = MAX (1, (gint)gtk_widget_get_props (widget)->allocation.height - allocation->y * 2);

  if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible)
    {
      GtkRequisition vscrollbar_requisition;
      gboolean is_rtl;

      __gtk_widget_get_child_requisition (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar,
					&vscrollbar_requisition);
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible)
    {
      GtkRequisition hscrollbar_requisition;
      __gtk_widget_get_child_requisition (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar,
					&hscrollbar_requisition);
				   ...
				   GtkAllocation *allocation)
{
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_ALWAYS)
    gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible = TRUE;
  else if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_NEVER)
    gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible = FALSE;
  if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_ALWAYS)
    gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible = TRUE;
  else if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_NEVER)
    gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible = FALSE;
  ...
  if (gtk_bin_get_props (bin)->child && __gtk_widget_get_visible (gtk_bin_get_props (bin)->child))
      ...
      do
	{
	  ...
	  previous_hvis = gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible;
	  previous_vvis = gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible;
      ...
      while (previous_hvis != gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible ||
	     previous_vvis != gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible);
    }
  else
    {
      gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible = gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_policy == GTK_POLICY_ALWAYS;
      gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible = gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_policy == GTK_POLICY_ALWAYS;
      gtk_scrolled_window_relative_allocation (widget, &relative_allocation);
    }
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar_visible)
    {
      ...
      if (!__gtk_widget_get_visible (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar))
	__gtk_widget_show (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar);
      ...
      if (gtk_scrolled_window_get_props (scrolled_window)->shadow_type != GTK_SHADOW_NONE)
	{
          if (!scrollbars_within_bevel)
            {
              ...
              child_allocation.width += 2 * gtk_widget_get_props (widget)->style->xthickness;
            }
      ...
      __gtk_widget_size_allocate (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar, &child_allocation);
    }
  else if (__gtk_widget_get_visible (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar))
    __gtk_widget_hide (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar);

  if (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar_visible)
    {
      GtkRequisition vscrollbar_requisition;
      if (!__gtk_widget_get_visible (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar))
	__gtk_widget_show (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar);
      ...
      if (gtk_scrolled_window_get_props (scrolled_window)->shadow_type != GTK_SHADOW_NONE)
	{
          if (!scrollbars_within_bevel)
            {
              child_allocation.y -= gtk_widget_get_props (widget)->style->ythickness;
	      child_allocation.height += 2 * gtk_widget_get_props (widget)->style->ythickness;
            }
      ...
      __gtk_widget_size_allocate (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar, &child_allocation);
    }
  else if (__gtk_widget_get_visible (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar))
    __gtk_widget_hide (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar);
}
  ...
  if (range && __gtk_widget_get_visible (range))
    {
      ...
      new_value = CLAMP (gtk_adjustment_get_props (adj)->value + delta, gtk_adjustment_get_props (adj)->lower, gtk_adjustment_get_props (adj)->upper - gtk_adjustment_get_props (adj)->page_size);
      
      __gtk_adjustment_set_value (adj, new_value);
			   ...
			   GtkDirectionType  direction)
{
  ...
  if (gtk_scrolled_window_get_props (scrolled_window)->focus_out)
    {
      gtk_scrolled_window_get_props (scrolled_window)->focus_out = FALSE; /* Clear this to catch the wrap-around case */
      return FALSE;
    }
  ...
  if (!had_focus_child && __gtk_widget_get_can_focus (widget))
    {
					...
					gpointer       data)
{
  ...
  if (gtk_scrolled_window_get_props (scrolled_win)->hscrollbar &&
      adjustment == __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_win)->hscrollbar)))
    {
      if (gtk_scrolled_window_get_props (scrolled_win)->hscrollbar_policy == GTK_POLICY_AUTOMATIC)
	{
	  gboolean visible;
	  
	  visible = gtk_scrolled_window_get_props (scrolled_win)->hscrollbar_visible;
	  gtk_scrolled_window_get_props (scrolled_win)->hscrollbar_visible = (gtk_adjustment_get_props (adjustment)->upper - gtk_adjustment_get_props (adjustment)->lower >
					      gtk_adjustment_get_props (adjustment)->page_size);
	  if (gtk_scrolled_window_get_props (scrolled_win)->hscrollbar_visible != visible)
	    __gtk_widget_queue_resize (GTK_WIDGET (scrolled_win));
	}
    }
  else if (gtk_scrolled_window_get_props (scrolled_win)->vscrollbar &&
	   adjustment == __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_win)->vscrollbar)))
    {
      if (gtk_scrolled_window_get_props (scrolled_win)->vscrollbar_policy == GTK_POLICY_AUTOMATIC)
	{
	  gboolean visible;

	  visible = gtk_scrolled_window_get_props (scrolled_win)->vscrollbar_visible;
	  gtk_scrolled_window_get_props (scrolled_win)->vscrollbar_visible = (gtk_adjustment_get_props (adjustment)->upper - gtk_adjustment_get_props (adjustment)->lower >
					      gtk_adjustment_get_props (adjustment)->page_size);
	  if (gtk_scrolled_window_get_props (scrolled_win)->vscrollbar_visible != visible)
	    __gtk_widget_queue_resize (GTK_WIDGET (scrolled_win));
	}
    }
}
			 ...
			 GtkWidget    *child)
{
  ...
  gtk_bin_get_props (bin)->child = child;
  __gtk_widget_set_parent (child, GTK_WIDGET (bin));

  /* this is a temporary message */
  if (!__gtk_widget_set_scroll_adjustments (child,
					  __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->hscrollbar)),
					  __gtk_range_get_adjustment (GTK_RANGE (gtk_scrolled_window_get_props (scrolled_window)->vscrollbar))))
    g_warning ("gtk_scrolled_window_add(): cannot add non scrollable widget "
	       "use __gtk_scrolled_window_add_with_viewport() instead");
}
...
/**
 * __gtk_scrolled_window_add_with_viewport:
 * @scrolled_window: a #GtkScrolledWindow
 ...
 * __gtk_container_add() instead of this function.
 *
 ...
 */
void
__gtk_scrolled_window_add_with_viewport (GtkScrolledWindow *scrolled_window,
				       GtkWidget         *child)
{
  GtkBin *bin;
  GtkWidget *viewport;
  ...
  if (gtk_bin_get_props (bin)->child != NULL)
    ...
    {
      viewport =
        __gtk_viewport_new (__gtk_scrolled_window_get_hadjustment (scrolled_window),
			  __gtk_scrolled_window_get_vadjustment (scrolled_window));
      __gtk_container_add (GTK_CONTAINER (scrolled_window), viewport);
    }

  __gtk_widget_show (viewport);
  __gtk_container_add (GTK_CONTAINER (viewport), child);
}
 ...
 */
gint
___gtk_scrolled_window_get_scrollbar_spacing (GtkScrolledWindow *scrolled_window)
{
  ...
  if (class->scrollbar_spacing >= 0)
  ...
  else
    {
      ...
      __gtk_widget_style_get (GTK_WIDGET (scrolled_window),
